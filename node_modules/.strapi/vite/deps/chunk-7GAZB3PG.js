...
// ../packages/core/content-type-builder/admin/src/utils/getTrad.ts
var getTrad = (id) => `${pluginId}.${id}`;

// ../packages/core/content-type-builder/admin/src/components/DataManager/useDataManager.ts
var import_react2 = __toESM(require_react());

// ../packages/core/content-type-builder/admin/src/components/DataManager/DataManagerContext.ts
...
// ../packages/core/content-type-builder/admin/src/components/FormModalNavigation/useFormModalNavigation.ts
var import_react3 = __toESM(require_react());

// ../packages/core/content-type-builder/admin/src/components/FormModalNavigation/FormModalNavigationContext.ts
...
// ../packages/core/content-type-builder/admin/src/components/Status.tsx
...
var Status = ({ status }) => {
  switch (status) {
    case "UNCHANGED":
      return null;
    case "CHANGED":
      return (0, import_jsx_runtime.jsx)(Typography, { fontWeight: "semiBold", textColor: "alternative500", children: "M" });
    case "REMOVED":
      return (0, import_jsx_runtime.jsx)(Typography, { fontWeight: "semiBold", textColor: "danger500", children: "D" });
    case "NEW":
      return (0, import_jsx_runtime.jsx)(Typography, { fontWeight: "semiBold", textColor: "success500", children: "N" });
  }
};
...
// ../packages/core/content-type-builder/admin/src/components/AttributeIcon.tsx
...
var AttributeIcon = ({ type, customField = null, ...rest }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(IconBox, { width: "3.2rem", height: "3.2rem", shrink: 0, ...rest, "aria-hidden": true, children: (0, import_jsx_runtime2.jsx)(Box, { tag: Compo }) });
};
...
// ../packages/core/content-type-builder/admin/src/utils/conditions.ts
...
//# sourceMappingURL=chunk-7GAZB3PG.js.map
