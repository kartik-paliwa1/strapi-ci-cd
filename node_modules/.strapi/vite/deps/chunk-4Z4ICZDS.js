...
// ../packages/core/admin/admin/src/components/Filters.tsx
var React = __toESM(require_react());

// ../packages/core/admin/admin/src/constants/filters.ts
var BASE_FILTERS = [
  {
...
var PopoverImpl = ({ zIndex }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Popover.Content, { style: { zIndex }, children: (0, import_jsx_runtime.jsx)(Box, { padding: 3, children: (0, import_jsx_runtime.jsx)(
    Form,
    {
      method: "POST",
      initialValues: {
...
var AttributeTag = ({
  ...
  return (0, import_jsx_runtime.jsx)(Tag, { padding: 1, onClick: handleClick, icon: (0, import_jsx_runtime.jsx)(ForwardRef$4d, {}), children: content });
};
var Filters = {
  List,
  Popover: PopoverImpl,
...
//# sourceMappingURL=chunk-4Z4ICZDS.js.map
