...
// ../packages/core/admin/admin/src/pages/Marketplace/MarketplacePage.tsx
...
// ../packages/core/admin/admin/src/pages/Marketplace/components/NpmPackagesFilters.tsx
...
var NpmPackagesFilters = ({
  ...
  return (0, import_jsx_runtime.jsxs)(Popover.Root, { children: [
    (0, import_jsx_runtime.jsx)(Popover.Trigger, { children: (0, import_jsx_runtime.jsx)(Button, { variant: "tertiary", startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$3p, {}), children: formatMessage({ id: "app.utils.filters", defaultMessage: "Filters" }) }) }),
    ...
    (_a = query.collections) == null ? void 0 : _a.map((collection) => (0, import_jsx_runtime.jsx)(Box, { padding: 1, children: (0, import_jsx_runtime.jsx)(Tag, { icon: (0, import_jsx_runtime.jsx)(ForwardRef$4d, {}), onClick: () => handleTagRemove(collection, "collections"), children: collection }) }, collection)),
    npmPackageType === "plugin" && ((_b = query.categories) == null ? void 0 : _b.map((category) => (0, import_jsx_runtime.jsx)(Box, { padding: 1, children: (0, import_jsx_runtime.jsx)(Tag, { icon: (0, import_jsx_runtime.jsx)(ForwardRef$4d, {}), onClick: () => handleTagRemove(category, "categories"), children: category }) }, category)))
  ] });
};
var FilterSelect = ({
  message,
...
// ../packages/core/admin/admin/src/pages/Marketplace/components/NpmPackageCard.tsx
var import_pluralize = __toESM(require_pluralize());
var semver = __toESM(require_semver2());
import StrapiLogo from "/Users/kartikpaliwal/Downloads/strapi-develop/packages/core/admin/admin/src/assets/images/logo-strapi-2022.svg";
    ...
    Flex,
    {
      ...
      children: [
        (0, import_jsx_runtime2.jsxs)(Box, { children: [
          (0, import_jsx_runtime2.jsxs)(Flex, { direction: "row", justifyContent: "space-between", alignItems: "flex-start", children: [
          ...
          (0, import_jsx_runtime2.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime2.jsx)(Typography, { tag: "h3", variant: "delta", children: (0, import_jsx_runtime2.jsxs)(
            Flex,
            {
              alignItems: "center",
              ...
              children: [
                attributes.name,
                attributes.validated && !attributes.madeByStrapi && (0, import_jsx_runtime2.jsx)(
                  TooltipImpl,
                  {
                    ...
                    children: (0, import_jsx_runtime2.jsx)(ForwardRef$4L, { fill: "success600" })
                  }
                ),
                attributes.madeByStrapi && (0, import_jsx_runtime2.jsx)(TooltipImpl, { description: madeByStrapiMessage, children: (0, import_jsx_runtime2.jsx)(
                  Box,
                  {
                    tag: "img",
                    src: StrapiLogo,
          ...
          (0, import_jsx_runtime2.jsx)(Box, { paddingTop: 2, children: (0, import_jsx_runtime2.jsx)(EllipsisText, { tag: "p", variant: "omega", textColor: "neutral600", children: attributes.description }) })
        ] }),
        (0, import_jsx_runtime2.jsxs)(Flex, { gap: 2, style: { alignSelf: "flex-end" }, paddingTop: 6, children: [
          (0, import_jsx_runtime2.jsx)(
            LinkButton,
            {
              size: "S",
...
var InstallPluginButton = ({
  ...
  if (isInstalled) {
    return (0, import_jsx_runtime2.jsxs)(Flex, { gap: 2, paddingLeft: 4, children: [
      (0, import_jsx_runtime2.jsx)(ForwardRef$4N, { width: "1.2rem", height: "1.2rem", color: "success600" }),
      (0, import_jsx_runtime2.jsx)(Typography, { variant: "omega", textColor: "success600", fontWeight: "bold", children: formatMessage({
...
var CardButton = ({
    ...
    if (!versionRange || !isCompatible) {
      return (0, import_jsx_runtime2.jsx)(
        TooltipImpl,
        {
          ...
          children: (0, import_jsx_runtime2.jsx)("span", { children: (0, import_jsx_runtime2.jsx)(
            Button,
            {
              size: "S",
  ...
  return (0, import_jsx_runtime2.jsx)(Button, { size: "S", startIcon: (0, import_jsx_runtime2.jsx)(ForwardRef$3Z, {}), variant: "secondary", onClick: handleCopy, children: installMessage });
};
var PackageStats = ({ githubStars = 0, npmDownloads = 0, npmPackageType }) => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime2.jsxs)(Flex, { gap: 1, children: [
    !!githubStars && (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      (0, import_jsx_runtime2.jsx)(ForwardRef$x, { height: "1.2rem", width: "1.2rem", "aria-hidden": true }),
      (0, import_jsx_runtime2.jsx)(ForwardRef$H, { height: "1.2rem", width: "1.2rem", fill: "warning500", "aria-hidden": true }),
      (0, import_jsx_runtime2.jsx)(
        "p",
        {
          "aria-label": formatMessage(
          ...
          children: (0, import_jsx_runtime2.jsx)(Typography, { variant: "pi", textColor: "neutral800", children: githubStars })
        }
      ),
      (0, import_jsx_runtime2.jsx)(VerticalDivider, {})
    ] }),
    (0, import_jsx_runtime2.jsx)(ForwardRef$41, { height: "1.2rem", width: "1.2rem", "aria-hidden": true }),
    (0, import_jsx_runtime2.jsx)(
      "p",
      {
        "aria-label": formatMessage(
        ...
        children: (0, import_jsx_runtime2.jsx)(Typography, { variant: "pi", textColor: "neutral800", children: npmDownloads })
      }
    )
  ] });
};
...
// ../packages/core/admin/admin/src/pages/Marketplace/components/NpmPackagesGrid.tsx
...
var NpmPackagesGrid = ({
  ...
  if (npmPackages.length === 0) {
    return (0, import_jsx_runtime3.jsxs)(Box, { position: "relative", children: [
      (0, import_jsx_runtime3.jsx)(Layouts.Grid, { size: "M", children: Array(12).fill(null).map((_, idx) => (0, import_jsx_runtime3.jsx)(EmptyPluginCard, { height: "234px", hasRadius: true }, idx)) }),
      (0, import_jsx_runtime3.jsx)(Box, { position: "absolute", top: 11, width: "100%", children: (0, import_jsx_runtime3.jsxs)(Flex, { alignItems: "center", justifyContent: "center", direction: "column", children: [
        (0, import_jsx_runtime3.jsx)(ForwardRef$J, { width: "160px", height: "88px" }),
        (0, import_jsx_runtime3.jsx)(Box, { paddingTop: 6, children: (0, import_jsx_runtime3.jsx)(Typography, { variant: "delta", tag: "p", textColor: "neutral600", children: emptySearchMessage }) })
      ] }) })
    ] });
  }
  return (0, import_jsx_runtime3.jsx)(Grid.Root, { gap: 4, children: npmPackages.map((npmPackage) => (0, import_jsx_runtime3.jsx)(
    Grid.Item,
    {
      col: 4,
      s: 6,
...
// ../packages/core/admin/admin/src/pages/Marketplace/components/PageHeader.tsx
...
var PageHeader = ({ isOnline, npmPackageType = "plugin" }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(
    Layouts.Header,
    {
      ...
      primaryAction: isOnline && (0, import_jsx_runtime4.jsx)(
        LinkButton,
        {
...
// ../packages/core/admin/admin/src/pages/Marketplace/components/OfflineLayout.tsx
var import_jsx_runtime5 = __toESM(require_jsx_runtime());
var OfflineLayout = () => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime5.jsx)(Layouts.Root, { children: (0, import_jsx_runtime5.jsxs)(Main, { children: [
    ...
    (0, import_jsx_runtime5.jsxs)(
      Flex,
      {
        ...
        paddingTop: `12rem`,
        children: [
          (0, import_jsx_runtime5.jsx)(Box, { paddingBottom: 2, children: (0, import_jsx_runtime5.jsx)(Typography, { textColor: "neutral700", variant: "alpha", children: formatMessage({
            id: "admin.pages.MarketPlacePage.offline.title",
            defaultMessage: "You are offline"
          }) }) }),
          (0, import_jsx_runtime5.jsx)(Box, { paddingBottom: 6, children: (0, import_jsx_runtime5.jsx)(Typography, { textColor: "neutral700", variant: "epsilon", children: formatMessage({
          ...
          (0, import_jsx_runtime5.jsxs)(
            "svg",
            {
              ...
              children: [
                (0, import_jsx_runtime5.jsx)("rect", { x: ".5", y: ".5", width: "87", height: "87", rx: "43.5", fill: "#F0F0FF" }),
                ...
                (0, import_jsx_runtime5.jsx)("rect", { x: ".5", y: ".5", width: "87", height: "87", rx: "43.5", stroke: "#D9D8FF" })
              ]
            }
          )
        ]
...
// ../packages/core/admin/admin/src/pages/Marketplace/components/SortSelect.tsx
...
var SortSelect = ({ sortQuery, handleSelectChange }) => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime6.jsx)(SelectWrapper, { children: (0, import_jsx_runtime6.jsx)(
    SingleSelect,
    {
      value: sortQuery,
      ...
      children: Object.entries(SORT_TYPES).map(([sortName, messages]) => {
        return (0, import_jsx_runtime6.jsx)(SingleSelectOption, { value: sortName, children: formatMessage(messages.option) }, sortName);
      })
    }
  ) });
};
...
// ../packages/core/admin/admin/src/pages/Marketplace/hooks/useMarketplaceData.ts
...
// ../packages/core/admin/admin/src/pages/Marketplace/hooks/useNavigatorOnline.ts
...
var MarketplacePage = () => {
  ...
  return (0, import_jsx_runtime7.jsx)(Layouts.Root, { children: (0, import_jsx_runtime7.jsxs)(Page.Main, { children: [
    (0, import_jsx_runtime7.jsx)(Page.Title, { children: formatMessage({
      id: "admin.pages.MarketPlacePage.head",
      defaultMessage: "Marketplace - Plugins"
    }) }),
    (0, import_jsx_runtime7.jsx)(PageHeader, { isOnline, npmPackageType }),
    (0, import_jsx_runtime7.jsx)(Layouts.Content, { children: (0, import_jsx_runtime7.jsxs)(Tabs.Root, { variant: "simple", onValueChange: handleTabChange, value: npmPackageType, children: [
      (0, import_jsx_runtime7.jsxs)(Flex, { justifyContent: "space-between", paddingBottom: 4, children: [
        (0, import_jsx_runtime7.jsxs)(
          Tabs.List,
          {
            ...
            children: [
              (0, import_jsx_runtime7.jsxs)(Tabs.Trigger, { value: PLUGIN, children: [
                formatMessage({
              ...
              (0, import_jsx_runtime7.jsxs)(Tabs.Trigger, { value: PROVIDER, children: [
                formatMessage({
        ...
        (0, import_jsx_runtime7.jsx)(Box, { width: "25%", children: (0, import_jsx_runtime7.jsx)(
          Searchbar,
          {
            name: "searchbar",
      ...
      (0, import_jsx_runtime7.jsxs)(Flex, { paddingBottom: 4, gap: 2, children: [
      ...
      (0, import_jsx_runtime7.jsx)(Tabs.Content, { value: PLUGIN, children: (0, import_jsx_runtime7.jsx)(
        NpmPackagesGrid,
        {
      ...
      (0, import_jsx_runtime7.jsx)(Tabs.Content, { value: PROVIDER, children: (0, import_jsx_runtime7.jsx)(
        NpmPackagesGrid,
        {
      ...
      (0, import_jsx_runtime7.jsxs)(Pagination.Root, { ...pagination, defaultPageSize: 24, children: [
        (0, import_jsx_runtime7.jsx)(Pagination.PageSize, { options: ["12", "24", "50", "100"] }),
        (0, import_jsx_runtime7.jsx)(Pagination.Links, {})
      ] }),
      (0, import_jsx_runtime7.jsx)(Box, { paddingTop: 8, children: (0, import_jsx_runtime7.jsx)(
        "a",
        {
          ...
          children: (0, import_jsx_runtime7.jsx)(
            ContentBox,
            {
              ...
              endAction: (0, import_jsx_runtime7.jsx)(
                ForwardRef$3N,
                {
                  fill: "neutral600",
                  width: "1.2rem",
...
var ProtectedMarketplacePage = () => {
  ...
  return (0, import_jsx_runtime7.jsx)(Page.Protect, { permissions, children: (0, import_jsx_runtime7.jsx)(MarketplacePage, {}) });
};
export {
  MarketplacePage,
  ProtectedMarketplacePage
};
//# sourceMappingURL=MarketplacePage-GKCK4I7W.js.map
