...
// ../packages/core/content-manager/admin/src/pages/EditView/utils/data.ts
...
var handleInvisibleAttributes = (data, { schema, initialValues = {}, components = {} }, path = [], removedAttributes = []) => {
  var _a;
  if (!(schema == null ? void 0 : schema.attributes)) return { data, removedAttributes };
...
// ../packages/core/content-manager/admin/src/utils/api.ts
...
// ../packages/core/content-manager/admin/src/utils/validation.ts
var import_pipe2 = __toESM(require_pipe());
...
var createYupSchema = (attributes = {}, components = {}, options = { status: null }) => {
  const createModelSchema = (attributes2, removedAttributes = []) => create5().shape(
          ...
          if (attribute.repeatable) {
            return {
              ...
              [name]: transformSchema(
                create6().of(createModelSchema(attributes3, nestedRemoved).nullable(false))
...
// ../packages/core/content-manager/admin/src/hooks/useContentTypeSchema.ts
...
// ../packages/core/content-manager/admin/src/services/contentTypes.ts
...
// ../packages/core/content-manager/admin/src/utils/attributes.ts
...
// ../packages/core/content-manager/admin/src/hooks/useDocument.ts
var React2 = __toESM(require_react());

// ../packages/core/content-manager/admin/src/pages/EditView/utils/forms.ts
...
var useDocument = (args, opts) => {
  ...
  const getInitialFormValues = React2.useCallback(
...
var useDocumentLayout = (model) => {
  ...
  const editLayout = React3.useMemo(
  ...
  const { layout: edit } = React3.useMemo(
...
//# sourceMappingURL=chunk-LAHJ77FA.js.map
