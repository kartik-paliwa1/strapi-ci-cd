...
// ../packages/core/admin/admin/src/features/StrapiApp.tsx
var [StrapiAppProvider, useStrapiApp] = createContext("StrapiApp");

// ../packages/core/admin/admin/src/hooks/useQueryParams.ts
var import_react = __toESM(require_react());
var import_qs = __toESM(require_lib());
var useSearch = () => {
  const { search } = useLocation();
  return (0, import_react.useMemo)(() => search, [search]);
};
...
// ../packages/core/admin/admin/src/reducer.ts
var STORAGE_KEYS = {
  TOKEN: "jwtToken",
  STATUS: "isLoggedIn"
};
...
// ../packages/core/admin/admin/src/services/auth.ts
...
// ../packages/core/admin/admin/src/features/Auth.tsx
...
var AuthProvider = ({
  ...
  const login2 = React.useCallback(
    ...
    async (permissions, passedPermissions, rawQueryContext) => {
      ...
      const matchingPermissions = actualUserPermissions.filter(
        (permission) => permissions.findIndex(
          (perm) => perm.action === permission.action && // Only check the subject if it's provided
          (perm.subject == void 0 || perm.subject === permission.subject)
        ) >= 0
      );
...
//# sourceMappingURL=chunk-Q5ERACUA.js.map
