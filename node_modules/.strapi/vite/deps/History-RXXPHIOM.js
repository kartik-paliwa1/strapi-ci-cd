...
// ../packages/core/content-manager/admin/src/history/pages/History.tsx
var React4 = __toESM(require_react());
var import_qs3 = __toESM(require_lib());

// ../packages/core/content-manager/admin/src/history/components/VersionContent.tsx
var React2 = __toESM(require_react());
var import_pipe = __toESM(require_pipe());
...
var FormPanel = ({ panel }) => {
  ...
  if (panel.some((row) => row.some((field) => field.type === "dynamiczone"))) {
    ...
    return (0, import_jsx_runtime2.jsx)(Grid.Root, { gap: 4, children: (0, import_jsx_runtime2.jsx)(Grid.Item, { col: 12, s: 12, xs: 12, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime2.jsx)(VersionInputRenderer, { ...field }) }) }, field.name);
  }
  return (0, import_jsx_runtime2.jsx)(
    Box,
    {
      ...
      children: (0, import_jsx_runtime2.jsx)(Flex, { direction: "column", alignItems: "stretch", gap: 6, children: panel.map((row, gridRowIndex) => {
        ...
        return (0, import_jsx_runtime2.jsx)(Grid.Root, { gap: 4, children: visibleFields.map(({ size, ...field }) => {
          return (0, import_jsx_runtime2.jsx)(
            Grid.Item,
            {
              col: size,
              ...
              direction: "column",
              alignItems: "stretch",
              children: (0, import_jsx_runtime2.jsx)(VersionInputRenderer, { ...field })
            },
            field.name
          );
        }) }, gridRowIndex);
...
var VersionContent = () => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Layouts.Content, { children: [
    (0, import_jsx_runtime2.jsx)(Box, { paddingBottom: 8, children: (0, import_jsx_runtime2.jsx)(Form, { disabled: true, method: "PUT", initialValues: transformedData, children: (0, import_jsx_runtime2.jsx)(Flex, { direction: "column", alignItems: "stretch", gap: 6, position: "relative", children: [...layout, ...remainingFieldsLayout].map((panel, index) => {
      return (0, import_jsx_runtime2.jsx)(FormPanel, { panel }, index);
    }) }) }) }),
    removedAttributesAsFields.length > 0 && (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      (0, import_jsx_runtime2.jsx)(Divider, {}),
      (0, import_jsx_runtime2.jsxs)(Box, { paddingTop: 8, children: [
        (0, import_jsx_runtime2.jsxs)(Flex, { direction: "column", alignItems: "flex-start", paddingBottom: 6, gap: 1, children: [
          (0, import_jsx_runtime2.jsx)(Typography, { variant: "delta", children: formatMessage({
            id: "content-manager.history.content.unknown-fields.title",
            defaultMessage: "Unknown fields"
          }) }),
          (0, import_jsx_runtime2.jsx)(Typography, { variant: "pi", children: formatMessage(
            {
            ...
            {
              b: (chunks) => (0, import_jsx_runtime2.jsx)(Typography, { variant: "pi", fontWeight: "bold", children: chunks })
            }
          ) })
        ] }),
        (0, import_jsx_runtime2.jsx)(Form, { disabled: true, method: "PUT", initialValues: version.data, children: (0, import_jsx_runtime2.jsx)(Flex, { direction: "column", alignItems: "stretch", gap: 6, position: "relative", children: unknownFieldsLayout.map((panel, index) => {
          return (0, import_jsx_runtime2.jsx)(FormPanel, { panel }, index);
        }) }) })
      ] })
    ] })
...
var VersionHeader = ({ headerId }) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(Dialog.Root, { open: isConfirmDialogOpen, onOpenChange: setIsConfirmDialogOpen, children: [
    (0, import_jsx_runtime3.jsx)(
      Layouts.BaseHeader,
      {
        ...
        secondaryAction: (0, import_jsx_runtime3.jsx)(
          GradientBadgeWithIcon,
          {
            label: formatMessage({
        ...
        subtitle: (0, import_jsx_runtime3.jsx)(Typography, { variant: "epsilon", textColor: "neutral600", children: formatMessage(
          {
        ...
        navigationAction: (0, import_jsx_runtime3.jsx)(
          Link2,
          {
        ...
        sticky: false,
        primaryAction: (0, import_jsx_runtime3.jsx)(Dialog.Trigger, { children: (0, import_jsx_runtime3.jsx)(
          Button,
          {
    ...
    (0, import_jsx_runtime3.jsx)(
      ConfirmDialog,
      {
        ...
        endAction: (0, import_jsx_runtime3.jsx)(Button, { variant: "secondary", onClick: handleRestore, loading: isLoading, children: formatMessage({
          id: "content-manager.history.restore.confirm.button",
          defaultMessage: "Restore"
        }) }),
        children: (0, import_jsx_runtime3.jsxs)(
          Flex,
          {
            ...
            children: [
              ...
              (0, import_jsx_runtime3.jsx)(Typography, { children: formatMessage({
...
// ../packages/core/content-manager/admin/src/history/components/VersionsList.tsx
var import_qs2 = __toESM(require_lib());
var import_jsx_runtime4 = __toESM(require_jsx_runtime());
var BlueText = (children) => (0, import_jsx_runtime4.jsx)(Typography, { textColor: "primary600", variant: "pi", children });
var VersionCard = ({ version, isCurrent }) => {
  ...
  return (0, import_jsx_runtime4.jsxs)(
    Flex,
    {
      ...
      padding: 5,
      tag: Link,
      to: `?${(0, import_qs2.stringify)({ ...query, id: version.id })}`,
      style: { textDecoration: "none" },
      children: [
        (0, import_jsx_runtime4.jsxs)(Flex, { direction: "column", gap: 1, alignItems: "flex-start", children: [
          (0, import_jsx_runtime4.jsx)(Typography, { tag: "h3", fontWeight: "semiBold", children: formatDate(version.createdAt, {
            day: "numeric",
            month: "numeric",
            year: "numeric",
            hour: "2-digit",
          ...
          (0, import_jsx_runtime4.jsx)(Typography, { tag: "p", variant: "pi", textColor: "neutral600", children: formatMessage(
            {
            ...
            {
              distanceToNow: (0, import_jsx_runtime4.jsx)(RelativeTime, { timestamp: new Date(version.createdAt) }),
              author,
        ...
        version.status && (0, import_jsx_runtime4.jsx)(DocumentStatus, { status: version.status, size: "XS" })
      ]
    }
  );
};
var PaginationButton = ({ page, children }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(Link, { to: { search: (0, import_qs2.stringify)({ ...queryRest, page }) }, style: { textDecoration: "none" }, children: (0, import_jsx_runtime4.jsx)(Typography, { variant: "omega", textColor: "primary600", children }) });
};
var VersionsList = () => {
  const { formatMessage } = useIntl();
      ...
      children: [
        (0, import_jsx_runtime4.jsxs)(
          Flex,
          {
            ...
            tag: "header",
            children: [
              (0, import_jsx_runtime4.jsx)(Typography, { tag: "h2", variant: "omega", fontWeight: "semiBold", children: formatMessage({
                id: "content-manager.history.sidebar.title",
                defaultMessage: "Versions"
              }) }),
              (0, import_jsx_runtime4.jsx)(Box, { background: "neutral150", hasRadius: true, padding: 1, children: (0, import_jsx_runtime4.jsx)(Typography, { variant: "sigma", textColor: "neutral600", children: versions.meta.pagination.total }) })
            ]
          }
        ),
        (0, import_jsx_runtime4.jsxs)(Box, { flex: 1, overflow: "auto", children: [
          versions.meta.pagination.page > 1 && (0, import_jsx_runtime4.jsx)(Box, { paddingTop: 4, textAlign: "center", children: (0, import_jsx_runtime4.jsx)(PaginationButton, { page: page - 1, children: formatMessage({
            id: "content-manager.history.sidebar.show-newer",
            defaultMessage: "Show newer versions"
          }) }) }),
          (0, import_jsx_runtime4.jsx)(Flex, { direction: "column", gap: 3, padding: 4, tag: "ul", alignItems: "stretch", children: versions.data.map((version, index) => (0, import_jsx_runtime4.jsx)(
            "li",
            {
              ...
              children: (0, import_jsx_runtime4.jsx)(VersionCard, { version, isCurrent: page === 1 && index === 0 })
            },
            version.id
          )) }),
          versions.meta.pagination.page < versions.meta.pagination.pageCount && (0, import_jsx_runtime4.jsx)(Box, { paddingBottom: 4, textAlign: "center", children: (0, import_jsx_runtime4.jsx)(PaginationButton, { page: page + 1, children: formatMessage({
...
var HistoryPage = () => {
  ...
  if (!slug || collectionType === COLLECTION_TYPES && !documentId) {
    return (0, import_jsx_runtime5.jsx)(Navigate, { to: "/content-manager" });
  }
  ...
  if (!versionsResponse.isError && !((_b = (_a = versionsResponse.data) == null ? void 0 : _a.data) == null ? void 0 : _b.length)) {
    return (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: (0, import_jsx_runtime5.jsx)(
      Page.NoData,
      {
        action: (0, import_jsx_runtime5.jsx)(
          Link2,
          {
            tag: NavLink,
  ...
  if (((_d = (_c = versionsResponse.data) == null ? void 0 : _c.data) == null ? void 0 : _d.length) && !selectedVersionId) {
    return (0, import_jsx_runtime5.jsx)(
      Navigate,
      {
        to: { search: (0, import_qs3.stringify)({ ...query, id: versionsResponse.data.data[0].id }) },
        replace: true
      }
    );
  }
  ...
  return (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
    (0, import_jsx_runtime5.jsx)(Page.Title, { children: formatMessage(
      {
    ...
    (0, import_jsx_runtime5.jsx)(
      HistoryProvider,
      {
        ...
        page,
        mainField,
        children: (0, import_jsx_runtime5.jsxs)(Flex, { direction: "row", alignItems: "flex-start", children: [
          (0, import_jsx_runtime5.jsxs)(
            Main,
            {
              ...
              labelledBy: headerId,
              children: [
                (0, import_jsx_runtime5.jsx)(VersionHeader, { headerId }),
...
var ProtectedHistoryPageImpl = () => {
  ...
  return (0, import_jsx_runtime5.jsx)(
    Box,
    {
      ...
      zIndex: 2,
      background: "neutral0",
      children: (0, import_jsx_runtime5.jsx)(Page.Protect, { permissions, children: ({ permissions: permissions2 }) => (0, import_jsx_runtime5.jsx)(DocumentRBAC, { permissions: permissions2, children: (0, import_jsx_runtime5.jsx)(HistoryPage, {}) }) })
    }
  );
};
var ProtectedHistoryPage = () => {
  return (0, import_jsx_runtime5.jsx)(Portal$1, { children: (0, import_jsx_runtime5.jsx)(FocusTrap, { children: (0, import_jsx_runtime5.jsx)(ProtectedHistoryPageImpl, {}) }) });
};
export {
  HistoryProvider,
...
//# sourceMappingURL=History-RXXPHIOM.js.map
