...
// ../packages/core/admin/admin/src/services/homepage.ts
...
// ../packages/core/admin/admin/src/render.ts
...
import Logo2 from "/Users/kartikpaliwal/Downloads/strapi-develop/packages/core/admin/admin/src/assets/images/logo-strapi-2022.svg";

// ../packages/core/admin/admin/src/core/apis/CustomFields.ts
...
// ../packages/core/admin/admin/src/core/apis/Plugin.ts
var _a;
_a = L;
var Plugin = class {
...
// ../packages/core/admin/admin/src/core/apis/rbac.ts
var RBAC = class {
  constructor() {
...
// ../packages/core/admin/admin/src/core/apis/router.tsx
...
// ../packages/core/admin/admin/src/components/Theme.tsx
...
var Providers = ({ children, strapi, store }) => {
  ...
  return (0, import_jsx_runtime3.jsx)(
    StrapiAppProvider,
    {
      ...
      children: (0, import_jsx_runtime3.jsx)(Provider_default, { store, children: (0, import_jsx_runtime3.jsx)(QueryClientProvider, { client: queryClient, children: (0, import_jsx_runtime3.jsx)(AuthProvider, { children: (0, import_jsx_runtime3.jsx)(HistoryProvider, { children: (0, import_jsx_runtime3.jsx)(LanguageProvider, { messages: strapi.configurations.translations, children: (0, import_jsx_runtime3.jsx)(Theme, { themes: strapi.configurations.themes, children: (0, import_jsx_runtime3.jsx)(NotificationsProvider, { children: (0, import_jsx_runtime3.jsx)(TrackingProvider, { children: (0, import_jsx_runtime3.jsx)(GuidedTourContext, { enabled: isGuidedTourEnabled, children: (0, import_jsx_runtime3.jsx)(
        ConfigurationProvider,
        {
...
var App = ({ strapi, store }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(Providers, { strapi, store, children: (0, import_jsx_runtime4.jsx)(import_react.Suspense, { fallback: (0, import_jsx_runtime4.jsx)(Page.Loading, {}), children: (0, import_jsx_runtime4.jsx)(Outlet, {}) }) });
};
...
\`\`\`
    ...
    return (0, import_jsx_runtime5.jsx)(Main, { height: "100%", children: (0, import_jsx_runtime5.jsx)(Flex, { alignItems: "center", height: "100%", justifyContent: "center", children: (0, import_jsx_runtime5.jsxs)(
      Flex,
      {
        gap: 7,
        padding: 7,
        ...
        maxWidth: "512px",
        children: [
          (0, import_jsx_runtime5.jsxs)(Flex, { direction: "column", gap: 2, children: [
            (0, import_jsx_runtime5.jsx)(ForwardRef$5, { width: "32px", height: "32px", fill: "danger600" }),
            (0, import_jsx_runtime5.jsx)(Typography, { fontSize: 4, fontWeight: "bold", textAlign: "center", children: formatMessage({
              id: "app.error",
              defaultMessage: "Something went wrong"
            }) }),
            (0, import_jsx_runtime5.jsx)(Typography, { variant: "omega", textAlign: "center", children: formatMessage(
              {
              ...
              {
                link: (0, import_jsx_runtime5.jsx)(
                  Link2,
                  {
                    isExternal: true,
                    endIcon: true,
          ...
          (0, import_jsx_runtime5.jsxs)(Flex, { gap: 4, direction: "column", width: "100%", children: [
            (0, import_jsx_runtime5.jsx)(StyledAlert, { onClose: () => {
            }, width: "100%", closeLabel: "", variant: "danger", children: (0, import_jsx_runtime5.jsx)(ErrorType, { children: error.message }) }),
            (0, import_jsx_runtime5.jsx)(Button, { onClick: handleClick, variant: "tertiary", startIcon: (0, import_jsx_runtime5.jsx)(ForwardRef$3Z, {}), children: formatMessage({
              id: "app.error.copy",
...
// ../packages/core/admin/admin/src/pages/NotFoundPage.tsx
var import_jsx_runtime6 = __toESM(require_jsx_runtime());
var NotFoundPage = () => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime6.jsxs)(Page.Main, { labelledBy: "title", children: [
    ...
    (0, import_jsx_runtime6.jsx)(Layouts.Content, { children: (0, import_jsx_runtime6.jsx)(
      EmptyStateLayout,
      {
        action: (0, import_jsx_runtime6.jsx)(LinkButton, { tag: Link, variant: "secondary", endIcon: (0, import_jsx_runtime6.jsx)(ForwardRef$5l, {}), to: "/", children: formatMessage({
        ...
        hasRadius: true,
        icon: (0, import_jsx_runtime6.jsx)(ForwardRef$F, { width: "16rem" }),
        shadow: "tableShadow"
      }
    ) })
  ] });
...
// ../packages/core/admin/ee/admin/src/pages/SettingsPage/constants.ts
var getEERoutes2 = () => [
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-VAEHZCY3.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-5F7J7FSV.js");
        return {
...
// ../packages/core/admin/admin/src/pages/Auth/components/ForgotPassword.tsx
...
var ForgotPassword = () => {
  ...
  return (0, import_jsx_runtime7.jsx)(UnauthenticatedLayout, { children: (0, import_jsx_runtime7.jsxs)(Main, { children: [
    (0, import_jsx_runtime7.jsxs)(LayoutContent, { children: [
      (0, import_jsx_runtime7.jsxs)(Column, { children: [
        (0, import_jsx_runtime7.jsx)(Logo, {}),
        (0, import_jsx_runtime7.jsx)(Box, { paddingTop: 6, paddingBottom: 7, children: (0, import_jsx_runtime7.jsx)(Typography, { tag: "h1", variant: "alpha", children: formatMessage({
          id: "Auth.form.button.password-recovery",
          defaultMessage: "Password Recovery"
        }) }) }),
        error ? (0, import_jsx_runtime7.jsx)(Typography, { id: "global-form-error", role: "alert", tabIndex: -1, textColor: "danger600", children: isBaseQueryError(error) ? formatAPIError(error) : formatMessage({
      ...
      (0, import_jsx_runtime7.jsx)(
        Form,
        {
          ...
          children: (0, import_jsx_runtime7.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
            [
              {
            ...
            ].map((field) => (0, import_jsx_runtime7.jsx)(MemoizedInputRenderer, { ...field }, field.name)),
            (0, import_jsx_runtime7.jsx)(Button, { type: "submit", fullWidth: true, children: formatMessage({
    ...
    (0, import_jsx_runtime7.jsx)(Flex, { justifyContent: "center", children: (0, import_jsx_runtime7.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime7.jsx)(Link2, { tag: NavLink, to: "/auth/login", children: formatMessage({ id: "Auth.link.ready", defaultMessage: "Ready to sign in?" }) }) }) })
  ] }) });
};

// ../packages/core/admin/admin/src/pages/Auth/components/ForgotPasswordSuccess.tsx
var import_jsx_runtime8 = __toESM(require_jsx_runtime());
var ForgotPasswordSuccess = () => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime8.jsx)(UnauthenticatedLayout, { children: (0, import_jsx_runtime8.jsxs)(Main, { children: [
    (0, import_jsx_runtime8.jsx)(LayoutContent, { children: (0, import_jsx_runtime8.jsxs)(Column, { children: [
      (0, import_jsx_runtime8.jsx)(Logo, {}),
      (0, import_jsx_runtime8.jsx)(Box, { paddingTop: 6, paddingBottom: 7, children: (0, import_jsx_runtime8.jsx)(Typography, { tag: "h1", variant: "alpha", children: formatMessage({
        id: "app.containers.AuthPage.ForgotPasswordSuccess.title",
        defaultMessage: "Email sent"
      }) }) }),
      (0, import_jsx_runtime8.jsx)(Typography, { children: formatMessage({
      ...
      (0, import_jsx_runtime8.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime8.jsx)(Typography, { children: formatMessage({
    ...
    (0, import_jsx_runtime8.jsx)(Flex, { justifyContent: "center", children: (0, import_jsx_runtime8.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime8.jsx)(Link2, { tag: NavLink, to: "/auth/login", children: formatMessage({ id: "Auth.link.signin", defaultMessage: "Sign in" }) }) }) })
  ] }) });
};

// ../packages/core/admin/admin/src/pages/Auth/components/Oops.tsx
...
var Oops = () => {
  ...
  return (0, import_jsx_runtime9.jsx)(UnauthenticatedLayout, { children: (0, import_jsx_runtime9.jsxs)(Main, { children: [
    (0, import_jsx_runtime9.jsx)(LayoutContent, { children: (0, import_jsx_runtime9.jsxs)(Column, { children: [
      (0, import_jsx_runtime9.jsx)(Logo, {}),
      (0, import_jsx_runtime9.jsx)(Box, { paddingTop: 6, paddingBottom: 7, children: (0, import_jsx_runtime9.jsx)(Typography, { tag: "h1", variant: "alpha", children: formatMessage({ id: "Auth.components.Oops.title", defaultMessage: "Oops..." }) }) }),
      (0, import_jsx_runtime9.jsx)(Typography, { children: message }),
      (0, import_jsx_runtime9.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime9.jsx)(Typography, { children: formatMessage({
        id: "Auth.components.Oops.text.admin",
        defaultMessage: "If this is a mistake, please contact your administrator."
      }) }) })
    ] }) }),
    (0, import_jsx_runtime9.jsx)(Flex, { justifyContent: "center", children: (0, import_jsx_runtime9.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime9.jsx)(Link2, { tag: NavLink, to: "/auth/login", children: formatMessage({ id: "Auth.link.signin", defaultMessage: "Sign in" }) }) }) })
  ] }) });
};
...
var Register = ({ hasAdmin }) => {
  ...
  const { formatMessage } = useIntl();
  const { search: searchString } = useLocation();
  const query = React3.useMemo(() => new URLSearchParams(searchString), [searchString]);
  ...
  if (!match || match.params.authType !== "register" && match.params.authType !== "register-admin") {
    return (0, import_jsx_runtime10.jsx)(Navigate, { to: "/" });
  }
  ...
  return (0, import_jsx_runtime10.jsx)(UnauthenticatedLayout, { children: (0, import_jsx_runtime10.jsxs)(LayoutContent, { children: [
    (0, import_jsx_runtime10.jsxs)(Flex, { direction: "column", alignItems: "center", gap: 3, children: [
      (0, import_jsx_runtime10.jsx)(Logo, {}),
      (0, import_jsx_runtime10.jsx)(Typography, { tag: "h1", variant: "alpha", textAlign: "center", children: formatMessage({
        id: "Auth.form.welcome.title",
        defaultMessage: "Welcome to Strapi!"
      }) }),
      (0, import_jsx_runtime10.jsx)(Typography, { variant: "epsilon", textColor: "neutral600", textAlign: "center", children: formatMessage({
        id: "Auth.form.register.subtitle",
        defaultMessage: "Credentials are only used to authenticate in Strapi. All saved data will be stored in your database."
      }) }),
      apiError ? (0, import_jsx_runtime10.jsx)(Typography, { id: "global-form-error", role: "alert", tabIndex: -1, textColor: "danger600", children: apiError }) : null
    ] }),
    (0, import_jsx_runtime10.jsx)(
      Form,
      {
        ...
        children: (0, import_jsx_runtime10.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 6, marginTop: 7, children: [
          (0, import_jsx_runtime10.jsx)(Grid.Root, { gap: 4, children: [
            {
              label: formatMessage({
            ...
            },
            {
              label: formatMessage(
                ...
                {
                  terms: (0, import_jsx_runtime10.jsx)(A, { target: "_blank", href: "https://strapi.io/terms", rel: "noreferrer", children: formatMessage({
                    id: "Auth.privacy-policy-agreement.terms",
                    defaultMessage: "terms"
                  }) }),
                  policy: (0, import_jsx_runtime10.jsx)(A, { target: "_blank", href: "https://strapi.io/privacy", rel: "noreferrer", children: formatMessage({
          ...
          ].map(({ size, ...field }) => (0, import_jsx_runtime10.jsx)(Grid.Item, { col: size, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime10.jsx)(MemoizedInputRenderer, { ...field }) }, field.name)) }),
          (0, import_jsx_runtime10.jsx)(Button, { fullWidth: true, size: "L", type: "submit", children: formatMessage({
    ...
    (match == null ? void 0 : match.params.authType) === "register" && (0, import_jsx_runtime10.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime10.jsx)(Flex, { justifyContent: "center", children: (0, import_jsx_runtime10.jsx)(Link2, { tag: NavLink, to: "/auth/login", children: formatMessage({
...
var ResetPassword = () => {
  ...
  const navigate = useNavigate();
  const { search: searchString } = useLocation();
  const query = React4.useMemo(() => new URLSearchParams(searchString), [searchString]);
  const { _unstableFormatAPIError: formatAPIError } = useAPIErrorHandler();
  ...
  if (!query.get("code")) {
    return (0, import_jsx_runtime11.jsx)(Navigate, { to: "/auth/login" });
  }
  return (0, import_jsx_runtime11.jsx)(UnauthenticatedLayout, { children: (0, import_jsx_runtime11.jsxs)(Main, { children: [
    (0, import_jsx_runtime11.jsxs)(LayoutContent, { children: [
      (0, import_jsx_runtime11.jsxs)(Column, { children: [
        (0, import_jsx_runtime11.jsx)(Logo, {}),
        (0, import_jsx_runtime11.jsx)(Box, { paddingTop: 6, paddingBottom: 7, children: (0, import_jsx_runtime11.jsx)(Typography, { tag: "h1", variant: "alpha", children: formatMessage({
          id: "global.reset-password",
          defaultMessage: "Reset password"
        }) }) }),
        error ? (0, import_jsx_runtime11.jsx)(Typography, { id: "global-form-error", role: "alert", tabIndex: -1, textColor: "danger600", children: isBaseQueryError(error) ? formatAPIError(error) : formatMessage({
          id: "notification.error",
          defaultMessage: "An error occurred"
        }) }) : null
      ] }),
      (0, import_jsx_runtime11.jsx)(
        Form,
        {
          ...
          children: (0, import_jsx_runtime11.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
            [
              {
                hint: formatMessage({
                  id: "Auth.form.password.hint",
            ...
            ].map((field) => (0, import_jsx_runtime11.jsx)(MemoizedInputRenderer, { ...field }, field.name)),
            (0, import_jsx_runtime11.jsx)(Button, { fullWidth: true, type: "submit", children: formatMessage({
    ...
    (0, import_jsx_runtime11.jsx)(Flex, { justifyContent: "center", children: (0, import_jsx_runtime11.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime11.jsx)(Link2, { tag: NavLink, to: "/auth/login", children: formatMessage({ id: "Auth.link.ready", defaultMessage: "Ready to sign in?" }) }) }) })
  ] }) });
};

// ../packages/core/admin/admin/src/pages/Auth/constants.ts
var FORMS = {
...
var AuthPage = () => {
  ...
  const Login2 = useEnterprise(
    Login,
    async () => (await import("./Login-BMPCDZAE.js")).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import("./constants-YB6YIKD5.js")).FORMS,
    {
  ...
  if (!authType || !forms) {
    return (0, import_jsx_runtime12.jsx)(Navigate, { to: "/" });
  }
  ...
  if (Login2 && authType === "login") {
    return (0, import_jsx_runtime12.jsx)(Login2, {});
  } else if (authType === "login" && !Login2) {
    return null;
  }
  return (0, import_jsx_runtime12.jsx)(Component, { hasAdmin });
};
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-O45DD5EB.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-UFQLQBW7.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-ZFPTTRW6.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-FN7RVNCE.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-EKF5XOPM.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-PNYUJE4K.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-D3LNQKHO.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-EN7NOEPK.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-GP4OKJI6.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-SSUH2HS4.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-D2VZLR7A.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-NVTDNJRI.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-7XIRIHNB.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-FTK5ALIJ.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-WRBST7TP.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-PA5G3W5G.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-VOZ6LBPT.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-QOXXFKFB.js");
      return {
...
// ../packages/core/admin/admin/src/router.tsx
var import_jsx_runtime13 = __toESM(require_jsx_runtime());
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-O5EGWQAB.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-Q7Q23GBP.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-EUK5CNPG.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-GKCK4I7W.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-EDN5C27J.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-U5YLRYLF.js");
          return {
...
var Router = class {
  constructor(initialRoutes) {
    ...
    __publicField(this, "addMenuLink", (link) => {
      ...
      (0, import_invariant2.default)(
        ((_a2 = link.intlLabel) == null ? void 0 : _a2.id) && ((_b = link.intlLabel) == null ? void 0 : _b.defaultMessage),
  ...
  createRouter(strapi, { memory, ...opts } = {}) {
    const routes = [
      {
        path: "/*",
        errorElement: (0, import_jsx_runtime14.jsx)(Provider_default, { store: strapi.store, children: (0, import_jsx_runtime14.jsx)(LanguageProvider, { messages: strapi.configurations.translations, children: (0, import_jsx_runtime14.jsx)(Theme, { themes: strapi.configurations.themes, children: (0, import_jsx_runtime14.jsx)(ErrorElement, {}) }) }) }),
        element: (0, import_jsx_runtime14.jsx)(App, { strapi, store: strapi.store }),
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-YERGARXW.js");
              return {
  ...
  addSettingsLink(section, link) {
    ...
    if (typeof section === "object" && "links" in section) {
      ...
      (0, import_invariant2.default)(
        ((_a2 = section.intlLabel) == null ? void 0 : _a2.id) && ((_b = section.intlLabel) == null ? void 0 : _b.defaultMessage),
...
var Widgets = class {
  constructor() {
    ...
    __publicField(this, "generateUid", (widget) => {
      return widget.pluginId ? `plugin::${widget.pluginId}.${widget.id}` : `global::${widget.id}`;
    });
    __publicField(this, "checkWidgets", (widgets) => {
...
// ../packages/core/admin/admin/src/core/store/configure.ts
var staticReducers = {
...
var rtkQueryUnauthorizedMiddleware = ({ dispatch }) => (next) => (action) => {
  var _a2;
  if (isRejected(action) && ((_a2 = action.payload) == null ? void 0 : _a2.status) === 401) {
    dispatch(logout());
...
// ../packages/core/admin/admin/src/core/utils/createHook.ts
var createHook = () => {
  const _handlers = [];
  return {
    register(fn) {
...
// ../packages/core/admin/admin/src/translations/languageNativeNames.ts
...
// import("./translations/**/*.js") in ../packages/core/admin/admin/src/StrapiApp.tsx
var globImport_translations_js = __glob({
  "./translations/en-GB.js": () => import("./en-GB-3EBJRJ3P.js")
});

// import("./translations/**/*.json") in ../packages/core/admin/admin/src/StrapiApp.tsx
var globImport_translations_json = __glob({
  "./translations/ar.json": () => import("./ar-DCPI26AY.js"),
  "./translations/ca.json": () => import("./ca-74FN6GHI.js"),
  "./translations/cs.json": () => import("./cs-IFMCFM47.js"),
  "./translations/de.json": () => import("./de-WGH2HS7H.js"),
  "./translations/dk.json": () => import("./dk-GLOYUMTT.js"),
  "./translations/en.json": () => import("./en-C5HRAYKH.js"),
  "./translations/es.json": () => import("./es-DNZ2J7KP.js"),
  "./translations/eu.json": () => import("./eu-Q7ABBRDT.js"),
  "./translations/fr.json": () => import("./fr-2BKZMMFK.js"),
  "./translations/gu.json": () => import("./gu-HA4ZM4CR.js"),
  "./translations/he.json": () => import("./he-UKNIHOCD.js"),
  "./translations/hi.json": () => import("./hi-GOBMIGNZ.js"),
  "./translations/hu.json": () => import("./hu-7AIYTBZE.js"),
  "./translations/id.json": () => import("./id-7XDJ6ONA.js"),
  "./translations/it.json": () => import("./it-6334GKCN.js"),
  "./translations/ja.json": () => import("./ja-VHVS7DMN.js"),
  "./translations/ko.json": () => import("./ko-MR4WMWIY.js"),
  "./translations/ml.json": () => import("./ml-KPQ2O77U.js"),
  "./translations/ms.json": () => import("./ms-7UILY5P4.js"),
  "./translations/nl.json": () => import("./nl-ARQZDZOK.js"),
  "./translations/no.json": () => import("./no-R4L5RO5E.js"),
  "./translations/pl.json": () => import("./pl-GZVL6T56.js"),
  "./translations/pt-BR.json": () => import("./pt-BR-JU6C57Z2.js"),
  "./translations/pt.json": () => import("./pt-TJSMOI74.js"),
  "./translations/ru.json": () => import("./ru-6XHVR5HG.js"),
  "./translations/sa.json": () => import("./sa-KOOS4P6W.js"),
  "./translations/sk.json": () => import("./sk-YHIFUYOV.js"),
  "./translations/sv.json": () => import("./sv-GTSKVESZ.js"),
  "./translations/th.json": () => import("./th-LYKRBZ4M.js"),
  "./translations/tr.json": () => import("./tr-22XSYFBF.js"),
  "./translations/uk.json": () => import("./uk-GZ5ARQKN.js"),
  "./translations/vi.json": () => import("./vi-VY3UUQLB.js"),
  "./translations/zh-Hans.json": () => import("./zh-Hans-TCXT4MNC.js"),
  "./translations/zh.json": () => import("./zh-WBLBHTQS.js")
});
...
var StrapiApp = class {
  constructor({ config, appPlugins } = {}) {
    ...
    __publicField(this, "widgets", new Widgets());
    ...
    __publicField(this, "createCustomConfigurations", (customConfig) => {
      ...
      if (customConfig.locales) {
        this.configurations.locales = [
          "en",
          ...((_a2 = customConfig.locales) == null ? void 0 : _a2.filter((loc) => loc !== "en")) || []
        ];
      }
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-MQCAMPA7.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-MQCAMPA7.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-73ZPHCHK.js");
  ...
  async loadAdminTrads() {
    const adminLocales = await Promise.all(
      this.configurations.locales.map(async (locale) => {
        try {
          const { default: data } = await globImport_translations_js(`./translations/${locale}.js`);
          return { data, locale };
        } catch {
          try {
            const { default: data } = await globImport_translations_json(`./translations/${locale}.json`);
            return { data, locale };
          } catch {
  ...
  render() {
    ...
    return (0, import_jsx_runtime15.jsx)(RouterProvider, { router });
  }
};
...
var renderAdmin = async (mountNode, { plugins, customisations, features }) => {
  ...
  window.strapi = {
    ...
    future: {
      isEnabled: (name) => {
        var _a3;
        return ((_a3 = features == null ? void 0 : features.future) == null ? void 0 : _a3[name]) === true;
      }
    },
  ...
  try {
    const {
      data: {
        data: { isEE, isTrial, features: features2, flags }
      }
  ...
  await app.loadTrads((_a2 = customisations == null ? void 0 : customisations.config) == null ? void 0 : _a2.translations);
...
// ../packages/core/admin/admin/src/components/DescriptionComponentRenderer.tsx
var React7 = __toESM(require_react());
var import_isEqual = __toESM(require_isEqual());

// ../packages/core/admin/admin/src/hooks/useForceUpdate.ts
var React6 = __toESM(require_react());

// ../packages/core/admin/admin/src/hooks/useIsMounted.ts
...
// ../packages/core/admin/admin/src/hooks/useThrottledCallback.ts
var import_react2 = __toESM(require_react());
var import_throttle = __toESM(require_throttle());
var useThrottledCallback = (callback, wait, options) => {
  const throttledCallback = (0, import_react2.useMemo)(
...
var DescriptionComponentRenderer = ({
  ...
  const states = React7.useMemo(
    () => ids2.map((id) => {
      var _a2;
      return (_a2 = statesRef.current[id]) == null ? void 0 : _a2.value;
  ...
  return (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
    descriptions.map((description) => {
      ...
      return (0, import_jsx_runtime16.jsx)(Description, { id: key, description, props, update }, key);
    }),
    children(states)
  ] });
};
var Description = React7.memo(
...
// ../packages/core/admin/admin/src/hooks/useInjectReducer.ts
...
// ../packages/core/admin/admin/src/utils/rulesEngine.ts
...
var ConditionSchema = external_exports.object({
  ...
  operator: external_exports.enum(["is", "isNot"]),
...
//# sourceMappingURL=chunk-4JEMFY4B.js.map
