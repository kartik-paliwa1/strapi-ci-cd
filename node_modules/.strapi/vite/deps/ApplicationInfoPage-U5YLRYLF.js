...
// ../packages/core/admin/admin/src/pages/Settings/pages/ApplicationInfo/utils/constants.ts
var DIMENSION = 750;
var SIZE = 100;
var ACCEPTED_FORMAT = ["image/jpeg", "image/png", "image/svg+xml"];

// ../packages/core/admin/admin/src/pages/Settings/pages/ApplicationInfo/utils/files.ts
    ...
    (0, import_jsx_runtime.jsx)("form", { children: (0, import_jsx_runtime.jsx)(Box, { paddingLeft: 8, paddingRight: 8, paddingTop: 6, paddingBottom: 6, children: (0, import_jsx_runtime.jsx)(Field.Root, { name: id, error: fileError, children: (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 2, children: [
      (0, import_jsx_runtime.jsxs)(
        Flex,
        {
          ...
          children: [
            (0, import_jsx_runtime.jsx)(ForwardRef$1j, { fill: "primary600", width: "6rem", height: "6rem", "aria-hidden": true }),
...
var ApplicationInfoPage = () => {
  ...
  const [logos, setLogos] = React2.useState({ menu: serverLogos.menu, auth: serverLogos.auth });
  ...
  const AdminSeatInfo = useEnterprise(
    AdminSeatInfoCE,
    async () => (await import("./AdminSeatInfo-IG3FWUKI.js")).AdminSeatInfoEE
  );
  const {
  ...
  return (0, import_jsx_runtime2.jsxs)(Layouts.Root, { children: [
    ...
    (0, import_jsx_runtime2.jsx)(Page.Main, { children: (0, import_jsx_runtime2.jsxs)("form", { onSubmit: handleSubmit, children: [
      (0, import_jsx_runtime2.jsx)(
        Layouts.Header,
        {
          ...
          primaryAction: canUpdate && (0, import_jsx_runtime2.jsx)(Button, { disabled: isSaveDisabled, type: "submit", startIcon: (0, import_jsx_runtime2.jsx)(ForwardRef$4N, {}), children: formatMessage({ id: "global.save", defaultMessage: "Save" }) })
        }
      ),
      (0, import_jsx_runtime2.jsx)(Layouts.Content, { children: (0, import_jsx_runtime2.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
        (0, import_jsx_runtime2.jsxs)(
          Flex,
          {
            ...
            paddingLeft: 7,
            children: [
              (0, import_jsx_runtime2.jsx)(Typography, { variant: "delta", tag: "h3", children: formatMessage({
                id: "global.details",
                defaultMessage: "Details"
              }) }),
              (0, import_jsx_runtime2.jsxs)(Grid.Root, { gap: 5, tag: "dl", children: [
                (0, import_jsx_runtime2.jsxs)(Grid.Item, { col: 6, s: 12, direction: "column", alignItems: "start", children: [
                  (0, import_jsx_runtime2.jsx)(Typography, { variant: "sigma", textColor: "neutral600", tag: "dt", children: formatMessage({
                    id: "Settings.application.strapiVersion",
                    defaultMessage: "strapi version"
                  }) }),
                  (0, import_jsx_runtime2.jsxs)(Flex, { gap: 3, direction: "column", alignItems: "start", tag: "dd", children: [
                    (0, import_jsx_runtime2.jsxs)(Typography, { children: [
                      "v",
                      strapiVersion
                    ] }),
                    shouldUpdateStrapi && (0, import_jsx_runtime2.jsx)(
                      Link,
                      {
                ...
                (0, import_jsx_runtime2.jsxs)(Grid.Item, { col: 6, s: 12, direction: "column", alignItems: "start", children: [
                  ...
                  (0, import_jsx_runtime2.jsxs)(Flex, { gap: 3, direction: "column", alignItems: "start", tag: "dd", children: [
                    ...
                    (0, import_jsx_runtime2.jsx)(Link, { href: "https://strapi.io/pricing-self-hosted", endIcon: (0, import_jsx_runtime2.jsx)(ForwardRef$3N, {}), children: formatMessage({
                ...
                (0, import_jsx_runtime2.jsxs)(Grid.Item, { col: 6, s: 12, direction: "column", alignItems: "start", children: [
                  ...
                  (0, import_jsx_runtime2.jsx)(Typography, { tag: "dd", children: nodeVersion })
                ] }),
        ...
        canRead && (0, import_jsx_runtime2.jsxs)(
          Box,
          {
            hasRadius: true,
            background: "neutral0",
            ...
            children: [
              ...
              (0, import_jsx_runtime2.jsxs)(Grid.Root, { paddingTop: 4, gap: 4, children: [
                (0, import_jsx_runtime2.jsx)(Grid.Item, { col: 6, s: 12, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime2.jsx)(
                  LogoInput,
                  {
                    canUpdate,
...
//# sourceMappingURL=ApplicationInfoPage-U5YLRYLF.js.map
