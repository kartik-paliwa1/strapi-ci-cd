...
// ../packages/core/content-releases/admin/src/components/EntryValidationPopover.tsx
...
`;
var CustomStatusButton = ({
  children,
  icon,
  color
}) => {
  return (0, import_jsx_runtime.jsx)(Popover.Trigger, { children: (0, import_jsx_runtime.jsx)(Button, { variant: "ghost", endIcon: (0, import_jsx_runtime.jsx)(ForwardRef$4$, {}), children: (0, import_jsx_runtime.jsxs)(ButtonContent, { color, gap: 2, children: [
    icon,
    (0, import_jsx_runtime.jsx)(Typography, { textColor: color, variant: "omega", fontWeight: "bold", children })
  ] }) }) });
};
var EntryStatusTrigger = ({
  ...
  if (action === "publish") {
    if (hasErrors || requiredStage && requiredStage.id !== (entryStage == null ? void 0 : entryStage.id)) {
      return (0, import_jsx_runtime.jsx)(CustomStatusButton, { icon: (0, import_jsx_runtime.jsx)(ForwardRef$4b, {}), color: "danger600", children: formatMessage({
        id: "content-releases.pages.ReleaseDetails.entry-validation.not-ready",
        defaultMessage: "Not ready to publish"
      }) });
    }
    if (status === "draft") {
      return (0, import_jsx_runtime.jsx)(CustomStatusButton, { icon: (0, import_jsx_runtime.jsx)(ForwardRef$4L, {}), color: "success600", children: formatMessage({
        id: "content-releases.pages.ReleaseDetails.entry-validation.ready-to-publish",
        defaultMessage: "Ready to publish"
      }) });
    }
    if (status === "modified") {
      return (0, import_jsx_runtime.jsx)(CustomStatusButton, { icon: (0, import_jsx_runtime.jsx)(ForwardRef$5h, {}), color: "alternative600", children: formatMessage({
...
var FieldsValidation = ({
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", gap: 1, width: "100%", padding: 5, children: [
    (0, import_jsx_runtime.jsxs)(Flex, { gap: 2, width: "100%", children: [
      ...
      hasErrors ? (0, import_jsx_runtime.jsx)(ForwardRef$4b, { fill: "danger600" }) : (0, import_jsx_runtime.jsx)(ForwardRef$4L, { fill: "success600" })
    ] }),
...
var getReviewStageIcon = ({
  ...
  if (!contentTypeHasReviewWorkflow) {
    return (0, import_jsx_runtime.jsx)(ForwardRef$4L, { fill: "neutral200" });
  }
  if (requiredStage && requiredStage.id !== (entryStage == null ? void 0 : entryStage.id)) {
    return (0, import_jsx_runtime.jsx)(ForwardRef$4b, { fill: "danger600" });
  }
  return (0, import_jsx_runtime.jsx)(ForwardRef$4L, { fill: "success600" });
};
...
var ReleaseDetailsLayout = ({
  ...
  return (0, import_jsx_runtime2.jsxs)(Main, { "aria-busy": isLoadingDetails, children: [
    (0, import_jsx_runtime2.jsx)(
      Layouts.Header,
      {
        title: release.name,
        subtitle: (0, import_jsx_runtime2.jsxs)(Flex, { gap: 2, lineHeight: 6, children: [
          (0, import_jsx_runtime2.jsx)(Typography, { textColor: "neutral600", variant: "epsilon", children: numberOfEntriesText + (isScheduled ? ` - ${scheduledText}` : "") }),
          (0, import_jsx_runtime2.jsx)(Badge, { ...getBadgeProps(release.status), children: release.status })
        ] }),
        navigationAction: (0, import_jsx_runtime2.jsx)(BackButton, { fallback: ".." }),
        primaryAction: !release.releasedAt && (0, import_jsx_runtime2.jsxs)(Flex, { gap: 2, children: [
              ...
              children: [
                ...
                (0, import_jsx_runtime2.jsxs)(
                  ReleaseInfoWrapper,
                  {
                    ...
                    padding: 4,
                    children: [
                      (0, import_jsx_runtime2.jsx)(Typography, { variant: "pi", fontWeight: "bold", children: formatMessage({
                        id: "content-releases.header.actions.created",
                        defaultMessage: "Created"
                      }) }),
                      (0, import_jsx_runtime2.jsxs)(Typography, { variant: "pi", color: "neutral300", children: [
                        (0, import_jsx_runtime2.jsx)(RelativeTime, { timestamp: new Date(release.createdAt) }),
                        formatMessage(
                          {
          ...
          (0, import_jsx_runtime2.jsx)(Button, { size: "S", variant: "tertiary", onClick: handleRefresh, children: formatMessage({
            id: "content-releases.header.actions.refresh",
            defaultMessage: "Refresh"
          }) }),
          canPublish ? (0, import_jsx_runtime2.jsx)(
            Button,
            {
              size: "S",
              variant: "default",
...
var ReleaseDetailsBody = ({ releaseId }) => {
  ...
  if (Object.keys(releaseActions).length === 0) {
    return (0, import_jsx_runtime2.jsx)(Layouts.Content, { children: (0, import_jsx_runtime2.jsx)(
      EmptyStateLayout,
      {
        action: (0, import_jsx_runtime2.jsx)(
          LinkButton,
          {
            tag: Link,
            to: {
  ...
  return (0, import_jsx_runtime2.jsx)(Layouts.Content, { children: (0, import_jsx_runtime2.jsxs)(Flex, { gap: 8, direction: "column", alignItems: "stretch", children: [
    (0, import_jsx_runtime2.jsx)(Flex, { children: (0, import_jsx_runtime2.jsx)(
      SingleSelect,
      {
        ...
        children: options.map((option) => (0, import_jsx_runtime2.jsx)(SingleSelectOption, { value: option, children: formatMessage(getGroupByOptionLabel(option)) }, option))
      }
    ) }),
    Object.keys(releaseActions).map((key) => (0, import_jsx_runtime2.jsxs)(Flex, { gap: 4, direction: "column", alignItems: "stretch", children: [
      (0, import_jsx_runtime2.jsx)(Flex, { role: "separator", "aria-label": key, children: (0, import_jsx_runtime2.jsx)(Badge, { children: key }) }),
      (0, import_jsx_runtime2.jsx)(
        Table.Root,
        {
          ...
          children: (0, import_jsx_runtime2.jsxs)(Table.Content, { children: [
            (0, import_jsx_runtime2.jsx)(Table.Head, { children: headers.map(({ label, name }) => (0, import_jsx_runtime2.jsx)(Table.HeaderCell, { label: formatMessage(label), name }, name)) }),
            (0, import_jsx_runtime2.jsx)(Table.Loading, {}),
            (0, import_jsx_runtime2.jsx)(Table.Body, { children: releaseActions[key].map(
              ({ id, contentType, locale, type, entry, status }, actionIndex) => (0, import_jsx_runtime2.jsxs)(Tr, { children: [
                (0, import_jsx_runtime2.jsx)(Td, { width: "25%", maxWidth: "200px", children: (0, import_jsx_runtime2.jsx)(Typography, { ellipsis: true, children: `${contentType.mainFieldValue || entry.id}` }) }),
                hasI18nEnabled && (0, import_jsx_runtime2.jsx)(Td, { width: "10%", children: (0, import_jsx_runtime2.jsx)(Typography, { children: `${(locale == null ? void 0 : locale.name) ? locale.name : "-"}` }) }),
                (0, import_jsx_runtime2.jsx)(Td, { width: "10%", children: (0, import_jsx_runtime2.jsx)(Typography, { children: contentType.displayName || "" }) }),
                (0, import_jsx_runtime2.jsx)(Td, { width: "20%", children: release.releasedAt ? (0, import_jsx_runtime2.jsx)(Typography, { children: formatMessage(
                  {
                  ...
                  },
                  {
                    ...
                    b: (children) => (0, import_jsx_runtime2.jsx)(Typography, { fontWeight: "bold", children })
                  }
                ) }) : (0, import_jsx_runtime2.jsx)(
                  ReleaseActionOptions,
                  {
                ...
                !release.releasedAt && (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
                  (0, import_jsx_runtime2.jsx)(Td, { width: "20%", minWidth: "200px", children: (0, import_jsx_runtime2.jsx)(
                  ...
                  (0, import_jsx_runtime2.jsx)(Td, { children: (0, import_jsx_runtime2.jsx)(Flex, { justifyContent: "flex-end", children: (0, import_jsx_runtime2.jsxs)(ReleaseActionMenu.Root, { children: [
                    (0, import_jsx_runtime2.jsx)(
...
var ReleaseDetailsPage = () => {
  ...
  if (!releaseId) {
    return (0, import_jsx_runtime2.jsx)(Navigate, { to: ".." });
  }
  ...
  return (0, import_jsx_runtime2.jsxs)(
    ReleaseDetailsLayout,
    {
      ...
      toggleWarningSubmit,
      children: [
        (0, import_jsx_runtime2.jsx)(ReleaseDetailsBody, { releaseId }),
        (0, import_jsx_runtime2.jsx)(
          ReleaseModal,
          {
        ...
        (0, import_jsx_runtime2.jsx)(Dialog.Root, { open: showWarningSubmit, onOpenChange: toggleWarningSubmit, children: (0, import_jsx_runtime2.jsx)(ConfirmDialog, { onConfirm: handleDeleteRelease, children: formatMessage({
...
var App = () => {
  return (0, import_jsx_runtime3.jsx)(Page.Protect, { permissions: PERMISSIONS.main, children: (0, import_jsx_runtime3.jsxs)(Routes, { children: [
    (0, import_jsx_runtime3.jsx)(Route, { index: true, element: (0, import_jsx_runtime3.jsx)(ReleasesPage, {}) }),
    (0, import_jsx_runtime3.jsx)(Route, { path: ":releaseId", element: (0, import_jsx_runtime3.jsx)(ReleaseDetailsPage, {}) })
  ] }) });
};
export {
  App
};
//# sourceMappingURL=App-YPMEWWD7.js.map
