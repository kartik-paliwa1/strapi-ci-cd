...
// ../packages/core/admin/admin/src/components/Form.tsx
...
var Blocker = ({ onProceed = () => {
  ...
  if (blocker.state === "blocked") {
    ...
    return (0, import_jsx_runtime.jsx)(Dialog.Root, { open: true, onOpenChange: handleCancel, children: (0, import_jsx_runtime.jsxs)(Dialog.Content, { children: [
      ...
      (0, import_jsx_runtime.jsx)(Dialog.Body, { icon: (0, import_jsx_runtime.jsx)(ForwardRef$5, { width: "24px", height: "24px", fill: "danger600" }), children: formatMessage({
...
//# sourceMappingURL=chunk-SHHZGTRU.js.map
