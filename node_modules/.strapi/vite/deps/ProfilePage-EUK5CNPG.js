...
var Panel = ({ children, ...flexProps }) => {
  return (0, import_jsx_runtime.jsx)(
    Box,
    {
      ...
      paddingLeft: 7,
      paddingRight: 7,
      children: (0, import_jsx_runtime.jsx)(Flex, { direction: "column", alignItems: "stretch", gap: 4, ...flexProps, children })
    }
  );
};
var ProfilePage = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(Page.Main, { "aria-busy": isSubmittingForm, children: [
    ...
    (0, import_jsx_runtime.jsx)(
      Form,
      {
        ...
        children: ({ isSubmitting, modified }) => (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
          ...
          (0, import_jsx_runtime.jsx)(Box, { paddingBottom: 6, children: (0, import_jsx_runtime.jsx)(Layouts.Content, { children: (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
    ...
    (0, import_jsx_runtime.jsx)(Box, { paddingBottom: 10, children: (0, import_jsx_runtime.jsx)(Layouts.Content, { children: (0, import_jsx_runtime.jsx)(GuidedTourSection, {}) }) })
  ] });
};
var PasswordSection = () => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime.jsxs)(Panel, { children: [
...
var GuidedTourSection = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(Panel, { alignItems: "start", children: [
    ...
    (0, import_jsx_runtime.jsx)(Button, { variant: "tertiary", onClick: onClickReset, children: formatMessage({
...
//# sourceMappingURL=ProfilePage-EUK5CNPG.js.map
