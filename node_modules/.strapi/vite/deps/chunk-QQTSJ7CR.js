...
// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/hooks/usePermissionsDataManager.ts
...
// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/utils/difference.ts
...
// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/utils/forms.ts
...
// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/utils/createArrayOfValues.ts
...
// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/utils/permissions.ts
...
// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/utils/layouts.ts
...
// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/utils/updateConditionsToFalse.ts
...
// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/utils/constants.ts
var cellWidth = `12rem`;
var firstRowWidth = `20rem`;
var rowHeight = `5.3rem`;

// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/utils/removeConditionKeyFromData.ts
...
// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/utils/getCheckboxState.ts
...
// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/components/CollapseLabel.tsx
...
// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/components/HiddenAction.tsx
var HiddenAction = dt.div`
  width: ${cellWidth};
`;

// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/components/RequiredSign.tsx
var import_jsx_runtime = __toESM(require_jsx_runtime());
var RequiredSign = () => (0, import_jsx_runtime.jsx)(Box, { color: "danger700", paddingLeft: 1, children: "*" });

// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/components/RowLabelWithCheckbox.tsx
...
var RowLabelWithCheckbox = ({
  ...
  return (0, import_jsx_runtime2.jsxs)(Flex, { alignItems: "center", paddingLeft: 6, width: firstRowWidth, shrink: 0, children: [
    (0, import_jsx_runtime2.jsx)(Box, { paddingRight: 2, children: (0, import_jsx_runtime2.jsx)(
      CheckboxImpl,
      {
        name: checkboxName,
    ...
    (0, import_jsx_runtime2.jsxs)(CollapseLabel, { ...collapseLabelProps, children: [
      (0, import_jsx_runtime2.jsx)(Typography, { ellipsis: true, children: label }),
      children
    ] })
  ] });
};
...
var CollapsePropertyMatrix = ({
  ...
  return (0, import_jsx_runtime3.jsxs)(Flex, { display: "inline-flex", direction: "column", alignItems: "stretch", minWidth: 0, children: [
    (0, import_jsx_runtime3.jsx)(Header, { label, headers: propertyActions }),
    (0, import_jsx_runtime3.jsx)(Box, { children: childrenForm.map(({ children: childrenForm2, label: label2, value, required }, i) => (0, import_jsx_runtime3.jsx)(
      ActionRow,
      {
  ...
  return (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    (0, import_jsx_runtime3.jsx)(
      Wrapper,
      {
        ...
        children: (0, import_jsx_runtime3.jsxs)(Flex, { children: [
          (0, import_jsx_runtime3.jsxs)(
            RowLabelWithCheckbox,
            {
              ...
              children: [
                ...
                (0, import_jsx_runtime3.jsx)(CarretIcon, { $isActive: isActive })
              ]
            }
          ),
          (0, import_jsx_runtime3.jsx)(Flex, { children: propertyActions.map(({ label: label2, isActionRelatedToCurrentProperty, actionId }) => {
    ...
    isActive && (0, import_jsx_runtime3.jsx)(
      SubActionRow,
      {
...
var SubActionRow = ({
  ...
  return (0, import_jsx_runtime3.jsxs)(Box, { paddingLeft: `3.2rem`, children: [
    ...
    childrenForm.map(({ label, value, required, children: subChildrenForm }, index) => {
      ...
      return (0, import_jsx_runtime3.jsxs)(LeftBorderTimeline, { $isVisible: isVisible, children: [
        (0, import_jsx_runtime3.jsxs)(Flex, { height: rowHeight, children: [
          (0, import_jsx_runtime3.jsx)(StyledBox, { children: (0, import_jsx_runtime3.jsx)(
            Svg,
            {
              width: "20",
              height: "23",
          ...
          (0, import_jsx_runtime3.jsxs)(Flex, { style: { flex: 1 }, children: [
            (0, import_jsx_runtime3.jsx)(RowStyle, { $level: recursiveLevel, $isActive: isActive, $isCollapsable: isArrayType, children: (0, import_jsx_runtime3.jsxs)(
              CollapseLabel,
              {
                alignItems: "center",
                ...
                title: label,
                children: [
                  (0, import_jsx_runtime3.jsx)(RowLabel, { ellipsis: true, children: label }),
                  required && (0, import_jsx_runtime3.jsx)(RequiredSign, {}),
                  (0, import_jsx_runtime3.jsx)(CarretIcon, { $isActive: isActive })
                ]
              }
            ) }),
            (0, import_jsx_runtime3.jsx)(Flex, { style: { flex: 1 }, children: propertyActions.map(
        ...
        displayedRecursiveChildren && isActive && (0, import_jsx_runtime3.jsx)(Box, { paddingBottom: 2, children: (0, import_jsx_runtime3.jsx)(
          SubActionRow,
          {
            isFormDisabled,
...
var Header = ({ headers = [], label }) => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime3.jsxs)(Flex, { children: [
    (0, import_jsx_runtime3.jsx)(Flex, { width: firstRowWidth, height: rowHeight, shrink: 0, alignItems: "center", paddingLeft: 6, children: (0, import_jsx_runtime3.jsx)(Typography, { variant: "sigma", textColor: "neutral500", children: formatMessage(
      {
    ...
    headers.map((header) => {
      if (!header.isActionRelatedToCurrentProperty) {
        return (0, import_jsx_runtime3.jsx)(Flex, { width: cellWidth, shrink: 0 }, header.label);
      }
      return (0, import_jsx_runtime3.jsx)(Flex, { width: cellWidth, shrink: 0, justifyContent: "center", children: (0, import_jsx_runtime3.jsx)(Typography, { variant: "sigma", textColor: "neutral500", children: formatMessage({
...
// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/components/ConditionsButton.tsx
var React2 = __toESM(require_react());
var import_jsx_runtime4 = __toESM(require_jsx_runtime());
var ConditionsButtonImpl = React2.forwardRef(
  ({ onClick, className, hasConditions = false, variant = "tertiary" }, ref) => {
    const { formatMessage } = useIntl();
    return (0, import_jsx_runtime4.jsx)(ButtonContainer, { $hasConditions: hasConditions, className, children: (0, import_jsx_runtime4.jsx)(Button, { variant, startIcon: (0, import_jsx_runtime4.jsx)(ForwardRef$4l, {}), onClick, ref, type: "button", children: formatMessage({
      id: "global.settings",
...
var ConditionsModal = ({
  ...
  const [state, setState] = React3.useState(
    createDefaultConditionsForm2(actionsToDisplay, modifiedData, arrayOfOptionsGroupedByCategory)
  );
  ...
  return (0, import_jsx_runtime5.jsxs)(Modal.Content, { children: [
    (0, import_jsx_runtime5.jsx)(Modal.Header, { children: (0, import_jsx_runtime5.jsx)(Breadcrumbs, { id: "condition-modal-breadcrumbs", label: headerBreadCrumbs.join(", "), children: headerBreadCrumbs.map((label, index, arr) => (0, import_jsx_runtime5.jsx)(Crumb, { isCurrent: index === arr.length - 1, children: (0, import_upperFirst.default)(
      formatMessage({
        id: label,
        defaultMessage: label
      })
    ) }, label)) }) }),
    (0, import_jsx_runtime5.jsxs)(Modal.Body, { children: [
      actionsToDisplay.length === 0 && (0, import_jsx_runtime5.jsx)(Typography, { children: formatMessage({
      ...
      (0, import_jsx_runtime5.jsx)("ul", { children: actionsToDisplay.map(({ actionId, label, pathToConditionsObject }, index) => {
    ...
    (0, import_jsx_runtime5.jsxs)(Modal.Footer, { children: [
      (0, import_jsx_runtime5.jsx)(Button, { variant: "tertiary", onClick: () => onCloseModal(), children: formatMessage({ id: "app.components.Button.cancel", defaultMessage: "Cancel" }) }),
      (0, import_jsx_runtime5.jsx)(Button, { onClick: handleSubmit, children: formatMessage({
...
var createDefaultConditionsForm2 = (actionsToDisplay, modifiedData, arrayOfOptionsGroupedByCategory) => {
  return actionsToDisplay.reduce((acc, current) => {
    const valueFromModifiedData = (0, import_get2.default)(
      modifiedData,
...
var ActionRow2 = ({
  ...
  return (0, import_jsx_runtime5.jsxs)(
    Flex,
    {
      ...
      children: [
        (0, import_jsx_runtime5.jsxs)(Flex, { style: { width: 180 }, children: [
          (0, import_jsx_runtime5.jsxs)(Typography, { variant: "sigma", textColor: "neutral600", children: [
            formatMessage({
          ...
          (0, import_jsx_runtime5.jsx)(Typography, { variant: "sigma", title: label, textColor: "primary600", ellipsis: true, children: formatMessage({
        ...
        (0, import_jsx_runtime5.jsx)(Box, { style: { maxWidth: 430, width: "100%" }, children: (0, import_jsx_runtime5.jsx)(
          MultiSelectNested,
          {
            id: name,
...
var ContentTypeCollapses = ({
  ...
  return (0, import_jsx_runtime6.jsx)(import_jsx_runtime6.Fragment, { children: subjects.map(({ uid, label, properties }, index) => {
...
var Collapse = ({
  ...
  return (0, import_jsx_runtime6.jsxs)(BoxWrapper, { $isActive: isActive, children: [
        ...
        children: [
          (0, import_jsx_runtime6.jsx)(
            RowLabelWithCheckbox,
            {
              ...
              value: hasAllActionsSelected,
              isActive,
              children: (0, import_jsx_runtime6.jsx)(Chevron, { paddingLeft: 2, children: isActive ? (0, import_jsx_runtime6.jsx)(ForwardRef$4B, {}) : (0, import_jsx_runtime6.jsx)(ForwardRef$4H, {}) })
            }
          ),
          (0, import_jsx_runtime6.jsx)(Flex, { style: { flex: 1 }, children: checkboxesActions.map(
            ({ actionId, hasSomeActionsSelected: hasSomeActionsSelected2, isDisplayed, ...restAction }) => {
              ...
              if (isParentCheckbox) {
                return (0, import_jsx_runtime6.jsxs)(Cell, { justifyContent: "center", alignItems: "center", children: [
                  hasConditions && (0, import_jsx_runtime6.jsx)(
                    Box,
                    {
                      tag: "span",
                      position: "absolute",
    ...
    (0, import_jsx_runtime6.jsx)(Box, { bottom: "10px", right: "9px", position: "absolute", children: (0, import_jsx_runtime6.jsxs)(
      Modal.Root,
      {
        ...
        children: [
          (0, import_jsx_runtime6.jsx)(Modal.Trigger, { children: (0, import_jsx_runtime6.jsx)(ConditionsButton, { hasConditions: doesConditionButtonHasConditions }) }),
          (0, import_jsx_runtime6.jsx)(
            ConditionsModal,
            {
...
var generateCheckboxesActions = (availableActions, modifiedData, pathToData) => {
  return availableActions.map(({ actionId, isDisplayed, applyToProperties, label }) => {
    ...
    const checkboxNameArray = (0, import_isEmpty2.default)(applyToProperties) ? [...baseCheckboxNameArray, "properties", "enabled"] : baseCheckboxNameArray;
    const conditionsValue = (0, import_get3.default)(modifiedData, [...baseCheckboxNameArray, "conditions"], null);
...
var GlobalActions = ({ actions = [], isFormDisabled, kind }) => {
    ...
    const relatedActionsData = actionsIds.reduce(
      (acc, actionId) => {
        Object.keys(data).forEach((ctUid) => {
          const actionIdData = (0, import_get4.default)(data, [ctUid, actionId]);
  ...
  return (0, import_jsx_runtime7.jsx)(Box, { paddingBottom: 4, paddingTop: 6, style: { paddingLeft: firstRowWidth }, children: (0, import_jsx_runtime7.jsx)(Flex, { gap: 0, children: displayedActions.map(({ label, actionId }) => {
    return (0, import_jsx_runtime7.jsxs)(
      Flex,
      {
        ...
        gap: 3,
        children: [
          (0, import_jsx_runtime7.jsx)(Typography, { variant: "sigma", textColor: "neutral500", children: formatMessage({
            id: `Settings.roles.form.permissions.${label.toLowerCase()}`,
            defaultMessage: label
          }) }),
          (0, import_jsx_runtime7.jsx)(
            CheckboxImpl,
            {
              ...
              checked: (0, import_get4.default)(checkboxesState, [actionId, "hasSomeActionsSelected"], false) ? "indeterminate" : (0, import_get4.default)(checkboxesState, [actionId, "hasAllActionsSelected"], false)
            }
          )
        ]
      },
...
// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/components/ContentTypes.tsx
...
var ContentTypes = ({
  ...
  return (0, import_jsx_runtime8.jsxs)(Box, { background: "neutral0", children: [
    (0, import_jsx_runtime8.jsx)(GlobalActions, { actions, kind, isFormDisabled }),
...
var PluginsAndSettingsPermissions = ({
  ...
  return (0, import_jsx_runtime9.jsx)(Box, { padding: 6, background: "neutral0", children: (0, import_jsx_runtime9.jsx)(Accordion.Root, { size: "M", children: layout.map(({ category, categoryId, childrenForm }, index) => {
...
var Row = ({
  ...
  return (0, import_jsx_runtime9.jsxs)(Accordion.Item, { value: name, children: [
    (0, import_jsx_runtime9.jsx)(Accordion.Header, { variant, children: (0, import_jsx_runtime9.jsx)(
      Accordion.Trigger,
      {
        caretPosition: "right",
    ...
    (0, import_jsx_runtime9.jsx)(Accordion.Content, { children: (0, import_jsx_runtime9.jsx)(Box, { padding: 6, children: childrenForm.map(({ actions, subCategoryName, subCategoryId }) => (0, import_jsx_runtime9.jsx)(
      SubCategory,
      {
        actions,
        categoryName,
...
var SubCategory = ({
  ...
  const formattedActions = React6.useMemo(() => {
    return actions.map((action) => {
      ...
      const conditionValue = (0, import_get5.default)(modifiedData, [...pathToData, action.action, "conditions"], {});
  ...
  const datum = (0, import_get5.default)(modifiedData, [...pathToData], {});
  ...
  return (0, import_jsx_runtime9.jsx)(import_jsx_runtime9.Fragment, { children: (0, import_jsx_runtime9.jsxs)(Box, { children: [
    (0, import_jsx_runtime9.jsxs)(Flex, { justifyContent: "space-between", alignItems: "center", children: [
      (0, import_jsx_runtime9.jsx)(Box, { paddingRight: 4, children: (0, import_jsx_runtime9.jsx)(Typography, { variant: "sigma", textColor: "neutral600", children: subCategoryName }) }),
      (0, import_jsx_runtime9.jsx)(Border, { flex: 1 }),
      (0, import_jsx_runtime9.jsx)(Box, { paddingLeft: 4, children: (0, import_jsx_runtime9.jsx)(
        CheckboxImpl,
        {
    ...
    (0, import_jsx_runtime9.jsxs)(Flex, { paddingTop: 6, paddingBottom: 6, children: [
      (0, import_jsx_runtime9.jsx)(Grid.Root, { gap: 2, style: { flex: 1 }, children: formattedActions.map(({ checkboxName, value, action, displayName, hasConditions }) => {
        return (0, import_jsx_runtime9.jsx)(Grid.Item, { col: 3, direction: "column", alignItems: "start", children: (0, import_jsx_runtime9.jsx)(CheckboxWrapper, { $disabled: isFormDisabled, $hasConditions: hasConditions, children: (0, import_jsx_runtime9.jsx)(
          CheckboxImpl,
          {
            name: checkboxName,
            disabled: isFormDisabled,
      ...
      (0, import_jsx_runtime9.jsxs)(
        Modal.Root,
        {
          ...
          children: [
            (0, import_jsx_runtime9.jsx)(Modal.Trigger, { children: (0, import_jsx_runtime9.jsx)(ConditionsButton, { hasConditions: doesButtonHasCondition }) }),
...
var Permissions = React7.forwardRef(
  ({ layout, isFormDisabled, permissions = [] }, api) => {
    const [{ initialData, layouts, modifiedData }, dispatch] = React7.useReducer(
      reducer,
      initialState,
          ...
          if ((0, import_isEmpty3.default)(contentTypesDiff)) {
            ...
            didUpdateConditions = Object.values(contentTypesDiff).some((permission = {}) => {
              return Object.values(permission).some(
                (permissionValue) => (0, import_has2.default)(permissionValue, "conditions")
              );
            });
          }
    ...
    return (0, import_jsx_runtime10.jsx)(
      PermissionsDataManagerProvider,
      {
        ...
        children: (0, import_jsx_runtime10.jsxs)(Tabs.Root, { defaultValue: TAB_LABELS[0].id, children: [
          (0, import_jsx_runtime10.jsx)(
            Tabs.List,
            {
              ...
              children: TAB_LABELS.map((tabLabel) => (0, import_jsx_runtime10.jsx)(Tabs.Trigger, { value: tabLabel.id, children: formatMessage({ id: tabLabel.labelId, defaultMessage: tabLabel.defaultMessage }) }, tabLabel.id))
            }
          ),
          (0, import_jsx_runtime10.jsx)(Tabs.Content, { value: TAB_LABELS[0].id, children: (0, import_jsx_runtime10.jsx)(
            ContentTypes,
            {
          ...
          (0, import_jsx_runtime10.jsx)(Tabs.Content, { value: TAB_LABELS[1].id, children: (0, import_jsx_runtime10.jsx)(
            ContentTypes,
            {
          ...
          (0, import_jsx_runtime10.jsx)(Tabs.Content, { value: TAB_LABELS[2].id, children: (0, import_jsx_runtime10.jsx)(
          ...
          (0, import_jsx_runtime10.jsx)(Tabs.Content, { value: TAB_LABELS[3].id, children: (0, import_jsx_runtime10.jsx)(
            PluginsAndSettingsPermissions,
            {
  ...
  switch (action.type) {
    case "ON_CHANGE_COLLECTION_TYPE_GLOBAL_ACTION_CHECKBOX": {
      ...
      Object.keys((0, import_get6.default)(state, pathToData)).forEach((collectionType) => {
        const collectionTypeActionData = (0, import_get6.default)(
          state,
    ...
    case "ON_CHANGE_COLLECTION_TYPE_ROW_LEFT_CHECKBOX": {
      ...
      Object.keys(objToUpdate).forEach((actionId) => {
        if ((0, import_has2.default)(objToUpdate[actionId], `properties.${propertyName}`)) {
          const objValue = (0, import_get6.default)(objToUpdate, [actionId, "properties", propertyName, rowName]);
...
//# sourceMappingURL=chunk-QQTSJ7CR.js.map
