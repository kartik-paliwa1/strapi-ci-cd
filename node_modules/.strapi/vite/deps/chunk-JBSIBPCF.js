...
// ../packages/core/content-type-builder/admin/src/constants.ts
var PERMISSIONS = {
...
// ../packages/core/content-type-builder/admin/src/components/AutoReloadOverlayBlocker.tsx
...
var Blocker = ({ displayedIcon, description, title, isOpen }) => {
  ...
  return isOpen && ((_a = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a.body) ? (0, import_react_dom.createPortal)(
    (0, import_jsx_runtime.jsxs)(Overlay, { id: "autoReloadOverlayBlocker", direction: "column", alignItems: "center", gap: 6, children: [
      ...
      displayedIcon === "time" && (0, import_jsx_runtime.jsx)(IconBox, { padding: 6, background: "primary100", borderColor: "primary200", children: (0, import_jsx_runtime.jsx)(ForwardRef$4z, { width: "4rem", height: "4rem" }) }),
...
// ../packages/core/content-type-builder/admin/src/components/DataManager/reducer.ts
var import_merge = __toESM(require_merge());
var import_omit = __toESM(require_omit());

// ../packages/core/content-type-builder/admin/src/utils/makeUnique.ts
var makeUnique = (array) => [...new Set(array)];

// ../packages/core/content-type-builder/admin/src/components/DataManager/undoRedo.ts
var isCallable = (obj) => {
...
// ../packages/core/content-type-builder/admin/src/components/DataManager/utils/formatSchemas.ts
...
// ../packages/core/content-type-builder/admin/src/utils/nameToSlug.ts
var import_slugify = __toESM(require_slugify());
var nameToSlug = (name) => (0, import_slugify.default)(name, { separator: "-" });

// ../packages/core/content-type-builder/admin/src/components/FormModal/utils/createUid.ts
var createUid = (name) => {
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/reducer.ts
var import_set = __toESM(require_set());
var import_snakeCase = __toESM(require_snakeCase());
var import_pluralize = __toESM(require_pluralize());

// ../packages/core/content-type-builder/admin/src/components/FormModal/utils/customFieldDefaultOptionsReducer.ts
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/utils/relations.ts
...
var slice2 = createSlice({
  ...
  reducers: {
    onChange: (state, action) => {
      ...
      (0, import_set.default)(state, ["modifiedData", ...keys], value);
    },
    onChangeRelationTarget: (state, action) => {
      ...
      (0, import_set.default)(state, ["modifiedData", "target"], value);
      ...
      if (Array.isArray(targetContentTypeAllowedRelations)) {
        ...
        if (currentRelationType && !targetContentTypeAllowedRelations.includes(currentRelationType)) {
          ...
          if (relationToSet === "oneWay") {
            (0, import_set.default)(state, ["modifiedData", "relation"], "oneToOne");
          } else if (relationToSet === "manyWay") {
            (0, import_set.default)(state, ["modifiedData", "relation"], "oneToMany");
          } else {
            (0, import_set.default)(state, ["modifiedData", "relation"], relationToSet);
          }
        }
      }
      let nameToSet;
      ...
      (0, import_set.default)(state, ["modifiedData", "name"], nameToSet);
      const currentTargetAttribute = state.modifiedData.targetAttribute;
      if (currentTargetAttribute === null) {
        return;
      }
      if (didChangeRelationTypeBecauseOfRestrictedRelation && changedRelationType && ["oneWay", "manyWay"].includes(changedRelationType)) {
        (0, import_set.default)(state, ["modifiedData", "targetAttribute"], null);
        return;
      }
      ...
      (0, import_set.default)(state, ["modifiedData", "targetAttribute"], targetAttributeToSet);
    },
    onChangeRelationType: (state, action) => {
      ...
      if (!["oneWay", "manyWay"].includes(value)) {
        (0, import_set.default)(state, ["modifiedData", "relation"], value);
        const currentTargetAttribute = state.modifiedData.targetAttribute;
      ...
      if (value === "oneWay") {
        (0, import_set.default)(state, ["modifiedData", "relation"], "oneToOne");
        (0, import_set.default)(state, ["modifiedData", "targetAttribute"], null);
        (0, import_set.default)(state, ["modifiedData", "name"], (0, import_pluralize.default)((0, import_snakeCase.default)(currentName), 1));
        return;
      }
      (0, import_set.default)(state, ["modifiedData", "relation"], "oneToMany");
      (0, import_set.default)(state, ["modifiedData", "targetAttribute"], null);
      (0, import_set.default)(state, ["modifiedData", "name"], (0, import_pluralize.default)((0, import_snakeCase.default)(currentName), 2));
    },
    resetProps: () => {
    ...
    resetPropsAndSetTheFormForAddingACompoToADz: (state) => {
      ...
      return { ...initialState2, modifiedData: dataToSet };
    },
    ...
    setCustomFieldDataSchema: (state, action) => {
      ...
      if (optionDefaults.length) {
        optionDefaults.forEach(
          ({ name, defaultValue }) => (0, import_set.default)(state.modifiedData, name, defaultValue)
        );
      }
    },
...
//# sourceMappingURL=chunk-JBSIBPCF.js.map
