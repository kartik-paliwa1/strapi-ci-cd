import {
  require_baseMap
} from "./chunk-LVCIZRV3.js";
import {
  useCreateAPITokenMutation,
  useGetAPITokenQuery,
  useUpdateAPITokenMutation
} from "./chunk-AFX3CX6F.js";
import {
  ApiTokenBox,
  FormHead,
  LifeSpanInput,
  ...
  TokenName,
  TokenTypeSelect
} from "./chunk-G5DMHQI7.js";
import {
  API_TOKEN_TYPE
} from "./chunk-6YNROIN2.js";
import {
  useRBAC
...
// ../packages/core/admin/admin/src/services/contentApi.ts
...
// ../packages/core/admin/admin/src/pages/Settings/pages/ApiTokens/EditView/apiTokenPermissions.tsx
...
var FormApiTokenContainer = ({
  ...
  return (0, import_jsx_runtime2.jsx)(
    Box,
    {
      ...
      paddingLeft: 7,
      paddingRight: 7,
      children: (0, import_jsx_runtime2.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 4, children: [
        (0, import_jsx_runtime2.jsx)(Typography, { variant: "delta", tag: "h2", children: formatMessage({
          id: "global.details",
          defaultMessage: "Details"
        }) }),
        (0, import_jsx_runtime2.jsxs)(Grid.Root, { gap: 5, children: [
          (0, import_jsx_runtime2.jsx)(Grid.Item, { col: 6, xs: 12, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime2.jsx)(
            TokenName,
            {
              error: errors["name"],
              value: values["name"],
...
// ../packages/core/admin/admin/src/pages/Settings/pages/ApiTokens/EditView/components/BoundRoute.tsx
var import_map = __toESM(require_map());
var import_tail = __toESM(require_tail());
...
var BoundRoute = ({
  ...
  return (0, import_jsx_runtime3.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 2, children: [
    (0, import_jsx_runtime3.jsxs)(Typography, { variant: "delta", tag: "h3", children: [
      formatMessage({
        id: "Settings.apiTokens.createPage.BoundRoute.title",
        defaultMessage: "Bound route to"
      }),
      " ",
      (0, import_jsx_runtime3.jsx)("span", { children: controller }),
      (0, import_jsx_runtime3.jsxs)(Typography, { variant: "delta", textColor: "primary600", children: [
        ".",
        action
      ] })
    ] }),
    (0, import_jsx_runtime3.jsxs)(Flex, { hasRadius: true, background: "neutral0", borderColor: "neutral200", gap: 0, children: [
      (0, import_jsx_runtime3.jsx)(MethodBox, { background: colors.background, borderColor: colors.border, padding: 2, children: (0, import_jsx_runtime3.jsx)(Typography, { fontWeight: "bold", textColor: colors.text, children: method }) }),
      (0, import_jsx_runtime3.jsx)(Box, { paddingLeft: 2, paddingRight: 2, children: (0, import_map.default)(formattedRoute, (value) => (0, import_jsx_runtime3.jsxs)(Typography, { textColor: value.includes(":") ? "neutral600" : "neutral900", children: [
        "/",
        value
      ] }, value)) })
    ] })
...
var ActionBoundRoutes = () => {
  ...
  return (0, import_jsx_runtime4.jsx)(
    Grid.Item,
    {
      ...
      direction: "column",
      alignItems: "stretch",
      children: selectedAction ? (0, import_jsx_runtime4.jsx)(Flex, { direction: "column", alignItems: "stretch", gap: 2, children: actionSection && actionSection in routes && routes[actionSection].map((route) => {
        var _a, _b;
        return ((_b = (_a = route.config.auth) == null ? void 0 : _a.scope) == null ? void 0 : _b.includes(selectedAction)) || route.handler === selectedAction ? (0, import_jsx_runtime4.jsx)(BoundRoute, { route }, route.handler) : null;
      }) }) : (0, import_jsx_runtime4.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 2, children: [
        (0, import_jsx_runtime4.jsx)(Typography, { variant: "delta", tag: "h3", children: formatMessage({
...
var CollapsableContentType = ({
  ...
  return (0, import_jsx_runtime5.jsxs)(Accordion.Item, { value: `${label}-${orderNumber}`, children: [
    (0, import_jsx_runtime5.jsx)(Accordion.Header, { variant: orderNumber % 2 ? "primary" : "secondary", children: (0, import_jsx_runtime5.jsx)(Accordion.Trigger, { children: (0, import_capitalize.default)(label) }) }),
    (0, import_jsx_runtime5.jsx)(Accordion.Content, { children: controllers == null ? void 0 : controllers.map((controller) => {
      ...
      return (0, import_jsx_runtime5.jsxs)(Box, { children: [
        (0, import_jsx_runtime5.jsxs)(Flex, { justifyContent: "space-between", alignItems: "center", padding: 4, children: [
          (0, import_jsx_runtime5.jsx)(Box, { paddingRight: 4, children: (0, import_jsx_runtime5.jsx)(Typography, { variant: "sigma", textColor: "neutral600", children: controller == null ? void 0 : controller.controller }) }),
          (0, import_jsx_runtime5.jsx)(Border, {}),
          (0, import_jsx_runtime5.jsx)(Box, { paddingLeft: 4, children: (0, import_jsx_runtime5.jsx)(
            CheckboxImpl,
            {
        ...
        (0, import_jsx_runtime5.jsx)(Grid.Root, { gap: 4, padding: 4, children: (controller == null ? void 0 : controller.actions) && (controller == null ? void 0 : controller.actions.map((action) => {
                  ...
                  children: [
                    (0, import_jsx_runtime5.jsx)(
                      CheckboxImpl,
                      {
                        ...
                        disabled,
                        children: (0, import_jsx_runtime5.jsx)("span", { style: { overflowWrap: "anywhere" }, children: action.action })
                      }
                    ),
                    (0, import_jsx_runtime5.jsx)(
                      "button",
                      {
                        ...
                        children: (0, import_jsx_runtime5.jsx)(ForwardRef$4l, { id: "cog" })
                      }
                    )
                  ]
                }
...
// ../packages/core/admin/admin/src/pages/Settings/pages/ApiTokens/EditView/components/ContentTypesSection.tsx
var import_jsx_runtime6 = __toESM(require_jsx_runtime());
var ContentTypesSection = ({ section = null, ...props }) => {
  return (0, import_jsx_runtime6.jsx)(Box, { children: (0, import_jsx_runtime6.jsx)(Accordion.Root, { size: "M", children: section && section.map((api, index) => (0, import_jsx_runtime6.jsx)(
...
var Permissions = ({ ...props }) => {
  ...
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime7.jsxs)(Grid.Root, { gap: 0, shadow: "filterShadow", hasRadius: true, background: "neutral0", children: [
    (0, import_jsx_runtime7.jsxs)(
      Grid.Item,
      {
        ...
        gap: 6,
        children: [
          (0, import_jsx_runtime7.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 2, children: [
            (0, import_jsx_runtime7.jsx)(Typography, { variant: "delta", tag: "h2", children: formatMessage({
              id: "Settings.apiTokens.createPage.permissions.title",
              defaultMessage: "Permissions"
            }) }),
            (0, import_jsx_runtime7.jsx)(Typography, { tag: "p", textColor: "neutral600", children: formatMessage({
              id: "Settings.apiTokens.createPage.permissions.description",
              defaultMessage: "Only actions bound by a route are listed below."
            }) })
          ] }),
          (data == null ? void 0 : data.permissions) && (0, import_jsx_runtime7.jsx)(ContentTypesSection, { section: data == null ? void 0 : data.permissions, ...props })
        ]
      }
    ),
...
// ../packages/core/admin/admin/src/pages/Settings/pages/ApiTokens/EditView/reducer.ts
var import_pull = __toESM(require_pull());

// ../packages/core/admin/admin/src/pages/Settings/pages/ApiTokens/EditView/utils/transformPermissionsData.ts
...
var EditView = () => {
  ...
  } = useRBAC((_c = permissions.settings) == null ? void 0 : _c["api-tokens"]);
  ...
  return (0, import_jsx_runtime8.jsx)(ApiTokenPermissionsProvider, { value: providerValue, children: (0, import_jsx_runtime8.jsxs)(Page.Main, { children: [
    (0, import_jsx_runtime8.jsx)(Page.Title, { children: formatMessage(
    ...
    (0, import_jsx_runtime8.jsx)(
      Formik,
      {
        ...
        children: ({ errors, handleChange, isSubmitting, values, setFieldValue }) => {
          ...
          return (0, import_jsx_runtime8.jsxs)(Form, { children: [
            (0, import_jsx_runtime8.jsx)(
              FormHead,
              {
                title: {
            ...
            (0, import_jsx_runtime8.jsx)(Layouts.Content, { children: (0, import_jsx_runtime8.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
              (apiToken == null ? void 0 : apiToken.accessKey) && showToken && (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, { children: (0, import_jsx_runtime8.jsx)(ApiTokenBox, { token: apiToken.accessKey, tokenType: API_TOKEN_TYPE }) }),
              (0, import_jsx_runtime8.jsx)(
...
var ProtectedEditView = () => {
  ...
  return (0, import_jsx_runtime8.jsx)(Page.Protect, { permissions, children: (0, import_jsx_runtime8.jsx)(EditView, {}) });
};
...
//# sourceMappingURL=chunk-FOPPOFAU.js.map
