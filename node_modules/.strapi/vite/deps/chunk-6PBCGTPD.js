...
var SortableItem = ({ id, children }) => {
  ...
  return (0, import_jsx_runtime2.jsx)("div", { ref: setNodeRef, style, ...attributes, children });
};
...
var Fields = ({ attributes, fieldSizes, components, metadatas = {} }) => {
  ...
  function findContainer(id, containersAsDictionary) {
    ...
    return Object.keys(containersAsDictionary).find(
      (key) => containersAsDictionary[key].children.find((child) => child.dndId === id)
    );
  }
    ...
    DndContext,
    {
      ...
      onDragOver: ({ active, over }) => {
        ...
        const overIndex = containersAsDictionary[overContainer].children.findIndex(
          (item) => item.dndId === (over == null ? void 0 : over.id)
        );
      ...
      children: (0, import_jsx_runtime2.jsxs)(Flex, { paddingTop: 6, direction: "column", alignItems: "stretch", gap: 4, children: [
        (0, import_jsx_runtime2.jsxs)(Flex, { alignItems: "flex-start", direction: "column", justifyContent: "space-between", children: [
          (0, import_jsx_runtime2.jsx)(Typography, { fontWeight: "bold", children: formatMessage({
            id: getTranslation("containers.list.displayedFields"),
            defaultMessage: "Displayed fields"
          }) }),
          (0, import_jsx_runtime2.jsx)(Typography, { variant: "pi", textColor: "neutral600", children: formatMessage({
            id: "containers.SettingPage.editSettings.description",
            defaultMessage: "Drag & drop the fields to build the layout"
          }) })
        ] }),
        (0, import_jsx_runtime2.jsx)(Box, { padding: 4, hasRadius: true, borderStyle: "dashed", borderWidth: "1px", borderColor: "neutral300", children: (0, import_jsx_runtime2.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 2, children: [
          containers.map((container, containerIndex) => (0, import_jsx_runtime2.jsx)(
            SortableContext,
            {
              id: container.dndId,
              items: container.children.map((child) => ({ id: child.dndId })),
              children: (0, import_jsx_runtime2.jsx)(DroppableContainer, { id: container.dndId, children: ({ setNodeRef }) => (0, import_jsx_runtime2.jsx)(Grid.Root, { ref: setNodeRef, gap: 2, children: container.children.map((child, childIndex) => (0, import_jsx_runtime2.jsx)(
                Grid.Item,
                {
                  col: child.size,
                  direction: "column",
                  alignItems: "stretch",
                  children: (0, import_jsx_runtime2.jsx)(SortableItem, { id: child.dndId, children: (0, import_jsx_runtime2.jsx)(
                    Field,
                    {
          ...
          (0, import_jsx_runtime2.jsx)(DragOverlay, { children: activeDragItem ? (0, import_jsx_runtime2.jsx)(
            Field,
            {
          ...
          (0, import_jsx_runtime2.jsxs)(Menu.Root, { children: [
            ...
            (0, import_jsx_runtime2.jsx)(Menu.Content, { children: remainingFields.map((field) => (0, import_jsx_runtime2.jsx)(Menu.Item, { onSelect: handleAddField(field), children: field.label }, field.name)) })
          ] })
        ] }) })
      ] })
    }
...
var Field = ({ attribute, components, name, onRemoveField, dndId }) => {
  ...
  if (value.name === TEMP_FIELD_NAME) {
    return (0, import_jsx_runtime2.jsx)(Flex, { tag: "span", height: "100%", style: { opacity: 0 } });
  }
  if (!attribute) {
    return null;
  }
  return (0, import_jsx_runtime2.jsxs)(Modal.Root, { open: isModalOpen, onOpenChange: setIsModalOpen, children: [
    (0, import_jsx_runtime2.jsxs)(
      Flex,
      {
        ...
        children: [
          ...
          (0, import_jsx_runtime2.jsxs)(Flex, { direction: "column", alignItems: "flex-start", grow: 1, overflow: "hidden", children: [
            (0, import_jsx_runtime2.jsxs)(Flex, { gap: 3, justifyContent: "space-between", width: "100%", children: [
              (0, import_jsx_runtime2.jsx)(Typography, { ellipsis: true, fontWeight: "bold", children: value.label }),
              (0, import_jsx_runtime2.jsxs)(Flex, { children: [
                (0, import_jsx_runtime2.jsx)(
                  IconButton,
                  {
                    type: "button",
            ...
            (attribute == null ? void 0 : attribute.type) === "component" ? (0, import_jsx_runtime2.jsxs)(
              Flex,
              {
                paddingTop: 3,
                paddingRight: 3,
                ...
                width: "100%",
                children: [
                  (0, import_jsx_runtime2.jsx)(Grid.Root, { gap: 4, width: "100%", children: components[attribute.component].layout.map(
                    (row) => row.map(({ size, ...field }) => (0, import_jsx_runtime2.jsx)(Grid.Item, { col: size, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime2.jsx)(
                      Flex,
                      {
                        alignItems: "center",
                        background: "neutral0",
                        ...
                        children: (0, import_jsx_runtime2.jsx)(Typography, { textColor: "neutral800", children: field.name })
                      }
                    ) }, field.name))
                  ) }),
                  (0, import_jsx_runtime2.jsx)(
            ...
            (attribute == null ? void 0 : attribute.type) === "dynamiczone" ? (0, import_jsx_runtime2.jsx)(
              Flex,
              {
                paddingTop: 3,
                paddingRight: 3,
                ...
                width: "100%",
                wrap: "wrap",
                children: attribute == null ? void 0 : attribute.components.map((uid) => (0, import_jsx_runtime2.jsxs)(
                  ComponentLink,
                  {
                    onClick: (e) => e.stopPropagation(),
                    to: `../components/${uid}/configurations/edit`,
                    children: [
                      (0, import_jsx_runtime2.jsx)(ComponentIcon, { icon: components[uid].settings.icon }),
                      (0, import_jsx_runtime2.jsx)(Typography, { fontSize: 1, textColor: "neutral600", fontWeight: "bold", children: components[uid].settings.displayName })
                    ]
                  },
                  uid
                ))
    ...
    value.name !== TEMP_FIELD_NAME && (0, import_jsx_runtime2.jsx)(EditFieldForm, { attribute, name, onClose: () => setIsModalOpen(false) })
  ] });
};
...
// ../packages/core/content-manager/admin/src/components/ConfigurationForm/Form.tsx
...
var ConfigurationForm = ({
  ...
  return (0, import_jsx_runtime3.jsx)(Layouts.Root, { children: (0, import_jsx_runtime3.jsx)(Main, { children: (0, import_jsx_runtime3.jsxs)(Form, { initialValues, onSubmit, method: "PUT", children: [
    (0, import_jsx_runtime3.jsx)(Header, { name: settings.displayName ?? "" }),
    (0, import_jsx_runtime3.jsx)(Layouts.Content, { children: (0, import_jsx_runtime3.jsxs)(
      Flex,
      {
        alignItems: "stretch",
        background: "neutral0",
        ...
        paddingRight: 7,
        children: [
          (0, import_jsx_runtime3.jsx)(Typography, { variant: "delta", tag: "h2", children: formatMessage({
            id: getTranslation("containers.SettingPage.settings"),
            defaultMessage: "Settings"
          }) }),
          (0, import_jsx_runtime3.jsxs)(Grid.Root, { children: [
            (0, import_jsx_runtime3.jsx)(Grid.Item, { col: 6, s: 12, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime3.jsx)(
              MemoizedInputRenderer,
              {
                type: "enumeration",
                label: formatMessage({
            ...
            (0, import_jsx_runtime3.jsx)(Grid.Item, { col: 12, s: 12, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime3.jsx)(Typography, { variant: "delta", tag: "h3", children: formatMessage({
              id: getTranslation("containers.SettingPage.view"),
              defaultMessage: "View"
            }) }) }),
            (0, import_jsx_runtime3.jsx)(Grid.Item, { col: 12, s: 12, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime3.jsx)(
              Fields,
              {
                attributes,
                components,
...
var Header = ({ name }) => {
  ...
  return (0, import_jsx_runtime3.jsx)(
    Layouts.Header,
    {
      ...
      primaryAction: (0, import_jsx_runtime3.jsx)(Button, { disabled: !modified, loading: isSubmitting, type: "submit", children: formatMessage({ id: "global.save", defaultMessage: "Save" }) })
    }
  );
};
...
//# sourceMappingURL=chunk-6PBCGTPD.js.map
