...
} from "./chunk-JBSIBPCF.js";
import "./chunk-NLQDD6GV.js";
import {
  getRelationType,
  pluginId
} from "./chunk-ZOWRUFDM.js";
import {
  require_pluralize
} from "./chunk-KGNUV6Q7.js";
import {
  createRulesEngine
...
import {
  ...
  tours,
  useGuidedTour
} from "./chunk-UIAWNFPX.js";
import {
  require_pick
} from "./chunk-7PUUZZBB.js";
...
// ../packages/core/content-type-builder/admin/src/pages/App/index.tsx
var import_react12 = __toESM(require_react());

// ../packages/core/content-type-builder/admin/src/components/ContentTypeBuilderNav/ContentTypeBuilderNav.tsx
var import_react2 = __toESM(require_react());

// ../packages/core/content-type-builder/admin/src/components/ContentTypeBuilderNav/useContentTypeBuilderMenu.ts
...
var ContentTypeBuilderNav = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(SubNav.Main, { "aria-label": pluginName, children: [
    (0, import_jsx_runtime.jsx)(SubNav.Header, { label: pluginName }),
    (0, import_jsx_runtime.jsx)(Divider, { background: "neutral150" }),
    (0, import_jsx_runtime.jsxs)(Flex, { padding: 5, gap: 3, direction: "column", alignItems: "stretch", children: [
      (0, import_jsx_runtime.jsx)(tours.contentTypeBuilder.Save, { children: (0, import_jsx_runtime.jsxs)(Flex, { gap: 2, children: [
        ...
        (0, import_jsx_runtime.jsxs)(Menu.Root, { open: menuIsOpen, onOpenChange: setMenuIsOpen, children: [
          (0, import_jsx_runtime.jsxs)(
            Menu.Trigger,
            {
              ...
              variant: "tertiary",
              children: [
                (0, import_jsx_runtime.jsx)(ForwardRef$1Z, { fill: "neutral500", "aria-hidden": true, focusable: false }),
          ...
          (0, import_jsx_runtime.jsxs)(Menu.Content, { zIndex: 1, children: [
            (0, import_jsx_runtime.jsx)(
              Menu.Item,
              {
    ...
    (0, import_jsx_runtime.jsx)(SubNav.Sections, { children: menu.map((section) => {
      var _a, _b, _c;
      return (0, import_jsx_runtime.jsx)(import_react2.Fragment, { children: (0, import_jsx_runtime.jsx)(
        SubNav.Section,
        {
          label: formatMessage({
            id: section.title.id,
          ...
          children: section.links.map((link) => {
            ...
            if ("links" in link) {
              return (0, import_jsx_runtime.jsx)(SubNav.SubSection, { label: link.title, children: link.links.map((subLink) => {
                ...
                return (0, import_jsx_runtime.jsx)(
                  SubNav.Link,
                  {
                    to: subLink.to,
                    label,
                    endAction: (0, import_jsx_runtime.jsx)(Box, { tag: "span", textAlign: "center", width: "24px", children: (0, import_jsx_runtime.jsx)(Status, { status: subLink.status }) })
                  },
                  subLink.name
                );
              }) }, link.name);
            ...
            return (0, import_jsx_runtime.jsx)(
              SubNav.Link,
              {
                to: link.to,
                label: linkLabel,
                endAction: (0, import_jsx_runtime.jsx)(Box, { tag: "span", textAlign: "center", width: "24px", children: (0, import_jsx_runtime.jsx)(Status, { status: link.status }) })
              },
              link.name
            );
          })
    ...
    (0, import_jsx_runtime.jsx)(
      Dialog.Root,
      {
        ...
        children: (0, import_jsx_runtime.jsx)(ConfirmDialog, { onConfirm: discardChanges, children: formatMessage({
...
// ../packages/core/content-type-builder/admin/src/components/DataManager/DataManagerProvider.tsx
var React = __toESM(require_react());
var import_groupBy = __toESM(require_groupBy());
var import_isEqual = __toESM(require_isEqual());
var import_mapValues = __toESM(require_mapValues());

// ../packages/core/content-type-builder/admin/src/components/DataManager/useServerRestartWatcher.ts
var TIMEOUT = "timeout";
var timeout = 30 * 1e3;
...
// ../packages/core/content-type-builder/admin/src/components/DataManager/utils/cleanData.ts
...
var formatTypeForRequest = (type) => {
  ...
  return {
    ...
    ...(0, import_omit.default)(type, ["info", "options", "visible", "uid", "restrictRelationsTo"]),
    ...type.options,
    ...type.info,
    attributes: type.attributes.map((attr) => {
      ...
      return {
        action: action2,
        name: attr.name,
        properties: removeNullKeys((0, import_omit.default)(formatAttribute(attr), ["status", "name"]))
      };
    })
  };
};
...
// ../packages/core/content-type-builder/admin/src/components/DataManager/utils/retrieveComponentsThatHaveComponents.ts
...
var getComponentWithChildComponents = (component) => {
  return {
    ...
    childComponents: component.attributes.filter(
      (attribute) => {
...
// ../packages/core/content-type-builder/admin/src/components/DataManager/utils/retrieveNestedComponents.ts
...
// ../packages/core/content-type-builder/admin/src/components/DataManager/utils/retrieveSpecificInfoFromComponents.ts
...
var retrieveSpecificInfoFromComponents = (allComponents, keysToRetrieve) => {
  const allData = Object.keys(allComponents).map((compo) => {
    return (0, import_get2.default)(allComponents, [compo, ...keysToRetrieve], "");
  });
...
var DataManagerProvider = ({ children }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(DataManagerContext.Provider, { value: context, children });
};
var DataManagerProvider_default = DataManagerProvider;

// ../packages/core/content-type-builder/admin/src/components/ExitPrompt.tsx
...
var ExitPrompt = () => {
  ...
  if (blocker.state === "blocked") {
    return (0, import_jsx_runtime3.jsx)(Dialog.Root, { open: true, onOpenChange: () => blocker.reset(), children: (0, import_jsx_runtime3.jsx)(ConfirmDialog, { onConfirm: () => blocker.proceed(), children: confirmationMessage }) });
  }
  return null;
};

// ../packages/core/content-type-builder/admin/src/components/FormModal/FormModal.tsx
...
// ../packages/core/content-type-builder/admin/src/utils/isAllowedContentTypesForRelations.ts
...
// ../packages/core/content-type-builder/admin/src/utils/findAttribute.ts
var findAttribute = (attributes, attributeToFind) => {
  return attributes.find(({ name }) => name === attributeToFind);
};

// ../packages/core/content-type-builder/admin/src/utils/getYupInnerErrors.ts
...
// ../packages/core/content-type-builder/admin/src/components/AllowedTypesSelect.tsx
...
var AllowedTypesSelect = ({
  ...
  const { formatMessage } = useIntl();
  const displayedValue = value === null || (value == null ? void 0 : value.length) === 0 ? formatMessage({ id: "global.none", defaultMessage: "None" }) : [...value].sort().map((v) => (0, import_upperFirst2.default)(v)).join(", ");
  const label = intlLabel.id ? formatMessage({ id: intlLabel.id, defaultMessage: intlLabel.defaultMessage }) : name;
  return (0, import_jsx_runtime4.jsxs)(Field.Root, { name, children: [
    (0, import_jsx_runtime4.jsx)(Field.Label, { children: label }),
...
// ../packages/core/content-type-builder/admin/src/components/AttributeOptions/OptionBoxWrapper.tsx
...
// ../packages/core/content-type-builder/admin/src/components/AttributeOptions/AttributeOption.tsx
var import_jsx_runtime5 = __toESM(require_jsx_runtime());
var newAttributes = [];
var NewBadge = () => (0, import_jsx_runtime5.jsx)(Flex, { grow: 1, justifyContent: "flex-end", children: (0, import_jsx_runtime5.jsxs)(Flex, { gap: 1, hasRadius: true, background: "alternative100", padding: `0.2rem 0.4rem`, children: [
  (0, import_jsx_runtime5.jsx)(ForwardRef$N, { width: `1rem`, height: `1rem`, fill: "alternative600" }),
  (0, import_jsx_runtime5.jsx)(Typography, { textColor: "alternative600", variant: "sigma", children: "New" })
] }) });
var AttributeOption = ({ type = "text" }) => {
  ...
  return (0, import_jsx_runtime5.jsx)(OptionBoxWrapper, { padding: 4, tag: "button", hasRadius: true, type: "button", onClick: handleClick, children: (0, import_jsx_runtime5.jsxs)(Flex, { children: [
    (0, import_jsx_runtime5.jsx)(AttributeIcon, { type }),
    (0, import_jsx_runtime5.jsxs)(Box, { paddingLeft: 4, width: "100%", children: [
      (0, import_jsx_runtime5.jsxs)(Flex, { justifyContent: "space-between", children: [
        (0, import_jsx_runtime5.jsx)(Typography, { fontWeight: "bold", textColor: "neutral800", children: formatMessage({ id: getTrad(`attribute.${type}`), defaultMessage: type }) }),
        newAttributes.includes(type) && (0, import_jsx_runtime5.jsx)(NewBadge, {})
      ] }),
      (0, import_jsx_runtime5.jsx)(Flex, { children: (0, import_jsx_runtime5.jsx)(Typography, { variant: "pi", textColor: "neutral600", children: formatMessage({
...
// ../packages/core/content-type-builder/admin/src/components/AttributeOptions/AttributeList.tsx
var import_jsx_runtime6 = __toESM(require_jsx_runtime());
var AttributeList = ({ attributes }) => (0, import_jsx_runtime6.jsx)(KeyboardNavigable, { tagName: "button", children: (0, import_jsx_runtime6.jsx)(Flex, { direction: "column", alignItems: "stretch", gap: 8, children: attributes.map((attributeRow, index) => {
  return (
    // eslint-disable-next-line react/no-array-index-key
    (0, import_jsx_runtime6.jsx)(Grid.Root, { gap: 3, children: attributeRow.map((attribute) => (0, import_jsx_runtime6.jsx)(Grid.Item, { col: 6, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime6.jsx)(AttributeOption, { type: attribute }) }, attribute)) }, index)
  );
}) }) });

// ../packages/core/content-type-builder/admin/src/components/AttributeOptions/CustomFieldOption.tsx
...
var CustomFieldOption = ({ customFieldUid, customField }) => {
  ...
  return (0, import_jsx_runtime7.jsx)(OptionBoxWrapper, { padding: 4, tag: "button", hasRadius: true, type: "button", onClick: handleClick, children: (0, import_jsx_runtime7.jsxs)(Flex, { children: [
    (0, import_jsx_runtime7.jsx)(AttributeIcon, { type, customField: customFieldUid }),
    (0, import_jsx_runtime7.jsxs)(Box, { paddingLeft: 4, children: [
      (0, import_jsx_runtime7.jsx)(Flex, { children: (0, import_jsx_runtime7.jsx)(Typography, { fontWeight: "bold", textColor: "neutral800", children: formatMessage(intlLabel) }) }),
      (0, import_jsx_runtime7.jsx)(Flex, { children: (0, import_jsx_runtime7.jsx)(Typography, { variant: "pi", textColor: "neutral600", children: formatMessage(intlDescription) }) })
    ] })
  ] }) });
};

// ../packages/core/content-type-builder/admin/src/components/AttributeOptions/EmptyAttributes.tsx
...
`;
var EmptyCardGrid = () => {
  return (0, import_jsx_runtime8.jsx)(Flex, { wrap: "wrap", gap: 4, children: [...Array(4)].map((_, idx) => {
...
var EmptyAttributes = () => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime8.jsxs)(Box, { position: "relative", children: [
    (0, import_jsx_runtime8.jsx)(EmptyCardGrid, {}),
    (0, import_jsx_runtime8.jsx)(Box, { position: "absolute", top: 6, width: "100%", children: (0, import_jsx_runtime8.jsxs)(Flex, { alignItems: "center", justifyContent: "center", direction: "column", children: [
      (0, import_jsx_runtime8.jsx)(ForwardRef$J, { width: "160px", height: "88px" }),
      (0, import_jsx_runtime8.jsx)(Box, { paddingTop: 6, paddingBottom: 4, children: (0, import_jsx_runtime8.jsxs)(Box, { textAlign: "center", children: [
        (0, import_jsx_runtime8.jsx)(Typography, { variant: "delta", tag: "p", textColor: "neutral600", children: formatMessage({
          id: getTrad("modalForm.empty.heading"),
          defaultMessage: "Nothing in here yet."
        }) }),
        (0, import_jsx_runtime8.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime8.jsx)(Typography, { variant: "delta", tag: "p", textColor: "neutral600", children: formatMessage({
...
// ../packages/core/content-type-builder/admin/src/components/AttributeOptions/CustomFieldsList.tsx
...
var CustomFieldsList = () => {
  ...
  return (0, import_jsx_runtime9.jsx)(KeyboardNavigable, { tagName: "button", children: (0, import_jsx_runtime9.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 3, children: [
    (0, import_jsx_runtime9.jsx)(Grid.Root, { gap: 3, children: sortedCustomFields.map(([uid, customField]) => (0, import_jsx_runtime9.jsx)(Grid.Item, { col: 6, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime9.jsx)(CustomFieldOption, { customFieldUid: uid, customField }, uid) }, uid)) }),
...
// ../packages/core/content-type-builder/admin/src/components/AttributeOptions/AttributeOptions.tsx
...
var AttributeOptions = ({ attributes, forTarget, kind }) => {
  ...
  return (0, import_jsx_runtime10.jsx)(Modal.Body, { children: (0, import_jsx_runtime10.jsxs)(Tabs.Root, { variant: "simple", defaultValue: "default", children: [
    (0, import_jsx_runtime10.jsxs)(Flex, { justifyContent: "space-between", children: [
      (0, import_jsx_runtime10.jsx)(Typography, { variant: "beta", tag: "h2", children: formatMessage({ id: titleId, defaultMessage: "Select a field" }) }),
      (0, import_jsx_runtime10.jsxs)(Tabs.List, { children: [
        (0, import_jsx_runtime10.jsx)(Tabs.Trigger, { value: "default", children: formatMessage({ id: defaultTabId, defaultMessage: "Default" }) }),
        (0, import_jsx_runtime10.jsx)(Tabs.Trigger, { value: "custom", children: formatMessage({ id: customTabId, defaultMessage: "Custom" }) })
      ] })
    ] }),
    (0, import_jsx_runtime10.jsx)(Divider, { marginBottom: 6 }),
    (0, import_jsx_runtime10.jsx)(Tabs.Content, { value: "default", children: (0, import_jsx_runtime10.jsx)(AttributeList, { attributes }) }),
    (0, import_jsx_runtime10.jsx)(Tabs.Content, { value: "custom", children: (0, import_jsx_runtime10.jsx)(CustomFieldsList, {}) })
  ] }) });
};

// ../packages/core/content-type-builder/admin/src/components/BooleanDefaultValueSelect.tsx
...
var BooleanDefaultValueSelect = ({
  ...
  return (0, import_jsx_runtime11.jsxs)(Field.Root, { name, children: [
    (0, import_jsx_runtime11.jsx)(Field.Label, { children: label }),
    (0, import_jsx_runtime11.jsx)(SingleSelect, { onChange: handleChange, value: (value === null ? "" : value).toString(), children: options2.map(({ metadatas: { intlLabel: intlLabel2, disabled, hidden }, key, value: value2 }) => {
      return (0, import_jsx_runtime11.jsx)(SingleSelectOption, { value: value2, disabled, hidden, children: intlLabel2.defaultMessage }, key);
    }) })
  ] });
};

// ../packages/core/content-type-builder/admin/src/components/CustomRadioGroup/Styles.tsx
var Wrapper = dt(Flex)`
  position: relative;
  align-items: stretch;
...
// ../packages/core/content-type-builder/admin/src/components/CustomRadioGroup/CustomRadioGroup.tsx
...
var CustomRadioGroup = ({
  ...
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime12.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 2, children: [
    (0, import_jsx_runtime12.jsx)(Typography, { variant: "pi", fontWeight: "bold", textColor: "neutral800", htmlFor: name, tag: "label", children: formatMessage(intlLabel) }),
    (0, import_jsx_runtime12.jsx)(Wrapper, { gap: 4, alignItems: "stretch", children: radios.map((radio) => {
      return (0, import_jsx_runtime12.jsxs)("label", { htmlFor: radio.value.toString(), className: "container", children: [
        ...
        (0, import_jsx_runtime12.jsx)(Box, { className: "option", padding: 4, children: (0, import_jsx_runtime12.jsxs)(Flex, { children: [
          (0, import_jsx_runtime12.jsx)(Box, { paddingRight: 4, children: (0, import_jsx_runtime12.jsx)("span", { className: "checkmark" }) }),
          (0, import_jsx_runtime12.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 2, children: [
            (0, import_jsx_runtime12.jsx)(Typography, { fontWeight: "bold", children: formatMessage(radio.title) }),
            (0, import_jsx_runtime12.jsx)(Typography, { variant: "pi", textColor: "neutral600", children: formatMessage(radio.description) })
          ] })
        ] }) })
      ] }, radio.value);
    }) })
...
// ../packages/core/content-type-builder/admin/src/components/BooleanRadioGroup.tsx
...
var BooleanRadioGroup = ({
  ...
  return (0, import_jsx_runtime13.jsx)(CustomRadioGroup, { ...rest, name, onChange: handleChange, intlLabel });
};

// ../packages/core/content-type-builder/admin/src/components/CheckboxWithNumberField.tsx
...
var CheckboxWithNumberField = ({
  ...
  return (0, import_jsx_runtime14.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 2, children: [
    ...
    value !== null && (0, import_jsx_runtime14.jsx)(Box, { paddingLeft: 6, style: { maxWidth: "200px" }, children: type === "text" ? (0, import_jsx_runtime14.jsxs)(Field.Root, { error: errorMessage, name, children: [
      (0, import_jsx_runtime14.jsx)(
        TextInput,
        {
          "aria-label": label,
    ...
    ] }) : (0, import_jsx_runtime14.jsxs)(Field.Root, { error: errorMessage, name, children: [
      (0, import_jsx_runtime14.jsx)(
        NumberInput,
        {
          "aria-label": label,
...
// ../packages/core/content-type-builder/admin/src/components/ContentTypeRadioGroup.tsx
...
var ContentTypeRadioGroup = ({ onChange, ...rest }) => {
  ...
  return (0, import_jsx_runtime15.jsx)(CustomRadioGroup, { ...rest, onChange: handleChange });
};

// ../packages/core/content-type-builder/admin/src/components/DraftAndPublishToggle.tsx
...
var DraftAndPublishToggle = ({
  ...
  return (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
    (0, import_jsx_runtime16.jsxs)(Field.Root, { hint, name, children: [
      (0, import_jsx_runtime16.jsx)(CheckboxImpl, { checked: value, disabled, onCheckedChange: handleChange, children: label }),
      (0, import_jsx_runtime16.jsx)(Field.Hint, {})
    ] }),
    (0, import_jsx_runtime16.jsx)(Dialog.Root, { open: showWarning, onOpenChange: (isOpen) => setShowWarning(isOpen), children: (0, import_jsx_runtime16.jsx)(
      ConfirmDialog,
      {
        endAction: (0, import_jsx_runtime16.jsx)(Button, { onClick: handleConfirm, variant: "danger", width: "100%", justifyContent: "center", children: formatMessage({
...
// ../packages/core/content-type-builder/admin/src/components/FormModalEndActions.tsx
...
var FormModalEndActions = ({
  ...
  if (isAttributeModal && isDzAttribute && isCreatingDz) {
    return (0, import_jsx_runtime17.jsx)(import_jsx_runtime17.Fragment, { children: (0, import_jsx_runtime17.jsx)(
      Button,
      {
        variant: "secondary",
        type: "submit",
  ...
  if (isAttributeModal && isComponentAttribute) {
    ...
    return (0, import_jsx_runtime17.jsxs)(Flex, { gap: 2, children: [
  ...
  if (isContentTypeModal) {
    return (0, import_jsx_runtime17.jsxs)(Flex, { gap: 2, children: [
      !isCreatingContentType && (0, import_jsx_runtime17.jsxs)(import_jsx_runtime17.Fragment, { children: [
        (0, import_jsx_runtime17.jsx)(
          Button,
          {
            type: "button",
      ...
      isCreatingContentType && (0, import_jsx_runtime17.jsx)(
        Button,
        {
          type: "submit",
          variant: "secondary",
  ...
  if (isComponentModal) {
    return (0, import_jsx_runtime17.jsxs)(Flex, { gap: 2, children: [
      !isCreatingComponent && (0, import_jsx_runtime17.jsxs)(import_jsx_runtime17.Fragment, { children: [
        (0, import_jsx_runtime17.jsx)(
          Button,
          {
            type: "button",
      ...
      isCreatingComponent && (0, import_jsx_runtime17.jsx)(
        Button,
        {
          type: "submit",
          variant: "secondary",
...
// ../packages/core/content-type-builder/admin/src/components/FormModalHeader.tsx
...
var FormModalHeader = ({
  ...
  if (isCreatingMainSchema) {
    ...
    return (0, import_jsx_runtime18.jsx)(Modal.Header, { children: (0, import_jsx_runtime18.jsxs)(Flex, { children: [
      (0, import_jsx_runtime18.jsx)(Box, { children: (0, import_jsx_runtime18.jsx)(AttributeIcon, { type: icon }) }),
      (0, import_jsx_runtime18.jsx)(Box, { paddingLeft: 3, children: (0, import_jsx_runtime18.jsx)(Modal.Title, { children: formatMessage({ id: headerId }, { name: displayName }) }) })
    ] }) });
  }
  headers = [
    {
  ...
  return (0, import_jsx_runtime18.jsx)(Modal.Header, { children: (0, import_jsx_runtime18.jsxs)(Flex, { gap: 3, children: [
    ...
    (0, import_jsx_runtime18.jsx)(AttributeIcon, { type: icon, customField: customFieldUid }),
    (0, import_jsx_runtime18.jsx)(Breadcrumbs, { label: headers.map(({ label }) => label).join(","), children: headers.map(({ label, info }, index, arr) => {
      ...
      return (0, import_jsx_runtime18.jsx)(Crumb, { isCurrent: index === arr.length - 1, children: label }, key);
    }) })
  ] }) });
};

// ../packages/core/content-type-builder/admin/src/components/FormModalSubHeader.tsx
var import_upperFirst4 = __toESM(require_upperFirst());
...
var FormModalSubHeader = ({
  ...
  return (0, import_jsx_runtime19.jsxs)(Flex, { direction: "column", alignItems: "flex-start", paddingBottom: 1, gap: 1, children: [
    (0, import_jsx_runtime19.jsx)(Typography, { tag: "h2", variant: "beta", children: formatMessage(
      {
    ...
    (0, import_jsx_runtime19.jsx)(Typography, { variant: "pi", textColor: "neutral600", children: formatMessage({
...
// ../packages/core/content-type-builder/admin/src/components/IconPicker/IconPicker.tsx
...
var IconPick = ({ iconKey, name, onChange, isSelected, ariaLabel }) => {
  ...
  return (0, import_jsx_runtime20.jsx)(Field.Root, { name, required: false, children: (0, import_jsx_runtime20.jsxs)(Field.Label, { children: [
    (0, import_jsx_runtime20.jsxs)(VisuallyHidden, { children: [
      ariaLabel,
    ...
    (0, import_jsx_runtime20.jsx)(TooltipImpl, { label: iconKey, children: (0, import_jsx_runtime20.jsx)(
      Flex,
      {
        padding: 2,
        cursor: "pointer",
        ...
        children: (0, import_jsx_runtime20.jsx)(Icon, { width: "2rem", height: "2rem", fill: isSelected ? "primary600" : "neutral300" })
      }
    ) })
  ] }) });
};
var IconPicker = ({ intlLabel, name, onChange, value = "" }) => {
  ...
  const [icons, setIcons] = (0, import_react5.useState)(allIcons);
  const searchIconRef = (0, import_react5.useRef)(null);
  const searchBarRef = (0, import_react5.useRef)(null);
  const toggleSearch = () => {
  ...
  return (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [
    (0, import_jsx_runtime20.jsxs)(Flex, { justifyContent: "space-between", paddingBottom: 2, children: [
      (0, import_jsx_runtime20.jsx)(Typography, { variant: "pi", fontWeight: "bold", textColor: "neutral800", tag: "label", children: formatMessage(intlLabel) }),
      (0, import_jsx_runtime20.jsxs)(Flex, { gap: 1, children: [
        showSearch ? (0, import_jsx_runtime20.jsx)(
          Searchbar,
          {
            ref: searchBarRef,
            name: "searchbar",
        ...
        value && (0, import_jsx_runtime20.jsx)(
          TooltipImpl,
          {
            label: formatMessage({
    ...
    (0, import_jsx_runtime20.jsx)(
      IconPickerWrapper,
      {
        ...
        overflow: "auto",
        textAlign: "center",
        children: icons.length > 0 ? icons.map((iconKey) => (0, import_jsx_runtime20.jsx)(
          IconPick,
          {
            iconKey,
            name,
          ...
          iconKey
        )) : (0, import_jsx_runtime20.jsx)(Box, { padding: 4, grow: 2, children: (0, import_jsx_runtime20.jsx)(Typography, { variant: "delta", textColor: "neutral600", textAlign: "center", children: formatMessage({
...
// ../packages/core/content-type-builder/admin/src/components/PluralName.tsx
...
var PluralName = ({
  ...
  const previousDisplayName = (0, import_react6.useRef)(displayName);
  const previousValue = (0, import_react6.useRef)(value);
  ...
  return (0, import_jsx_runtime21.jsxs)(Field.Root, { error: errorMessage, hint, name, children: [
    (0, import_jsx_runtime21.jsx)(Field.Label, { children: label }),
    (0, import_jsx_runtime21.jsx)(TextInput, { onChange, value: value || "" }),
    (0, import_jsx_runtime21.jsx)(Field.Error, {})
  ] });
};

// ../packages/core/content-type-builder/admin/src/components/GenericInputs.tsx
var React2 = __toESM(require_react());
var import_isEqual2 = __toESM(require_isEqual());

// ../packages/core/content-type-builder/admin/src/utils/parseDateValue.ts
...
// ../packages/core/content-type-builder/admin/src/utils/timeFormat.ts
...
var GenericInput = ({
  ...
  const getComponent = () => {
    switch (type) {
      ...
      case "password": {
        return (0, import_jsx_runtime22.jsx)(
          TextInput,
          {
            autoComplete,
            disabled,
            endAction: (0, import_jsx_runtime22.jsx)(
              "button",
              {
                "aria-label": formatMessage({
                ...
                type: "button",
                children: showPassword ? (0, import_jsx_runtime22.jsx)(ForwardRef$3L, { fill: "neutral500" }) : (0, import_jsx_runtime22.jsx)(ForwardRef$3J, { fill: "neutral500" })
              }
            ),
            onChange: (e) => {
              onChange({ target: { name, value: e.target.value, type } });
        ...
        return (0, import_jsx_runtime22.jsx)(
          SingleSelect,
          {
            ...
            children: options2.map(({ metadatas: { intlLabel: intlLabel2, disabled: disabled2, hidden }, key, value: value2 }) => {
              return (0, import_jsx_runtime22.jsx)(SingleSelectOption, { value: value2, disabled: disabled2, hidden, children: formatMessage(intlLabel2) }, key);
            })
          }
        );
      }
      ...
      default: {
        return (0, import_jsx_runtime22.jsx)(TextInput, { disabled: true, placeholder: "Not supported", type: "text", value: "" });
      }
    }
  };
  return (0, import_jsx_runtime22.jsxs)(Field.Root, { error: errorMessage, name, hint, required, children: [
    type !== "checkbox" ? (0, import_jsx_runtime22.jsx)(Field.Label, { action: labelAction, children: label }) : null,
    getComponent(),
...
// ../packages/core/content-type-builder/admin/src/components/Relation/RelationField/RelationTargetPicker/RelationTargetPicker.tsx
...
var RelationTargetPicker = ({
  ...
  const handleSelect = ({ uid, plugin, title, restrictRelationsTo }) => () => {
    ...
    dispatch(
      actions2.onChangeRelationTarget({
        target: {
          value: uid,
          oneThatIsCreatingARelationWithAnother,
  ...
  return (0, import_jsx_runtime23.jsxs)(Menu.Root, { children: [
    (0, import_jsx_runtime23.jsx)(MenuTrigger, { children: `${type.info.displayName} ${type.plugin ? `(from: ${type.plugin})` : ""}` }),
    (0, import_jsx_runtime23.jsx)(Menu.Content, { zIndex: "popover", children: allowedContentTypesForRelation.map(({ uid, title, restrictRelationsTo, plugin }) => (0, import_jsx_runtime23.jsxs)(Menu.Item, { onSelect: handleSelect({ uid, plugin, title, restrictRelationsTo }), children: [
      title,
      " ",
      plugin && (0, import_jsx_runtime23.jsxs)(import_jsx_runtime23.Fragment, { children: [
        "(from: ",
        plugin,
        ")"
      ] })
...
// ../packages/core/content-type-builder/admin/src/components/Relation/RelationField/RelationField.tsx
...
var RelationFormBox = ({
  ...
  return (0, import_jsx_runtime24.jsxs)(Box, { background: "neutral100", hasRadius: true, borderColor: "neutral200", children: [
    (0, import_jsx_runtime24.jsx)(Flex, { paddingTop: isMain ? 4 : 1, paddingBottom: isMain ? 3 : 1, justifyContent: "center", children: isMain ? (0, import_jsx_runtime24.jsx)(Typography, { variant: "pi", fontWeight: "bold", textColor: "neutral800", children: header }) : (0, import_jsx_runtime24.jsx)(
    ...
    (0, import_jsx_runtime24.jsx)(Divider, { background: "neutral200" }),
    (0, import_jsx_runtime24.jsx)(Box, { padding: 4, children: (0, import_jsx_runtime24.jsx)(
...
// ../packages/core/content-type-builder/admin/src/components/Relation/RelationNaturePicker/RelationNaturePicker.tsx
...
// ../packages/core/content-type-builder/admin/src/components/Relation/RelationNaturePicker/Components.tsx
var Wrapper2 = dt(Box)`
  position: relative;
  width: 100%;
  &::before {
...
var RelationNaturePicker = ({
  ...
  const dataType = naturePickerType === "component" ? "component" : (0, import_get3.default)(contentTypes, [targetUid, "kind"], "");
  ...
  const targetLabel = (0, import_get3.default)(contentTypes, [target, "info", "displayName"], "unknown");
  ...
  const restrictedRelations = (0, import_get3.default)(contentTypes, [target, "restrictRelationsTo"], null);
  const rightDisplayedValue = (0, import_pluralize2.default)(
    rightTarget,
  ...
  return (0, import_jsx_runtime25.jsxs)(Flex, { style: { flex: 1 }, children: [
    (0, import_jsx_runtime25.jsx)(Wrapper2, { children: (0, import_jsx_runtime25.jsx)(Flex, { paddingLeft: 9, paddingRight: 9, paddingTop: 1, justifyContent: "center", children: (0, import_jsx_runtime25.jsx)(KeyboardNavigable, { tagName: "button", children: (0, import_jsx_runtime25.jsx)(Flex, { gap: 3, children: relationsType.map((relation) => {
      ...
      return (0, import_jsx_runtime25.jsx)(
        IconWrapper,
        {
          ...
          children: (0, import_jsx_runtime25.jsx)(Asset, { "aria-hidden": "true" }, relation)
        },
        relation
      );
    }) }) }) }) }),
    (0, import_jsx_runtime25.jsxs)(InfosWrapper, { justifyContent: "center", children: [
      (0, import_jsx_runtime25.jsxs)(Typography, { children: [
        (0, import_truncate.default)(leftDisplayedValue, { length: 24 }),
        " "
      ] }),
      (0, import_jsx_runtime25.jsxs)(Typography, { textColor: "primary600", children: [
        formatMessage({ id: getTrad(`relation.${relationType}`) }),
        " "
      ] }),
      (0, import_jsx_runtime25.jsx)(Typography, { children: (0, import_truncate.default)(rightDisplayedValue, { length: 24 }) })
    ] })
  ] });
};

// ../packages/core/content-type-builder/admin/src/components/Relation/Relation.tsx
...
var Relation = ({
  ...
  return (0, import_jsx_runtime26.jsxs)(Flex, { style: { position: "relative" }, children: [
...
// ../packages/core/content-type-builder/admin/src/components/SelectCategory.tsx
...
var SelectCategory = ({
  ...
  const [categories, setCategories] = (0, import_react7.useState)(allComponentsCategories);
  const errorMessage = error ? formatMessage({ id: error, defaultMessage: error }) : "";
  const label = formatMessage(intlLabel);
  const handleChange = (value2) => {
  ...
  return (0, import_jsx_runtime27.jsxs)(Field.Root, { error: errorMessage, name, children: [
    (0, import_jsx_runtime27.jsx)(Field.Label, { children: label }),
    (0, import_jsx_runtime27.jsx)(
      Combobox,
      {
        ...
        value,
        creatable: true,
        children: categories.map((category) => (0, import_jsx_runtime27.jsx)(Option, { value: category, children: category }, category))
      }
    ),
...
// ../packages/core/content-type-builder/admin/src/components/SelectComponent.tsx
...
var SelectComponent = ({
  ...
  return (0, import_jsx_runtime28.jsxs)(Field.Root, { error: errorMessage, name, children: [
    (0, import_jsx_runtime28.jsx)(Field.Label, { children: label }),
    (0, import_jsx_runtime28.jsx)(
      SingleSelect,
      {
        ...
        children: options2.map((option) => {
          return (0, import_jsx_runtime28.jsx)(SingleSelectOption, { value: option.uid, children: `${option.categoryName} - ${option.label}` }, option.uid);
        })
      }
    ),
...
// ../packages/core/content-type-builder/admin/src/components/SelectComponents.tsx
...
var SelectComponents = ({
  ...
  return (0, import_jsx_runtime29.jsxs)(Field.Root, { name, children: [
    (0, import_jsx_runtime29.jsx)(Field.Label, { children: formatMessage(intlLabel) }),
...
// ../packages/core/content-type-builder/admin/src/components/SelectDateType.tsx
...
var SelectDateType = ({
  ...
  return (0, import_jsx_runtime30.jsxs)(Field.Root, { error: errorMessage, name, children: [
    (0, import_jsx_runtime30.jsx)(Field.Label, { children: label }),
    (0, import_jsx_runtime30.jsx)(SingleSelect, { onChange: handleChange, value: value || "", children: options2.map(({ metadatas: { intlLabel: intlLabel2, disabled, hidden }, key, value: value2 }) => {
      return (0, import_jsx_runtime30.jsx)(SingleSelectOption, { value: value2, disabled, hidden, children: formatMessage(
...
// ../packages/core/content-type-builder/admin/src/components/SelectNumber.tsx
...
var SelectNumber = ({
  ...
  return (0, import_jsx_runtime31.jsxs)(Field.Root, { error: errorMessage, name, children: [
    (0, import_jsx_runtime31.jsx)(Field.Label, { children: label }),
    (0, import_jsx_runtime31.jsx)(SingleSelect, { onChange: handleChange, value: value || "", children: options2.map(({ metadatas: { intlLabel: intlLabel2, disabled, hidden }, key, value: value2 }) => {
      return (0, import_jsx_runtime31.jsx)(SingleSelectOption, { value: value2, disabled, hidden, children: formatMessage(intlLabel2) }, key);
    }) }),
    (0, import_jsx_runtime31.jsx)(Field.Error, {})
  ] });
};

// ../packages/core/content-type-builder/admin/src/components/SingularName.tsx
...
var SingularName = ({
  ...
  const previousDisplayName = (0, import_react8.useRef)((modifiedData == null ? void 0 : modifiedData.displayName) || "");
  const displayName = (modifiedData == null ? void 0 : modifiedData.displayName) || "";
  ...
  const label = formatMessage(intlLabel);
  return (0, import_jsx_runtime32.jsxs)(Field.Root, { error: errorMessage, hint, name, children: [
    (0, import_jsx_runtime32.jsx)(Field.Label, { children: label }),
    (0, import_jsx_runtime32.jsx)(TextInput, { onChange, value: value || "" }),
    (0, import_jsx_runtime32.jsx)(Field.Error, {}),
    (0, import_jsx_runtime32.jsx)(Field.Hint, {})
  ] });
};

// ../packages/core/content-type-builder/admin/src/components/TabForm.tsx
...
var TabForm = ({
  ...
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime33.jsx)(import_jsx_runtime33.Fragment, { children: form.map((section, sectionIndex) => {
    if (section.items.length === 0) {
      return null;
    }
    return (0, import_jsx_runtime33.jsxs)(Box, { children: [
      section.sectionTitle && (0, import_jsx_runtime33.jsx)(Box, { paddingBottom: 4, children: (0, import_jsx_runtime33.jsx)(Typography, { variant: "delta", tag: "h3", children: formatMessage(section.sectionTitle) }) }),
      section.intlLabel && (0, import_jsx_runtime33.jsx)(Typography, { variant: "pi", textColor: "neutral600", children: formatMessage(section.intlLabel) }),
      (0, import_jsx_runtime33.jsx)(Grid.Root, { gap: 4, children: section.items.map((input, i) => {
        var _a;
        ...
        const errorId = pluginOptionError ? formErrors[pluginOptionError].id : (0, import_get4.default)(
          formErrors,
          [
        ...
        if (input.type === "condition-form") {
          ...
          return (0, import_jsx_runtime33.jsx)(
            Grid.Item,
            {
              ...
              direction: "column",
              alignItems: "stretch",
              children: !currentCondition || Object.keys(currentCondition).length === 0 ? (0, import_jsx_runtime33.jsxs)(Box, { children: [
                currentCondition && Object.keys(currentCondition).length > 0 && (0, import_jsx_runtime33.jsx)(Typography, { variant: "sigma", textColor: "neutral800", marginBottom: 2, children: formatCondition(
                  currentCondition,
                  availableFields,
                  genericInputProps.attributeName || modifiedData.name
                ) }),
                (0, import_jsx_runtime33.jsx)(TooltipImpl, { label: noFieldsMessage, children: (0, import_jsx_runtime33.jsx)(
                  Button,
                  {
                    ...
                    startIcon: (0, import_jsx_runtime33.jsx)("span", { "aria-hidden": true, children: "＋" }),
...
// ../packages/core/content-type-builder/admin/src/components/TextareaEnum.tsx
...
var TextareaEnum = ({
  ...
  return (0, import_jsx_runtime34.jsxs)(Field.Root, { error: errorMessage, hint, name, children: [
    (0, import_jsx_runtime34.jsx)(Field.Label, { action: labelAction, children: label }),
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/attributes/ConditionForm.tsx
var React3 = __toESM(require_react());
var import_react9 = __toESM(require_react());

// ../packages/core/content-type-builder/admin/src/components/ApplyConditionButton.tsx
var import_jsx_runtime35 = __toESM(require_jsx_runtime());
var ApplyConditionButton = ({
  disabled,
  tooltipMessage,
  onClick,
  marginTop = 4
  ...
  const { formatMessage } = useIntl();
  const button = (0, import_jsx_runtime35.jsx)(
    Button,
    {
      marginTop,
      fullWidth: true,
      ...
      disabled,
      onClick,
      startIcon: (0, import_jsx_runtime35.jsx)("span", { "aria-hidden": true, children: "＋" }),
      children: formatMessage({
        id: "form.attribute.condition.apply",
        defaultMessage: "Apply condition"
      })
  ...
  if (tooltipMessage) {
    return (0, import_jsx_runtime35.jsx)(TooltipImpl, { description: tooltipMessage, children: button });
  }
  return button;
};
...
var convertFromJsonLogic = (jsonLogic) => {
  ...
  return {
    ...
    value,
    action: "show"
    // Default to 'show' for 'visible'; adjust based on backend logic
  };
};
...
var ConditionForm = ({
  ...
  const [showConfirmDialog, setShowConfirmDialog] = (0, import_react9.useState)(false);
  ...
  const handleValueChange = (newValue) => {
    ...
    const updatedValue = { ...localValue, value: value2 };
    updateCondition(updatedValue);
  };
  ...
  if (!hasCondition) {
    return (0, import_jsx_runtime36.jsx)(Box, { padding: 4, margin: 4, hasRadius: true, background: "neutral0", borderColor: "neutral200", children: (0, import_jsx_runtime36.jsx)(ApplyConditionButton, { onClick: handleApplyCondition }) });
  }
  return (0, import_jsx_runtime36.jsx)(Box, { marginTop: 2, children: (0, import_jsx_runtime36.jsxs)(
    Box,
    {
      background: "neutral0",
      hasRadius: true,
      ...
      borderStyle: "solid",
      children: [
        (0, import_jsx_runtime36.jsxs)(Flex, { justifyContent: "space-between", alignItems: "center", padding: 4, children: [
          (0, import_jsx_runtime36.jsx)(Typography, { variant: "sigma", textColor: "neutral800", children: formatMessage(
            {
              id: getTrad("form.attribute.condition.title"),
              defaultMessage: "Condition for {name}"
            },
            {
              name: (0, import_jsx_runtime36.jsx)("strong", { children: attributeName })
            }
          ) }),
          (0, import_jsx_runtime36.jsxs)(Dialog.Root, { open: showConfirmDialog, onOpenChange: setShowConfirmDialog, children: [
            (0, import_jsx_runtime36.jsx)(Dialog.Trigger, { children: (0, import_jsx_runtime36.jsx)(IconButton, { label: "Delete", children: (0, import_jsx_runtime36.jsx)(ForwardRef$n, {}) }) }),
            (0, import_jsx_runtime36.jsx)(ConfirmDialog, { onConfirm: handleDelete, children: formatMessage({
              id: getTrad("popUpWarning.bodyMessage.delete-condition"),
              defaultMessage: "Are you sure you want to delete this condition?"
            }) })
          ] })
        ] }),
        (0, import_jsx_runtime36.jsxs)(Box, { background: "neutral100", padding: 4, children: [
          (0, import_jsx_runtime36.jsx)(Box, { paddingBottom: 2, children: (0, import_jsx_runtime36.jsx)(
            Typography,
            {
              variant: "sigma",
              textColor: "neutral600",
              style: { textTransform: "uppercase", letterSpacing: 1 },
              children: formatMessage({ id: getTrad("form.attribute.condition.if"), defaultMessage: "IF" })
            }
          ) }),
          (0, import_jsx_runtime36.jsxs)(Flex, { gap: 4, children: [
            (0, import_jsx_runtime36.jsx)(Box, { minWidth: 0, flex: 1, children: (0, import_jsx_runtime36.jsx)(Field.Root, { name: `${name}.field`, children: (0, import_jsx_runtime36.jsx)(
              SingleSelect,
              {
                ...
                children: conditionFields.map((field) => (0, import_jsx_runtime36.jsx)(SingleSelectOption, { value: field.name, children: (0, import_jsx_runtime36.jsxs)(Flex, { gap: 2, alignItems: "center", children: [
                  (0, import_jsx_runtime36.jsx)(SmallAttributeIcon, { type: field.type }),
                  (0, import_jsx_runtime36.jsx)("span", { children: field.name })
                ] }) }, field.name))
              }
            ) }) }),
            (0, import_jsx_runtime36.jsx)(Box, { minWidth: 0, flex: 1, children: (0, import_jsx_runtime36.jsx)(Field.Root, { name: `${name}.operator`, children: (0, import_jsx_runtime36.jsxs)(
              SingleSelect,
              {
                ...
                children: [
                  (0, import_jsx_runtime36.jsx)(SingleSelectOption, { value: "is", children: formatMessage({
                    id: getTrad("form.attribute.condition.operator.is"),
                    defaultMessage: "is"
                  }) }),
                  (0, import_jsx_runtime36.jsx)(SingleSelectOption, { value: "isNot", children: formatMessage({
            ...
            (0, import_jsx_runtime36.jsx)(Box, { minWidth: 0, flex: 1, children: (0, import_jsx_runtime36.jsx)(Field.Root, { name: `${name}.value`, children: (0, import_jsx_runtime36.jsx)(
              SingleSelect,
              {
                ...
                children: isEnumField && (selectedField == null ? void 0 : selectedField.enum) ? selectedField.enum.map((enumValue) => (0, import_jsx_runtime36.jsx)(SingleSelectOption, { value: enumValue, children: enumValue }, enumValue)) : (0, import_jsx_runtime36.jsxs)(import_jsx_runtime36.Fragment, { children: [
                  (0, import_jsx_runtime36.jsx)(SingleSelectOption, { value: "true", children: formatMessage({
                    id: getTrad("form.attribute.condition.value.true"),
                    defaultMessage: "true"
                  }) }),
                  (0, import_jsx_runtime36.jsx)(SingleSelectOption, { value: "false", children: formatMessage({
        ...
        (0, import_jsx_runtime36.jsxs)(Box, { background: "neutral100", padding: 4, children: [
          (0, import_jsx_runtime36.jsx)(Box, { paddingBottom: 4, children: (0, import_jsx_runtime36.jsx)(
            Typography,
            {
              variant: "sigma",
              textColor: "neutral600",
          ...
          (0, import_jsx_runtime36.jsx)(Box, { paddingBottom: 4, children: (0, import_jsx_runtime36.jsx)(Field.Root, { name: `${name}.action`, children: (0, import_jsx_runtime36.jsxs)(
            SingleSelect,
            {
              ...
              children: [
                (0, import_jsx_runtime36.jsxs)(SingleSelectOption, { value: "show", children: [
                  "Show ",
                  (0, import_jsx_runtime36.jsx)("span", { style: { fontWeight: "bold" }, children: attributeName || name })
                ] }),
                (0, import_jsx_runtime36.jsxs)(SingleSelectOption, { value: "hide", children: [
                  "Hide ",
                  (0, import_jsx_runtime36.jsx)("span", { style: { fontWeight: "bold" }, children: attributeName || name })
                ] })
              ]
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/attributes/nameField.ts
var nameField = {
  name: "name",
  type: "text",
  intlLabel: {
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/attributes/commonBaseForm.ts
var commonBaseForm = {
  sections: [{ sectionTitle: null, items: [nameField] }]
};

// ../packages/core/content-type-builder/admin/src/components/FormModal/component/componentForm.ts
var componentForm = {
  base(prefix = "") {
    const sections = [
      {
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/attributes/attributeOptions.ts
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/attributes/advancedForm.ts
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/component/componentField.ts
var componentField = {
  intlLabel: {
    id: "global.type",
    defaultMessage: "Type"
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/attributes/baseForm.ts
var baseForm = {
  component(data, step) {
    if (step === "1") {
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/attributes/form.ts
var attributesForm = {
  advanced: advancedForm,
  base: baseForm
};

// ../packages/core/content-type-builder/admin/src/components/FormModal/attributes/types.ts
var import_uniq = __toESM(require_uniq());

// ../packages/core/content-type-builder/admin/src/utils/toRegressedEnumValue.ts
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/attributes/validation/common.ts
      ...
      enum: create5().of(create2()).min(1, errorsTrads.min.id).test({
        ...
        test(values) {
          ...
          const duplicates = (0, import_uniq.default)(
            values.map(toRegressedEnumValue).filter((value, index, values2) => values2.indexOf(value) !== index)
          );
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/component/createComponentSchema.ts
    ...
    displayName: create2().test({
      ...
      test(value) {
        ...
        return usedComponentNames.every((reserved) => {
          ...
          (collectionName) => (0, import_fp2.snakeCase)(collectionName) !== snakeCaseCollectionName
        );
      }
    }).test({
      name: "nameNotAllowed",
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/contentType/contentTypeForm.ts
var nameField2 = {
  name: "displayName",
  type: "text",
  intlLabel: {
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/contentType/createContentTypeSchema.ts
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/dynamiczoneForm.ts
var dynamiczoneForm = {
  advanced: {
    default() {
      return {
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/forms/utils/addItemsToFormSection.ts
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/forms/utils/createCollectionName.ts
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/forms/utils/getUsedAttributeNames.ts
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/forms/forms.ts
var forms = {
  customField: {
    schema({
      schemaAttributes,
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/utils/canEditContentType.ts
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/utils/getAttributesToDisplay.ts
...
// ../packages/core/content-type-builder/admin/src/components/FormModal/utils/getFormInputNames.ts
...
var FormModal = () => {
  ...
  const {
    ...
    components,
    createSchema,
    createComponentSchema: createComponentSchema2,
    deleteComponent,
    deleteContentType,
  ...
  const type = forTarget === "component" ? components[targetUid] : contentTypes[targetUid];
  const [showWarningDialog, setShowWarningDialog] = (0, import_react10.useState)(false);
  const [pendingSubmit, setPendingSubmit] = (0, import_react10.useState)(null);
    ...
    const referencedFields = contentTypeAttributes.filter((attr) => {
      ...
      if (oldEnum && newEnum) {
        const deletedOrChangedValues = oldEnum.filter(
          (oldValue) => !newEnum.includes(oldValue)
        );
  ...
  React4.useEffect(() => {
    ...
    if (isOpen) {
      ...
      if (modalType === "addComponentToDynamicZone" && actionType === "edit") {
        ...
        dispatch(
          actions2.setDynamicZoneDataSchema({
            attributeToEdit
          })
        );
      }
      if (attributeType) {
        const attributeToEditNotFormatted = findAttribute(
          (0, import_get5.default)(type, ["attributes"], []),
          attributeName
        );
        const attributeToEdit = {
        ...
        if (modalType === "customField") {
          if (actionType === "edit") {
            dispatch(
              actions2.setCustomFieldDataSchema({
                isEditing: true,
            ...
            dispatch(
              actions2.setCustomFieldDataSchema({
                customField: (0, import_pick.default)(customField, ["type", "options"]),
                isEditing: false,
                modifiedDataToSetForEditing: attributeToEdit,
                uid: type.uid
              })
          ...
          dispatch(
            actions2.setAttributeDataSchema({
              attributeType,
              nameToSetForRelation: (0, import_get5.default)(collectionTypesForRelation, ["0", "title"], "error"),
              targetUid: (0, import_get5.default)(collectionTypesForRelation, ["0", "uid"], "error"),
  ...
  const attributes = (0, import_get5.default)(type, ["attributes"], null);
  const checkFormValidity = async () => {
    ...
    if (isCreatingContentType) {
      ...
      schema = forms.customField.schema({
        schemaAttributes: (0, import_get5.default)(type, ["attributes"], []),
      ...
      schema = forms.component.schema(
        Object.keys(components),
        (0, import_get5.default)(modifiedData, "componentToCreate.category", ""),
        reservedNames,
        actionType === "edit",
        components,
      ...
      if (computedAttrbiuteType === "relation") {
        const targetContentTypeUID = (0, import_get5.default)(modifiedData, ["target"], null);
        const targetContentTypeAttributes = (0, import_get5.default)(
          contentTypes,
  ...
  const handleChange = React4.useCallback(
    ({
      target: { name, value, type: type2, ...rest }
    }) => {
    ...
    try {
      ...
      if (isCreatingContentType) {
        ...
        if (isInFirstComponentStep) {
          onNavigateToCreateComponentStep2();
          dispatch(
            actions2.resetPropsAndSetFormForAddingAnExistingCompo({
              uid: type.uid
            })
          );
          return;
        ...
        if (isInFirstComponentStep) {
          ...
          dispatch(
            actions2.resetPropsAndSaveCurrentData({
              uid: type.uid
            })
          );
          onNavigateToCreateComponentStep2();
  ...
  const formToDisplay = (0, import_get5.default)(forms, [modalType, "form"], {
    advanced: () => ({
      sections: []
    }),
    base: () => ({
  ...
  const genericInputProps = {
    ...
    isAddingAComponentToAnotherComponent,
    isCreatingComponentWhileAddingAField,
    mainBoxHeader: (0, import_get5.default)(type, ["info", "displayName"], ""),
    modifiedData,
  ...
  const schemaKind = (0, import_get5.default)(contentTypes, [targetUid, "kind"]);
  ...
  return (0, import_jsx_runtime37.jsx)(Modal.Root, { open: isOpen, onOpenChange: handleClosed, children: (0, import_jsx_runtime37.jsxs)(Modal.Content, { children: [
    (0, import_jsx_runtime37.jsxs)(Dialog.Root, { open: showWarningDialog, onOpenChange: setShowWarningDialog, children: [
        ...
        ConfirmDialog,
        {
          ...
          children: (() => {
            ...
            if (isEnum) {
              ...
              const newEnum = modifiedData.enum;
              const deletedOrChangedValues = oldEnum.filter(
                (value) => !newEnum.includes(value)
              );
              return (0, import_jsx_runtime37.jsx)(Box, { children: (0, import_jsx_runtime37.jsxs)(Typography, { children: [
                formatMessage({
                ...
                (0, import_jsx_runtime37.jsx)(Typography, { fontWeight: "bold", children: fieldNames }),
                formatMessage({
                  id: "form.attribute.condition.enum-change-warning-values",
                  defaultMessage: ". Changing or removing the enum values "
                }),
                (0, import_jsx_runtime37.jsx)(Typography, { fontWeight: "bold", children: deletedOrChangedValues.join(", ") }),
                formatMessage({
    ...
    isPickingAttribute && (0, import_jsx_runtime37.jsx)(
      AttributeOptions,
      {
    ...
    !isPickingAttribute && (0, import_jsx_runtime37.jsxs)(FormComponent, { onSubmit: handleSubmit, children: [
      (0, import_jsx_runtime37.jsx)(Modal.Body, { children: (0, import_jsx_runtime37.jsxs)(
        Tabs.Root,
        {
          variant: "simple",
          value: activeTab,
          ...
          children: [
            (0, import_jsx_runtime37.jsxs)(Flex, { justifyContent: "space-between", children: [
              (0, import_jsx_runtime37.jsx)(
                FormModalSubHeader,
                {
                  actionType,
              ...
              (0, import_jsx_runtime37.jsxs)(Tabs.List, { children: [
                (0, import_jsx_runtime37.jsx)(Tabs.Trigger, { value: "basic", children: formatMessage({
                  id: getTrad("popUpForm.navContainer.base"),
                  defaultMessage: "Basic settings"
                }) }),
                (0, import_jsx_runtime37.jsx)(Tabs.Trigger, { value: "advanced", disabled: shouldDisableAdvancedTab(), children: formatMessage({
                  id: getTrad("popUpForm.navContainer.advanced"),
                  defaultMessage: "Advanced settings"
                }) })
              ] })
            ] }),
            (0, import_jsx_runtime37.jsx)(Divider, { marginBottom: 6 }),
            (0, import_jsx_runtime37.jsx)(Tabs.Content, { value: "basic", children: (0, import_jsx_runtime37.jsx)(Flex, { direction: "column", alignItems: "stretch", gap: 6, children: (0, import_jsx_runtime37.jsx)(
              TabForm,
              {
                form: baseForm2,
                formErrors,
            ...
            (0, import_jsx_runtime37.jsx)(Tabs.Content, { value: "advanced", children: (0, import_jsx_runtime37.jsx)(Flex, { direction: "column", alignItems: "stretch", gap: 6, children: (0, import_jsx_runtime37.jsx)(
              TabForm,
              {
                form: advancedForm2,
                formErrors,
      ...
      (0, import_jsx_runtime37.jsxs)(Modal.Footer, { children: [
        (0, import_jsx_runtime37.jsx)(
          Button,
          {
            type: "button",
            ...
            children: formatMessage({ id: "app.components.Button.cancel", defaultMessage: "Cancel" })
          }
        ),
        (0, import_jsx_runtime37.jsx)(
          FormModalEndActions,
...
// ../packages/core/content-type-builder/admin/src/components/FormModalNavigation/FormModalNavigationProvider.tsx
...
var FormModalNavigationProvider = ({ children }) => {
  ...
  const { trackUsage } = useTracking();
  const onClickSelectCustomField = (0, import_react11.useCallback)(
    ({ attributeType, customFieldUid }) => {
  ...
  const onClickSelectField = (0, import_react11.useCallback)(
    ({ attributeType, step }) => {
  ...
  const onOpenModalAddComponentsToDZ = (0, import_react11.useCallback)(
    ({ dynamicZoneTarget, targetUid }) => {
      setFormModalNavigationState((prevState) => ({
        ...prevState,
        dynamicZoneTarget,
        targetUid,
  ...
  const onOpenModalEditCustomField = (0, import_react11.useCallback)(
    ({
      forTarget,
      targetUid,
      attributeName,
  ...
  const onOpenModalEditField = (0, import_react11.useCallback)(
    ({ forTarget, targetUid, attributeName, attributeType, step }) => {
      setFormModalNavigationState((prevState) => ({
        ...prevState,
        modalType: "attribute",
        actionType: "edit",
  ...
  const onOpenModalEditSchema = (0, import_react11.useCallback)(
    ({ modalType, forTarget, targetUid, kind }) => {
      setFormModalNavigationState((prevState) => ({
        ...prevState,
        modalType,
        actionType: "edit",
  ...
  const onNavigateToChooseAttributeModal = (0, import_react11.useCallback)(
    ({ forTarget, targetUid }) => {
  ...
  const onNavigateToAddCompoToDZModal = (0, import_react11.useCallback)(
    ({ dynamicZoneTarget }) => {
      setFormModalNavigationState((prev) => ({
        ...prev,
        dynamicZoneTarget,
  ...
  return (0, import_jsx_runtime38.jsx)(FormModalNavigationContext.Provider, { value: contextValue, children });
};

// ../packages/core/content-type-builder/admin/src/pages/ListView/EmptyState.tsx
...
var EmptyState = () => {
  ...
  return (0, import_jsx_runtime39.jsxs)(import_jsx_runtime39.Fragment, { children: [
    (0, import_jsx_runtime39.jsx)(tours.contentTypeBuilder.Introduction, { children: (0, import_jsx_runtime39.jsx)(Box, {}) }),
    (0, import_jsx_runtime39.jsxs)(Flex, { justifyContent: "center", alignItems: "center", height: "100%", direction: "column", children: [
      (0, import_jsx_runtime39.jsx)(Typography, { variant: "alpha", children: pluginName }),
      (0, import_jsx_runtime39.jsx)(Typography, { variant: "delta", children: formatMessage({
...
var ListView = (0, import_react12.lazy)(() => import("./ListView-YVTFANO6.js"));
var App = () => {
  const { formatMessage } = useIntl();
  ...
  return (0, import_jsx_runtime40.jsxs)(Page.Protect, { permissions: PERMISSIONS.main, children: [
    (0, import_jsx_runtime40.jsx)(Page.Title, { children: title }),
    (0, import_jsx_runtime40.jsx)(AutoReloadOverlayBlockerProvider, { children: (0, import_jsx_runtime40.jsx)(FormModalNavigationProvider, { children: (0, import_jsx_runtime40.jsxs)(DataManagerProvider_default, { children: [
      ...
      (0, import_jsx_runtime40.jsxs)(import_jsx_runtime40.Fragment, { children: [
        ...
        (0, import_jsx_runtime40.jsx)(Layouts.Root, { sideNav: (0, import_jsx_runtime40.jsx)(ContentTypeBuilderNav, {}), children: (0, import_jsx_runtime40.jsx)(import_react12.Suspense, { fallback: (0, import_jsx_runtime40.jsx)(Page.Loading, {}), children: (0, import_jsx_runtime40.jsxs)(Routes, { children: [
          (0, import_jsx_runtime40.jsx)(Route, { path: "content-types/create-content-type", element: (0, import_jsx_runtime40.jsx)(EmptyState, {}) }),
          (0, import_jsx_runtime40.jsx)(Route, { path: "content-types/:contentTypeUid", element: (0, import_jsx_runtime40.jsx)(ListView, {}) }),
          ...
          (0, import_jsx_runtime40.jsx)(Route, { path: "*", element: (0, import_jsx_runtime40.jsx)(ListView, {}) })
        ] }) }) })
      ] })
    ] }) }) })
  ] });
...
lodash/lodash.min.js:
   ...
   *)
*/
//# sourceMappingURL=App-4KIDNXOX.js.map
