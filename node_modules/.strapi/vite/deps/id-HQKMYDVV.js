...
// ../packages/core/review-workflows/admin/src/routes/settings/components/Stages.tsx
...
// ../packages/core/review-workflows/admin/src/routes/settings/hooks/useDragAndDrop.ts
var React2 = __toESM(require_react());

// ../packages/core/review-workflows/admin/src/routes/settings/hooks/useKeyboardDragAndDrop.ts
...
// ../packages/core/review-workflows/admin/src/routes/settings/components/AddStage.tsx
  ...
  return (0, import_jsx_runtime.jsx)(
    StyledButton,
    {
      ...
      children: (0, import_jsx_runtime.jsx)(Typography, { variant: "pi", fontWeight: "bold", children: (0, import_jsx_runtime.jsxs)(Flex, { tag: "span", gap: 2, children: [
        (0, import_jsx_runtime.jsx)(ForwardRef$1j, { width: "2.4rem", height: "2.4rem", "aria-hidden": true }),
        children
      ] }) })
    }
  );
...
var Stages = ({ canDelete = true, canUpdate = true, isCreating }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Flex, { direction: "column", gap: 6, width: "100%", children: [
    (0, import_jsx_runtime2.jsxs)(Box, { position: "relative", width: "100%", children: [
      ...
      (0, import_jsx_runtime2.jsx)(Flex, { direction: "column", alignItems: "stretch", gap: 6, position: "relative", tag: "ol", children: stages.map((stage, index) => {
        return (0, import_jsx_runtime2.jsx)(Box, { tag: "li", children: (0, import_jsx_runtime2.jsx)(
          Stage,
          {
            index,
    ...
    canUpdate && (0, import_jsx_runtime2.jsx)(
      AddStage,
      {
        type: "button",
        onClick: () => {
...
var Stage = ({
  ...
  return (0, import_jsx_runtime2.jsxs)(Box, { ref: composedRef, shadow: "tableShadow", children: [
    liveText && (0, import_jsx_runtime2.jsx)(VisuallyHidden, { "aria-live": "assertive", children: liveText }),
    isDragging ? (0, import_jsx_runtime2.jsx)(
      Box,
      {
      ...
      AccordionRoot,
      {
        ...
        children: (0, import_jsx_runtime2.jsxs)(Accordion.Item, { value: id, children: [
          (0, import_jsx_runtime2.jsxs)(Accordion.Header, { children: [
            (0, import_jsx_runtime2.jsx)(Accordion.Trigger, { children: name }),
            (0, import_jsx_runtime2.jsx)(Accordion.Actions, { children: canDelete || canUpdate ? (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
              (0, import_jsx_runtime2.jsxs)(Menu.Root, { children: [
                (0, import_jsx_runtime2.jsxs)(ContextMenuTrigger, { size: "S", endIcon: null, paddingLeft: 2, paddingRight: 2, children: [
                  (0, import_jsx_runtime2.jsx)(ForwardRef$1Z, { "aria-hidden": true, focusable: false }),
                  (0, import_jsx_runtime2.jsx)(VisuallyHidden, { tag: "span", children: formatMessage({
                    id: "[tbdb].components.DynamicZone.more-actions",
                    defaultMessage: "More actions"
                  }) })
                ] }),
                (0, import_jsx_runtime2.jsx)(Menu.Content, { popoverPlacement: "bottom-end", zIndex: 2, children: (0, import_jsx_runtime2.jsxs)(Menu.SubRoot, { children: [
                  canUpdate && (0, import_jsx_runtime2.jsx)(Menu.Item, { onClick: handleCloneClick, children: formatMessage({
                    id: "Settings.review-workflows.stage.delete",
                    defaultMessage: "Duplicate stage"
                  }) }),
                  canDelete && (0, import_jsx_runtime2.jsx)(
                    Menu.Item,
                    {
          ...
          (0, import_jsx_runtime2.jsx)(Accordion.Content, { children: (0, import_jsx_runtime2.jsx)(Grid.Root, { gap: 4, padding: 6, children: [
            {
              disabled: !canUpdate,
              label: formatMessage({
          ...
          ].map(({ size, ...field }) => (0, import_jsx_runtime2.jsx)(Grid.Item, { col: size, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime2.jsx)(InputRenderer, { ...field }) }, field.name)) }) })
        ] })
      }
    )
  ] });
...
var InputRenderer = (props) => {
  switch (props.type) {
    case "color":
      return (0, import_jsx_runtime2.jsx)(ColorSelector, { ...props });
    case "permissions":
      return (0, import_jsx_runtime2.jsx)(PermissionsField, { ...props });
    default:
      return (0, import_jsx_runtime2.jsx)(MemoizedInputRenderer, { ...props });
  }
};
var ColorSelector = ({ disabled, label, name, required }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Field.Root, { error, name, required, children: [
    (0, import_jsx_runtime2.jsx)(Field.Label, { children: label }),
    (0, import_jsx_runtime2.jsx)(
      SingleSelect,
      {
        disabled,
        ...
        startIcon: (0, import_jsx_runtime2.jsx)(
          Flex,
          {
            tag: "span",
            height: 2,
...
var PermissionsField = ({ disabled, name, placeholder, required }) => {
  ...
  if (!isLoading && filteredRoles.length === 0) {
    return (0, import_jsx_runtime2.jsxs)(
      Field.Root,
      {
        ...
        required,
        children: [
          (0, import_jsx_runtime2.jsx)(Field.Label, { children: formatMessage({
            id: "Settings.review-workflows.stage.permissions.label",
            defaultMessage: "Roles that can change this stage"
          }) }),
          (0, import_jsx_runtime2.jsx)(
            TextInput,
            {
              ...
              startAction: (0, import_jsx_runtime2.jsx)(ForwardRef$3J, { fill: "neutral600" }),
              type: "text",
              value: ""
            }
          ),
  ...
  return (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: (0, import_jsx_runtime2.jsxs)(Flex, { alignItems: "flex-end", gap: 3, children: [
    (0, import_jsx_runtime2.jsx)(PermissionWrapper, { grow: 1, children: (0, import_jsx_runtime2.jsxs)(Field.Root, { error, name, required: true, children: [
      (0, import_jsx_runtime2.jsx)(Field.Label, { children: formatMessage({
        id: "Settings.review-workflows.stage.permissions.label",
        defaultMessage: "Roles that can change this stage"
      }) }),
          ...
          children: (0, import_jsx_runtime2.jsx)(
            MultiSelectGroup,
            {
              ...
              children: filteredRoles.map((role) => {
                return (0, import_jsx_runtime2.jsx)(NestedOption, { value: `${role.id}`, children: role.name }, role.id);
              })
            }
          )
        }
    ...
    (0, import_jsx_runtime2.jsxs)(Dialog.Root, { open: isApplyAllConfirmationOpen, onOpenChange: setIsApplyAllConfirmationOpen, children: [
      (0, import_jsx_runtime2.jsx)(Dialog.Trigger, { children: (0, import_jsx_runtime2.jsx)(
        IconButton,
        {
          disabled,
          label: formatMessage({
...
// ../packages/core/review-workflows/admin/src/routes/settings/components/WorkflowAttributes.tsx
var import_jsx_runtime3 = __toESM(require_jsx_runtime());
var WorkflowAttributes = ({ canUpdate = true }) => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime3.jsxs)(Grid.Root, { background: "neutral0", hasRadius: true, gap: 4, padding: 6, shadow: "tableShadow", children: [
    (0, import_jsx_runtime3.jsx)(Grid.Item, { col: 6, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime3.jsx)(
      MemoizedInputRenderer,
      {
        disabled: !canUpdate,
        label: formatMessage({
    ...
    (0, import_jsx_runtime3.jsx)(Grid.Item, { col: 6, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime3.jsx)(ContentTypesSelector, { disabled: !canUpdate }) }),
    (0, import_jsx_runtime3.jsx)(Grid.Item, { col: 6, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime3.jsx)(StageSelector, { disabled: !canUpdate }) })
  ] });
};
var ContentTypesSelector = ({ disabled }) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(Field.Root, { error, name: "contentTypes", children: [
          ...
          return (0, import_jsx_runtime3.jsx)(
            MultiSelectGroup,
            {
              ...
              children: opt.children.map((child) => {
                ...
                return (0, import_jsx_runtime3.jsx)(NestedOption2, { value: child.value, children: (0, import_jsx_runtime3.jsx)(Typography, {
                  ...
                  children: formatMessage(
                    ...
                    },
                    {
                      ...
                      em: (...children) => (0, import_jsx_runtime3.jsx)(Typography, { tag: "em", fontWeight: "bold", children }),
                      i: (...children) => (0, import_jsx_runtime3.jsx)(ContentTypeTakeNotice, { children })
                    }
                  )
                }) }, child.value);
              })
      ...
      children: [
        ...
        (0, import_jsx_runtime3.jsxs)(
          SingleSelect,
          {
            ...
            value,
            children: [
              (0, import_jsx_runtime3.jsx)(SingleSelectOption, { value: "", children: formatMessage({
  ...
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
        ...
        children: ({ modified, isSubmitting, values, setErrors }) => {
          ...
          return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
            (0, import_jsx_runtime4.jsx)(
              Header,
              {
                navigationAction: (0, import_jsx_runtime4.jsx)(BackButton, { fallback: ".." }),
                primaryAction: canUpdate || canCreate ? (0, import_jsx_runtime4.jsx)(
                  Button,
                  {
            ...
            (0, import_jsx_runtime4.jsx)(Root, { children: (0, import_jsx_runtime4.jsxs)(Flex, { alignItems: "stretch", direction: "column", gap: 7, children: [
              (0, import_jsx_runtime4.jsx)(WorkflowAttributes, { canUpdate: canUpdate || canCreate }),
              (0, import_jsx_runtime4.jsx)(
                Stages,
                {
                  canDelete,
            ...
            (0, import_jsx_runtime4.jsx)(
              Dialog.Root,
              {
                ...
                children: (0, import_jsx_runtime4.jsx)(ConfirmDialog, { onConfirm: handleConfirmDeleteDialog(values, { setErrors }), children: (0, import_jsx_runtime4.jsxs)(Flex, { direction: "column", gap: 5, children: [
                  savePrompts.hasDeletedServerStages && (0, import_jsx_runtime4.jsx)(Typography, { textAlign: "center", variant: "omega", children: formatMessage({
                    id: "review-workflows.page.delete.confirm.stages.body",
                    defaultMessage: "All entries assigned to deleted stages will be moved to the previous stage."
                  }) }),
                  savePrompts.hasReassignedContentTypes && (0, import_jsx_runtime4.jsx)(Typography, { textAlign: "center", variant: "omega", children: formatMessage(
                    {
                  ...
                  (0, import_jsx_runtime4.jsx)(Typography, { textAlign: "center", variant: "omega", children: formatMessage({
    ...
    (0, import_jsx_runtime4.jsxs)(
      LimitsModal.Root,
      {
        ...
        children: [
          (0, import_jsx_runtime4.jsx)(LimitsModal.Title, { children: formatMessage({
            id: "review-workflows.edit.page.workflows.limit.title",
            defaultMessage: "You’ve reached the limit of workflows in your plan"
          }) }),
          (0, import_jsx_runtime4.jsx)(LimitsModal.Body, { children: formatMessage({
...
var ProtectedEditPage = () => {
  ...
  return (0, import_jsx_runtime4.jsx)(Page.Protect, { permissions, children: (0, import_jsx_runtime4.jsx)(EditPage, {}) });
};
export {
  ProtectedEditPage
};
//# sourceMappingURL=id-HQKMYDVV.js.map
