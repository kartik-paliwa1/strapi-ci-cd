...
// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/ListPage.tsx
var React = __toESM(require_react());

// ../packages/core/admin/admin/src/pages/Settings/pages/Roles/components/RoleRow.tsx
...
var ListPage = () => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Page.Main, { children: [
    ...
    (0, import_jsx_runtime2.jsx)(
      Layouts.Header,
      {
        primaryAction: canCreate ? (0, import_jsx_runtime2.jsx)(Button, { onClick: handleNewRoleClick, startIcon: (0, import_jsx_runtime2.jsx)(ForwardRef$1l, {}), size: "S", children: formatMessage({
    ...
    canRead && (0, import_jsx_runtime2.jsx)(
      Layouts.Action,
      {
        startActions: (0, import_jsx_runtime2.jsx)(
          SearchInput,
          {
            label: formatMessage(
    ...
    canRead && (0, import_jsx_runtime2.jsx)(Layouts.Content, { children: (0, import_jsx_runtime2.jsxs)(
      Table,
      {
        colCount,
        rowCount,
        footer: canCreate ? (0, import_jsx_runtime2.jsx)(TFooter, { cursor: "pointer", onClick: handleNewRoleClick, icon: (0, import_jsx_runtime2.jsx)(ForwardRef$1l, {}), children: formatMessage({
          id: "Settings.roles.list.button.add",
          defaultMessage: "Add new role"
        }) }) : null,
        children: [
          (0, import_jsx_runtime2.jsx)(Thead, { children: (0, import_jsx_runtime2.jsxs)(Tr, { "aria-rowindex": 1, children: [
            (0, import_jsx_runtime2.jsx)(Th, { children: (0, import_jsx_runtime2.jsx)(Typography, { variant: "sigma", textColor: "neutral600", children: formatMessage({
              id: "global.name",
              defaultMessage: "Name"
            }) }) }),
            (0, import_jsx_runtime2.jsx)(Th, { children: (0, import_jsx_runtime2.jsx)(Typography, { variant: "sigma", textColor: "neutral600", children: formatMessage({
            ...
            (0, import_jsx_runtime2.jsx)(Th, { children: (0, import_jsx_runtime2.jsx)(VisuallyHidden, { children: formatMessage({
              id: "global.actions",
              defaultMessage: "Actions"
            }) }) })
          ] }) }),
          (0, import_jsx_runtime2.jsx)(Tbody, { children: roles == null ? void 0 : roles.map((role, index) => (0, import_jsx_runtime2.jsx)(
            RoleRow,
            {
              cursor: "pointer",
              id: role.id,
    ...
    (0, import_jsx_runtime2.jsx)(Dialog.Root, { open: isWarningDeleteAllOpened, onOpenChange: handleToggleModal, children: (0, import_jsx_runtime2.jsx)(ConfirmDialog, { onConfirm: handleDeleteData }) })
  ] });
};
var initialState = {
  roleToDelete: null,
...
var ProtectedListPage = () => {
  ...
  return (0, import_jsx_runtime2.jsx)(Page.Protect, { permissions, children: (0, import_jsx_runtime2.jsx)(ListPage, {}) });
};
export {
  ListPage,
  ProtectedListPage
};
//# sourceMappingURL=ListPage-O45DD5EB.js.map
