...
// ../packages/core/admin/admin/src/components/GuidedTour/utils/constants.ts
...
// ../packages/core/admin/admin/src/hooks/usePersistentState.ts
...
// ../packages/core/admin/admin/src/components/GuidedTour/utils/migrations.ts
...
var getCompletedTours = (tours2) => {
  return Object.keys(tours2).filter(
    (tourName) => tours2[tourName].isCompleted
  );
};
...
function reducer(state, action) {
  return fn(state, (draft) => {
    ...
    if (action.type === "set_completed_actions") {
      draft.completedActions = [.../* @__PURE__ */ new Set([...draft.completedActions, ...action.payload])];
    }
...
var GuidedTourContext = ({
  ...
  return (0, import_jsx_runtime.jsx)(GuidedTourProviderImpl, { state, dispatch, children });
};

// ../packages/core/admin/admin/src/components/GuidedTour/Steps/Step.tsx
...
var StepCount = ({
  ...
  return (0, import_jsx_runtime2.jsx)(Typography, { variant: "omega", fontSize: "12px", children: (0, import_jsx_runtime2.jsx)(
    message_default,
    {
      id: "tours.stepCount",
...
var GotItAction = ({ onClick }) => {
  return (0, import_jsx_runtime2.jsx)(Button, { onClick, children: (0, import_jsx_runtime2.jsx)(message_default, { id: "tours.gotIt", defaultMessage: "Got it" }) });
};
var DefaultActions = ({
  showSkip,
  showPrevious,
  ...
  return (0, import_jsx_runtime2.jsxs)(Flex, { gap: 2, children: [
    showSkip && (0, import_jsx_runtime2.jsx)(Button, { variant: "tertiary", onClick: handleSkip, children: (0, import_jsx_runtime2.jsx)(message_default, { id: "tours.skip", defaultMessage: "Skip" }) }),
    !showSkip && showPrevious && (0, import_jsx_runtime2.jsx)(Button, { variant: "tertiary", onClick: handlePreviousStep, children: (0, import_jsx_runtime2.jsx)(message_default, { id: "tours.previous", defaultMessage: "Previous" }) }),
    to ? (0, import_jsx_runtime2.jsx)(LinkButton, { tag: NavLink, to, onClick: handleNextStep, children: (0, import_jsx_runtime2.jsx)(message_default, { id: "tours.next", defaultMessage: "Next" }) }) : (0, import_jsx_runtime2.jsx)(Button, { onClick: handleNextStep, children: (0, import_jsx_runtime2.jsx)(message_default, { id: "tours.next", defaultMessage: "Next" }) })
  ] });
};
  ...
  Root: React2.forwardRef(({ withArrow = true, ...props }, ref) => {
    return (0, import_jsx_runtime2.jsxs)(
      Popover.Content,
      {
        ...
        ...props,
        children: [
          withArrow && (0, import_jsx_runtime2.jsx)(PopoverArrow, { asChild: true, children: (0, import_jsx_runtime2.jsx)(
            "svg",
            {
              ...
              viewBox: "0 0 23 25",
              fill: "none",
              children: (0, import_jsx_runtime2.jsx)("path", { d: "M11 24.5L1.82843 15.3284C0.266332 13.7663 0.26633 11.2337 1.82843 9.67157L11 0.5L23 12.5L11 24.5Z" })
            }
          ) }),
          (0, import_jsx_runtime2.jsx)(Flex, { width: "360px", direction: "column", alignItems: "start", children: props.children })
        ]
      }
    );
  }),
  Title: (props) => {
    return (0, import_jsx_runtime2.jsx)(Box, { paddingTop: 5, paddingLeft: 5, paddingRight: 5, paddingBottom: 1, width: "100%", children: "children" in props ? props.children : (0, import_jsx_runtime2.jsx)(Typography, { tag: "h1", id: "guided-tour-title", variant: "omega", fontWeight: "bold", children: (0, import_jsx_runtime2.jsx)(message_default, { id: props.id, defaultMessage: props.defaultMessage }) }) });
  },
  Content: (props) => (0, import_jsx_runtime2.jsx)(Box, { paddingBottom: 5, paddingLeft: 5, paddingRight: 5, width: "100%", children: "children" in props ? props.children : (0, import_jsx_runtime2.jsx)(Typography, { tag: "div", variant: "omega", children: (0, import_jsx_runtime2.jsx)(
    message_default,
    {
      id: props.id,
  ...
  Actions: ({
    ...
    return (0, import_jsx_runtime2.jsx)(
      ActionsContainer,
      {
        ...
        ...flexProps,
        children: children ? children : (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
          showStepCount && (0, import_jsx_runtime2.jsx)(StepCount, { tourName }),
...
// ../packages/core/admin/admin/src/components/GuidedTour/Steps/ApiTokensSteps.tsx
var import_jsx_runtime3 = __toESM(require_jsx_runtime());
var Introduction = ({ Step }) => (0, import_jsx_runtime3.jsxs)(Step.Root, { side: "top", sideOffset: 32, withArrow: false, children: [
  ...
  (0, import_jsx_runtime3.jsx)(Step.Actions, { showSkip: true })
] });
var ManageAPIToken = ({ Step }) => (0, import_jsx_runtime3.jsxs)(Step.Root, { side: "bottom", align: "end", children: [
  (0, import_jsx_runtime3.jsx)(Step.Title, { id: "tours.apiTokens.ManageAPIToken.title", defaultMessage: "Manage an API token" }),
  (0, import_jsx_runtime3.jsx)(
    Step.Content,
    {
...
var ViewAPIToken = ({ Step, dispatch }) => (0, import_jsx_runtime3.jsxs)(Step.Root, { side: "bottom", align: "end", children: [
  (0, import_jsx_runtime3.jsx)(Step.Title, { id: "tours.apiTokens.ViewAPIToken.title", defaultMessage: "View API token" }),
  (0, import_jsx_runtime3.jsx)(
    Step.Content,
    {
  ...
  (0, import_jsx_runtime3.jsxs)(Step.Actions, { children: [
    (0, import_jsx_runtime3.jsx)(StepCount, { tourName: "apiTokens" }),
    (0, import_jsx_runtime3.jsx)(GotItAction, { onClick: () => dispatch({ type: "next_step", payload: "apiTokens" }) })
  ] })
] });
var CopyAPIToken = ({ Step, dispatch }) => (0, import_jsx_runtime3.jsxs)(Step.Root, { side: "bottom", align: "start", sideOffset: -5, children: [
  (0, import_jsx_runtime3.jsx)(Step.Title, { id: "tours.apiTokens.CopyAPIToken.title", defaultMessage: "Copy your new API token" }),
  (0, import_jsx_runtime3.jsx)(
    Step.Content,
    {
      ...
      values: {
        spacer: (0, import_jsx_runtime3.jsx)(Box, { paddingTop: 2 }),
        a: (msg) => (0, import_jsx_runtime3.jsx)(Link, { isExternal: true, href: "https://docs.strapi.io/cms/features/api-tokens#usage", children: msg })
      }
    }
  ),
  (0, import_jsx_runtime3.jsxs)(Step.Actions, { children: [
...
var Finish = ({ Step }) => (0, import_jsx_runtime3.jsxs)(Step.Root, { side: "right", align: "start", children: [
  (0, import_jsx_runtime3.jsx)(
    Step.Title,
    {
  ...
  (0, import_jsx_runtime3.jsx)(Step.Actions, { showPrevious: false, showStepCount: false, to: "/" })
] });
var apiTokensSteps = [
  {
    name: "Introduction",
...
// ../packages/core/admin/admin/src/components/GuidedTour/Steps/ContentManagerSteps.tsx
var import_jsx_runtime4 = __toESM(require_jsx_runtime());
var ContentManagerActions = ({
  ...
  if (isActionRequired) {
    return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      ...
      (0, import_jsx_runtime4.jsx)(GotItAction, { onClick: handleNextStep })
    ] });
  }
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
    (0, import_jsx_runtime4.jsx)(
...
var Introduction2 = ({ Step }) => {
  return (0, import_jsx_runtime4.jsxs)(Step.Root, { side: "top", sideOffset: 33, withArrow: false, children: [
    (0, import_jsx_runtime4.jsx)(Step.Title, { id: "tours.contentManager.Introduction.title", defaultMessage: "Content manager" }),
    (0, import_jsx_runtime4.jsx)(
      Step.Content,
      {
    ...
    (0, import_jsx_runtime4.jsx)(Step.Actions, { children: (0, import_jsx_runtime4.jsx)(ContentManagerActions, { showSkip: true }) })
  ] });
};
var CreateNewEntry = ({ Step }) => {
  return (0, import_jsx_runtime4.jsxs)(Step.Root, { side: "bottom", align: "end", children: [
    (0, import_jsx_runtime4.jsx)(
      Step.Title,
      {
    ...
    (0, import_jsx_runtime4.jsx)(Step.Actions, { children: (0, import_jsx_runtime4.jsx)(ContentManagerActions, { showPrevious: true }) })
  ] });
};
var Fields = ({ Step }) => (0, import_jsx_runtime4.jsxs)(Step.Root, { sideOffset: -12, children: [
  (0, import_jsx_runtime4.jsx)(Step.Title, { id: "tours.contentManager.Fields.title", defaultMessage: "Fields" }),
  (0, import_jsx_runtime4.jsx)(
    Step.Content,
    {
...
var Publish = ({ Step }) => (0, import_jsx_runtime4.jsxs)(Step.Root, { side: "left", align: "center", children: [
  (0, import_jsx_runtime4.jsx)(Step.Title, { id: "tours.contentManager.Publish.title", defaultMessage: "Publish" }),
  (0, import_jsx_runtime4.jsx)(
    Step.Content,
    {
  ...
  (0, import_jsx_runtime4.jsx)(Step.Actions, { children: (0, import_jsx_runtime4.jsx)(ContentManagerActions, { isActionRequired: true }) })
] });
var Finish2 = ({ Step }) => (0, import_jsx_runtime4.jsxs)(Step.Root, { side: "right", children: [
  (0, import_jsx_runtime4.jsx)(
    Step.Title,
    {
  ...
  (0, import_jsx_runtime4.jsx)(Step.Actions, { showStepCount: false, showPrevious: false, to: "/settings/api-tokens" })
] });
...
// ../packages/core/admin/admin/src/components/GuidedTour/Steps/ContentTypeBuilderSteps.tsx
var import_jsx_runtime5 = __toESM(require_jsx_runtime());
var Introduction3 = ({ Step }) => (0, import_jsx_runtime5.jsxs)(Step.Root, { sideOffset: 33, withArrow: false, children: [
  ...
  (0, import_jsx_runtime5.jsx)(Step.Actions, { showPrevious: false })
] });
var CollectionTypes = ({ Step }) => (0, import_jsx_runtime5.jsxs)(Step.Root, { side: "right", sideOffset: 16, children: [
  (0, import_jsx_runtime5.jsx)(
    Step.Title,
    {
...
var SingleTypes = ({ Step }) => (0, import_jsx_runtime5.jsxs)(Step.Root, { side: "right", sideOffset: 16, children: [
  (0, import_jsx_runtime5.jsx)(Step.Title, { id: "tours.contentTypeBuilder.SingleTypes.title", defaultMessage: "Single Types" }),
  (0, import_jsx_runtime5.jsx)(
    Step.Content,
    {
...
var Components = ({ Step }) => (0, import_jsx_runtime5.jsxs)(Step.Root, { side: "right", sideOffset: 16, children: [
  (0, import_jsx_runtime5.jsx)(Step.Title, { id: "tours.contentTypeBuilder.Components.title", defaultMessage: "Components" }),
  (0, import_jsx_runtime5.jsx)(
    Step.Content,
    {
...
var YourTurn = ({ Step }) => (0, import_jsx_runtime5.jsxs)(Step.Root, { side: "right", sideOffset: 16, children: [
  (0, import_jsx_runtime5.jsx)(Step.Title, { id: "tours.contentTypeBuilder.YourTurn.title", defaultMessage: "Your turn" }),
  (0, import_jsx_runtime5.jsx)(
    Step.Content,
    {
...
var AddFields = ({ Step, dispatch }) => (0, import_jsx_runtime5.jsxs)(Step.Root, { side: "bottom", children: [
  (0, import_jsx_runtime5.jsx)(
    Step.Title,
    {
  ...
  (0, import_jsx_runtime5.jsxs)(Step.Actions, { children: [
    (0, import_jsx_runtime5.jsx)(StepCount, { tourName: "contentTypeBuilder" }),
    (0, import_jsx_runtime5.jsx)(GotItAction, { onClick: () => dispatch({ type: "next_step", payload: "contentTypeBuilder" }) })
  ] })
] });
var Save = ({ Step, dispatch }) => (0, import_jsx_runtime5.jsxs)(Step.Root, { side: "right", children: [
  (0, import_jsx_runtime5.jsx)(Step.Title, { id: "tours.contentTypeBuilder.Save.title", defaultMessage: "Save before you leave!" }),
  (0, import_jsx_runtime5.jsx)(
    Step.Content,
    {
...
var Finish3 = ({ Step }) => {
  ...
  return (0, import_jsx_runtime5.jsxs)(Step.Root, { side: "right", children: [
    (0, import_jsx_runtime5.jsx)(
      Step.Title,
      {
    ...
    (0, import_jsx_runtime5.jsx)(Step.Actions, { showStepCount: false, showPrevious: false, to })
  ] });
};
...
var GuidedTourTooltip = ({ children, ...props }) => {
  ...
  return (0, import_jsx_runtime6.jsx)(GuidedTourTooltipImpl, { ...props, children });
};
...
var GuidedTourTooltipImpl = ({
  ...
  const Step = React3.useMemo(() => createStepComponents(tourName), [tourName]);
  ...
  return (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
    isPopoverOpen && (0, import_jsx_runtime6.jsx)(Portal$1, { children: (0, import_jsx_runtime6.jsx)(GuidedTourOverlay, {}) }),
    (0, import_jsx_runtime6.jsxs)(Popover.Root, { open: isPopoverOpen, children: [
      (0, import_jsx_runtime6.jsx)(Popover.Anchor, { children }),
...
function createTour(tourName, steps) {
  const tour = steps.reduce(
    ...
    { _meta: { totalStepCount: steps.length, displayedStepCount: steps.length } }
  );
  return tour;
}
...
//# sourceMappingURL=chunk-UIAWNFPX.js.map
