...
// ../packages/core/content-manager/admin/src/pages/ListConfiguration/ListConfigurationPage.tsx
...
// ../packages/core/content-manager/admin/src/pages/ListConfiguration/components/Settings.tsx
...
var Settings = () => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 4, children: [
    (0, import_jsx_runtime2.jsx)(Typography, { variant: "delta", tag: "h2", children: formatMessage({
      id: getTranslation("containers.SettingPage.settings"),
      defaultMessage: "Settings"
    }) }),
    (0, import_jsx_runtime2.jsx)(Grid.Root, { gap: 4, children: formLayout.map(
      (row) => row.map(({ size, ...field }) => (0, import_jsx_runtime2.jsx)(Grid.Item, { s: 12, col: size, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime2.jsx)(MemoizedInputRenderer, { ...field }) }, field.name))
    ) }, "bottom")
  ] });
};
...
// ../packages/core/content-manager/admin/src/pages/ListConfiguration/components/SortDisplayedFields.tsx
var React3 = __toESM(require_react());

// ../packages/core/content-manager/admin/src/pages/ListConfiguration/components/DraggableCard.tsx
var React2 = __toESM(require_react());

// ../packages/core/content-manager/admin/src/pages/ListConfiguration/components/EditFieldForm.tsx
...
var EditFieldForm = ({ attribute, name, onClose }) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Modal.Content, { children: (0, import_jsx_runtime3.jsxs)(
    Form,
    {
      method: "PUT",
      initialValues: value,
      ...
      children: [
        (0, import_jsx_runtime3.jsx)(Modal.Header, { children: (0, import_jsx_runtime3.jsxs)(HeaderContainer, { children: [
          (0, import_jsx_runtime3.jsx)(FieldTypeIcon, { type: attribute.type }),
          (0, import_jsx_runtime3.jsx)(Modal.Title, { children: formatMessage(
            {
        ...
        (0, import_jsx_runtime3.jsx)(Modal.Body, { children: (0, import_jsx_runtime3.jsx)(Grid.Root, { gap: 4, children: [
          {
            name: "label",
            label: formatMessage({
        ...
        ).map(({ size, ...field }) => (0, import_jsx_runtime3.jsx)(
          Grid.Item,
          {
            s: 12,
            col: size,
            direction: "column",
            alignItems: "stretch",
            children: (0, import_jsx_runtime3.jsx)(MemoizedInputRenderer, { ...field })
          },
          field.name
        )) }) }),
        (0, import_jsx_runtime3.jsxs)(Modal.Footer, { children: [
          (0, import_jsx_runtime3.jsx)(Button, { onClick: onClose, variant: "tertiary", children: formatMessage({ id: "app.components.Button.cancel", defaultMessage: "Cancel" }) }),
          (0, import_jsx_runtime3.jsx)(Button, { type: "submit", children: formatMessage({ id: "global.finish", defaultMessage: "Finish" }) })
        ] })
      ]
    }
  ) });
...
var DraggableCard = ({
  ...
  return (0, import_jsx_runtime4.jsxs)(FieldWrapper, { ref: composedRefs, children: [
    isDragging && (0, import_jsx_runtime4.jsx)(CardDragPreview, { label }),
    !isDragging && isDraggingSibling && (0, import_jsx_runtime4.jsx)(CardDragPreview, { isSibling: true, label }),
    !isDragging && !isDraggingSibling && (0, import_jsx_runtime4.jsxs)(
      FieldContainer,
      {
        ...
        children: [
          (0, import_jsx_runtime4.jsxs)(Flex, { gap: 3, children: [
            ...
            (0, import_jsx_runtime4.jsx)(Typography, { fontWeight: "bold", children: label })
          ] }),
          (0, import_jsx_runtime4.jsxs)(Flex, { paddingLeft: 3, onClick: (e) => e.stopPropagation(), children: [
            (0, import_jsx_runtime4.jsxs)(Modal.Root, { open: isModalOpen, onOpenChange: setIsModalOpen, children: [
              (0, import_jsx_runtime4.jsx)(Modal.Trigger, { children: (0, import_jsx_runtime4.jsx)(
                ActionButton,
                {
                  onClick: (e) => {
                    e.stopPropagation();
                  ...
                  type: "button",
                  children: (0, import_jsx_runtime4.jsx)(ForwardRef$1z, { width: "1.2rem", height: "1.2rem" })
                }
              ) }),
              (0, import_jsx_runtime4.jsx)(
                EditFieldForm,
            ...
            (0, import_jsx_runtime4.jsx)(
              ActionButton,
              {
                ...
                type: "button",
                children: (0, import_jsx_runtime4.jsx)(ForwardRef$4d, { width: "1.2rem", height: "1.2rem" })
              }
            )
          ] })
        ]
...
var SortDisplayedFields = () => {
  ...
  return (0, import_jsx_runtime5.jsxs)(Flex, { alignItems: "stretch", direction: "column", gap: 4, children: [
    (0, import_jsx_runtime5.jsx)(Typography, { variant: "delta", tag: "h2", children: formatMessage({
      id: getTranslation("containers.SettingPage.view"),
      defaultMessage: "View"
    }) }),
    (0, import_jsx_runtime5.jsxs)(Flex, { padding: 4, borderColor: "neutral300", borderStyle: "dashed", borderWidth: "1px", hasRadius: true, children: [
      (0, import_jsx_runtime5.jsx)(Box, { flex: "1", overflow: "auto hidden", ref: scrollableContainerRef, children: (0, import_jsx_runtime5.jsx)(Flex, { gap: 3, children: values.map((field, index) => (0, import_jsx_runtime5.jsx)(
        DraggableCard,
        {
          index,
          isDraggingSibling,
      ...
      (0, import_jsx_runtime5.jsxs)(Menu.Root, { children: [
        (0, import_jsx_runtime5.jsxs)(
          Menu.Trigger,
          {
            ...
            variant: "tertiary",
            children: [
              (0, import_jsx_runtime5.jsx)(VisuallyHidden, { tag: "span", children: formatMessage({
                id: getTranslation("components.FieldSelect.label"),
                defaultMessage: "Add a field"
              }) }),
              (0, import_jsx_runtime5.jsx)(ForwardRef$1l, { "aria-hidden": true, focusable: false, style: { position: "relative", top: 2 } })
            ]
          }
        ),
        (0, import_jsx_runtime5.jsx)(Menu.Content, { children: nonDisplayedFields.map((field) => (0, import_jsx_runtime5.jsx)(Menu.Item, { onSelect: () => handleAddField(field), children: typeof field.label === "object" ? formatMessage(field.label) : field.label }, field.name)) })
      ] })
    ] })
  ] });
};
...
var ListConfiguration = () => {
  ...
  if (collectionType === SINGLE_TYPES) {
    return (0, import_jsx_runtime6.jsx)(Navigate, { to: `/single-types/${model}` });
  }
  if (isLoadingLayout) {
    return (0, import_jsx_runtime6.jsx)(Page.Loading, {});
  }
  return (0, import_jsx_runtime6.jsxs)(Layouts.Root, { children: [
    (0, import_jsx_runtime6.jsx)(Page.Title, { children: `Configure ${list.settings.displayName} List View` }),
    (0, import_jsx_runtime6.jsx)(Main, { children: (0, import_jsx_runtime6.jsxs)(Form, { initialValues, onSubmit: handleSubmit, method: "PUT", children: [
      ...
      (0, import_jsx_runtime6.jsx)(Layouts.Content, { children: (0, import_jsx_runtime6.jsxs)(
        Flex,
        {
          alignItems: "stretch",
          background: "neutral0",
...
var ProtectedListConfiguration = () => {
  ...
  return (0, import_jsx_runtime6.jsx)(Page.Protect, { permissions, children: (0, import_jsx_runtime6.jsx)(ListConfiguration, {}) });
};
export {
  ListConfiguration,
  ProtectedListConfiguration
};
//# sourceMappingURL=ListConfigurationPage-TAOCNAVR.js.map
